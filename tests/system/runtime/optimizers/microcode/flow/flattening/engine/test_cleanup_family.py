...
def _cleanup_flow_graph() -> FlowGraph:
    return FlowGraph(
        blocks={
            ...
            10: _block(10, (18,), (2,)),
            18: _block(18, (), (10,), block_type=2),
            20: _block(20, (19,), (2,)),
            19: _block(19, (), (20,), block_type=2),
...
def test_simple_cleanup_family_uses_backend_evidence_for_metadata() -> None:
    ...
    assert dict(metadata.strategy_scopes) == {
        ...
        "guarded_state_machine": "normalized_preanalysis_cfg_fact",
        "local_select_loop": "normalized_preanalysis_cfg_fact",
        "side_effect_select_loop": "normalized_preanalysis_cfg_fact",
        "selector_shell": "normalized_preanalysis_cfg_fact",
