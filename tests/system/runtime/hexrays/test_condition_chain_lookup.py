...
class TestResolveTargetViaConditionChain:
    def test_exact_match(self):
        condition_chain = _make_condition_chain_result({10: 0xAABBCCDD, 20: 0x11223344})
        assert resolve_target_via_condition_chain(condition_chain, 0xAABBCCDD) == 10
        assert resolve_target_via_condition_chain(condition_chain, 0x11223344) == 20
    ...
    def test_range_match(self):
        ...
        assert resolve_target_via_condition_chain(condition_chain, 0x250) == 20
