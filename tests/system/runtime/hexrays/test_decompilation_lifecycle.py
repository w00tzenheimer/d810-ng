...
def test_preoptimized_hook_propagates_poison_instead_of_continuing(
    ...
    failure = CfgTransactionFailure(
        attempt_id=TransactionAttemptId.new("hook-preopt-poison"),
    ...
    mba = SimpleNamespace(entry_ea=0x40A560, maturity=ida_hexrays.MMAT_PREOPTIMIZED)
    monkeypatch.setattr(
        HexraysDecompilationHook,
        "_function_owner_ea",
        staticmethod(lambda _mba: 0x40A560),
