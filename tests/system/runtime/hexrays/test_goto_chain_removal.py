...
class TestGotoChainRemovalPass:
    ...
    def test_self_loop_skipped(self):
        ...
        blk10_selfloop = BlockSnapshot(
            ...
            flags=0,
            start_ea=0x1100,
            insn_snapshots=(self_goto_insn,),
        )
        cfg = FlowGraph(
            blocks={0: blk0, 10: blk10_selfloop}, entry_serial=0, func_ea=0x1000
        )
    ...
    def test_block_with_instructions_not_goto_only(self):
        ...
        blk10 = BlockSnapshot(
            ...
            flags=0,
            start_ea=0x1100,
            insn_snapshots=(insn10a, insn10b),
        )
        blk20 = BlockSnapshot(
            serial=20,
            block_type=2,
        ...
        cfg = FlowGraph(
            blocks={0: blk0, 10: blk10, 20: blk20}, entry_serial=0, func_ea=0x1000
        )
    ...
    def test_empty_block_not_treated_as_simple_goto(self):
        ...
        cfg = FlowGraph(
            blocks={0: blk0, 10: blk10_empty, 20: blk20}, entry_serial=0, func_ea=0x1000
        )
    ...
    def test_goto_insn_mop_b_wrong_dest_is_rejected(self):
        ...
        blk10 = BlockSnapshot(
            ...
            flags=0,
            start_ea=0x1100,
            insn_snapshots=(goto_wrong_dest,),
        )
        blk20 = BlockSnapshot(
            serial=20,
            block_type=2,
