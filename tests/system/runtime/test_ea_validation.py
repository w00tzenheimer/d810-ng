...
class TestEaValidationHelpers:
    ...
    def test_valid_ea_accepted(self):
        import idaapi
        from d810.hexrays.utils.table_utils import is_valid_database_ea
