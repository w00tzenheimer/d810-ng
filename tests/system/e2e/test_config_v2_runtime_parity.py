...
_PARITY_ROWS = (
    ...
    pytest.param(
        ...
        id="tigress_engine_transition_facts_spine",
    ),
    pytest.param(
        ConfigV2ParityRow(
            row_id="tigress_engine_transition_facts_config_v2_canary_spine",
            legacy_config="default_unflattening_tigress_engine_transition_facts.json",
            shadow_config=(
                "default_unflattening_tigress_engine_transition_facts"
                ".pipeline_v2.json"
        ...
        id="tigress_engine_transition_facts_config_v2_canary_spine",
    ),
    pytest.param(
        ConfigV2ParityRow(
            row_id="example_libobfuscated_abc_mixed_spine",
            legacy_config="example_libobfuscated_abc.json",
            shadow_config="example_libobfuscated_abc.pipeline_v2.json",
            function_name="abc_or_dispatch",
            expected_pass_ids=(
                "mba-simplify",
                "forward-constant-propagation",
                *STATE_MACHINE_NATIVE_PASS_IDS,
        ...
        id="example_libobfuscated_abc_mixed_spine",
    ),
    pytest.param(
        ConfigV2ParityRow(
            row_id="example_libobfuscated_abc_config_v2_canary_mixed_spine",
            legacy_config="example_libobfuscated_abc.json",
            shadow_config="example_libobfuscated_abc.pipeline_v2.json",
        ...
        id="example_libobfuscated_abc_config_v2_canary_mixed_spine",
    ),
    pytest.param(
        ConfigV2ParityRow(
            row_id="flatfold_mixed_spine",
            legacy_config="flatfold.json",
            shadow_config="flatfold.pipeline_v2.json",
            function_name="mixed_dispatcher_pattern",
            expected_pass_ids=(
                "mba-simplify",
                "mba-state-preconditioner",
                "global-constant-inliner",
        ...
        id="flatfold_mixed_spine",
    ),
    pytest.param(
        ConfigV2ParityRow(
            row_id="flatfold_config_v2_canary_mixed_spine",
            legacy_config="flatfold.json",
            shadow_config="flatfold.pipeline_v2.json",
