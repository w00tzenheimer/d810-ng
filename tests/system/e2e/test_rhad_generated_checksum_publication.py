...
def _run_worker(binary: pathlib.Path) -> None:
    ...
    try:
        ...
        receipt = matching[0]
        assert receipt.operation_count == receipt.planned_operation_count == 994, (
...
def test_a560_generated_checksum_commits_and_reaches_ctree(
    ...
    with sqlite3.connect(diag_path) as connection:
        ...
        assert compiled_payload["aggregate_program_identity"] == (
            "sha256:99fd884b183fb048551aac61e2f8856c575eccbf43a2360b4cf37e3aaf1f746b"
        )
        proof_artifacts = {
        ...
        assert row129_calls["target_eas"] == [0x40B898, 0x40BC6D]
