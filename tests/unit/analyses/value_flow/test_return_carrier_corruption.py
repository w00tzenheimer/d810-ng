...
def test_legit_partial_return_not_severed_is_kept():
    ...
    """
    target = ReturnRegDef(
        block=70, ea=0x1800A0, ssa=300,
        is_const=True, is_partial=True, const_value=0x5,
    )
...
def test_severance_gate_precedes_uses_pillar():
    ...
    target = ReturnRegDef(
        block=70, ea=0x1800A0, ssa=301,
        is_const=True, is_partial=False, const_value=0x9,
    )
    result = prove_return_const_droppable(
        target,
...
def test_def_with_surviving_use_is_kept():
    ...
    result = prove_return_const_droppable(
        target, was_consumed_prefold=True, du_chain_uses=2,
...
def test_untagged_return_def_is_kept():
    ...
    result = prove_return_const_droppable(
        target, was_consumed_prefold=True, du_chain_uses=0,
        carrier_blocks=frozenset({4}), strict_dominators=frozenset({4}),
    )
