...
def test_preopt_0x40c703_selects_terminal_source_when_all_predecessors_covered() -> (
    None
):
    selected = detached_handler_island.select_boundary_owned_terminal_source_blocks(
...
def test_preopt_0x40c703_selects_empty_predecessor_source_when_old_successor_covered() -> (
    None
):
    selected = detached_handler_island.select_boundary_owned_terminal_source_blocks(
        source_native_ea_by_block={77: 0x40C703},
...
def test_preopt_0x40c703_rejects_terminal_source_with_one_uncovered_predecessor() -> (
    None
):
    selected = detached_handler_island.select_boundary_owned_terminal_source_blocks(
        source_native_ea_by_block={77: 0x40C703},
...
def test_preopt_0x40c703_already_routed_source_keeps_uncovered_sibling_fallback() -> (
    None
):
