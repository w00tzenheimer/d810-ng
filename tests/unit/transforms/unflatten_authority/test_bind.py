...
def _exact_fixture(*, optional_owner: bool = False):
    ...
    # The proof constant is the actual storage comparison constant.  The live
    # branch compares the state carrier with 7; 8 is the alternate route state,
    # not the predicate literal.
