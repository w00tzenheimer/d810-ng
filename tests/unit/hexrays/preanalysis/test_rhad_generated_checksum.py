...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 266
...
def test_indirect_jump_coverage_summary_matches_committed_row51_batch() -> None:
    summary = json.loads(
        (
            _REPO
            / "docs"
    ...
    assert summary["accepted_code_sha"] == ("83fa2fb172fdc0cd822d68af8fa883c28964beaf")
    ...
    assert simple == {
        ...
        "earliest_unproved_reference_order": 54,
        "earliest_unproved_operation_id": "rhad:route@0x40ACBD",
        "first_missing_typed_obligation": (
    ...
    assert existing == {
        ...
        "earliest_unproved_reference_order": 52,
        "earliest_unproved_operation_id": "rhad:route@0x40AC54",
        "first_missing_typed_obligation": (
