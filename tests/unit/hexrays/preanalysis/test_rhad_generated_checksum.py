...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 414
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert summary["accepted_code_sha"] == ("cb775189a078b02c9f5aac8889619c2054db9017")
    ...
    assert simple == {
        ...
        "earliest_unproved_reference_order": 95,
        "earliest_unproved_operation_id": "rhad:route@0x40B32A",
        "first_missing_typed_obligation": (
    ...
    assert existing == {
        ...
        "compiled_operation_instances": 51,
        "vertically_proved_operations": 51,
        "accepted_receipt_operations": 51,
        "earliest_unproved_reference_order": 94,
        "earliest_unproved_operation_id": "rhad:route@0x40B2F3",
        "first_missing_typed_obligation": (
