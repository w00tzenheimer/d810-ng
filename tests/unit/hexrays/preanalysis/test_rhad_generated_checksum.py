...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 575
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert summary["accepted_code_sha"] == ("c13ec1fd42bf24daf7f07752d5812bfc6247daaf")
    ...
    assert len(accepted_operation_ids) == 131
    assert accepted_operation_ids[-1] == "rhad:route@0x40B970"
    assert (
