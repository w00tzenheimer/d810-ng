...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 884
    ...
    row136 = plan.operation("rhad:route@0x40B98A")
    ...
    row139 = plan.operation("rhad:route@0x40BB8D")
    row139_envelope = row139.computed_branch_normalization.conditional_select_envelope
    row140 = plan.operation("rhad:route@0x40BBA7")
    row140_envelope = row140.computed_branch_normalization.conditional_select_envelope
    row141 = plan.operation("rhad:route@0x40BBC1")
    row141_envelope = row141.computed_branch_normalization.conditional_select_envelope
    row142 = plan.operation("rhad:route@0x40BBDD")
    row142_envelope = row142.computed_branch_normalization.conditional_select_envelope
    row143 = plan.operation("rhad:route@0x40BBF7")
    row143_envelope = row143.computed_branch_normalization.conditional_select_envelope
    row144 = plan.operation("rhad:route@0x40BC11")
    row144_envelope = row144.computed_branch_normalization.conditional_select_envelope
    row145 = plan.operation("rhad:route@0x40BC2B")
    row145_envelope = row145.computed_branch_normalization.conditional_select_envelope
    row146 = plan.operation("rhad:route@0x40BC5F")
    row146_envelope = row146.computed_branch_normalization.conditional_select_envelope
    row147 = plan.operation("rhad:route@0x40BC79")
    row147_envelope = row147.computed_branch_normalization.conditional_select_envelope
    row148 = plan.operation("rhad:route@0x40BC93")
    ...
    row151 = plan.operation("rhad:route@0x40BCE3")
    row151_envelope = row151.computed_branch_normalization.conditional_select_envelope
    row152 = plan.operation("rhad:route@0x40BCFD")
    row152_envelope = row152.computed_branch_normalization.conditional_select_envelope
    row153 = plan.operation("rhad:route@0x40BD17")
    row153_envelope = row153.computed_branch_normalization.conditional_select_envelope
    row154 = plan.operation("rhad:route@0x40BD4E")
    row154_envelope = row154.computed_branch_normalization.conditional_select_envelope
    row155 = plan.operation("rhad:route@0x40BD68")
    row155_envelope = row155.computed_branch_normalization.conditional_select_envelope
    row156 = plan.operation("rhad:route@0x40BD82")
    row156_envelope = row156.computed_branch_normalization.conditional_select_envelope
    row157 = plan.operation("rhad:route@0x40BE2D")
    row157_envelope = row157.computed_branch_normalization.conditional_select_envelope
    row158 = plan.operation("rhad:route@0x40BE47")
    row158_envelope = row158.computed_branch_normalization.conditional_select_envelope
    row159 = plan.operation("rhad:route@0x40BE61")
    row159_envelope = row159.computed_branch_normalization.conditional_select_envelope
    row160 = plan.operation("rhad:route@0x40BE96")
    row160_envelope = row160.computed_branch_normalization.conditional_select_envelope
    row161 = plan.operation("rhad:route@0x40BEB0")
    row161_envelope = row161.computed_branch_normalization.conditional_select_envelope
    row162 = plan.operation("rhad:route@0x40BECA")
    row162_envelope = row162.computed_branch_normalization.conditional_select_envelope
    row163 = plan.operation("rhad:route@0x40BEE5")
    ...
    row167 = plan.operation("rhad:route@0x40BFA2")
    row168 = plan.operation("rhad:route@0x40BFBC")
    row168_envelope = row168.computed_branch_normalization.conditional_select_envelope
    row169 = plan.operation("rhad:route@0x40BFD8")
    ...
    row173 = plan.operation("rhad:route@0x40C059")
    row173_envelope = row173.computed_branch_normalization.conditional_select_envelope
    row174 = plan.operation("rhad:route@0x40C073")
    row174_envelope = row174.computed_branch_normalization.conditional_select_envelope
    row176 = plan.operation("rhad:route@0x40C0B8")
    row176_envelope = row176.computed_branch_normalization.conditional_select_envelope
    row177 = plan.operation("rhad:route@0x40C0D2")
    row177_envelope = row177.computed_branch_normalization.conditional_select_envelope
    row178 = plan.operation("rhad:route@0x40C0EE")
    row178_envelope = row178.computed_branch_normalization.conditional_select_envelope
    row179 = plan.operation("rhad:route@0x40C108")
    row179_envelope = row179.computed_branch_normalization.conditional_select_envelope
    row181 = plan.operation("rhad:route@0x40C168")
    row181_envelope = row181.computed_branch_normalization.conditional_select_envelope
    row182 = plan.operation("rhad:route@0x40C184")
    row182_envelope = row182.computed_branch_normalization.conditional_select_envelope
    row183 = plan.operation("rhad:route@0x40C19E")
    row183_envelope = row183.computed_branch_normalization.conditional_select_envelope
    row184 = plan.operation("rhad:route@0x40C1F0")
    row184_envelope = row184.computed_branch_normalization.conditional_select_envelope
    row185 = plan.operation("rhad:route@0x40C20A")
    row185_envelope = row185.computed_branch_normalization.conditional_select_envelope
    row187 = plan.operation("rhad:route@0x40C26B")
    row187_envelope = row187.computed_branch_normalization.conditional_select_envelope
    row189 = plan.operation("rhad:route@0x40C313")
    row189_envelope = row189.computed_branch_normalization.conditional_select_envelope
    row191 = plan.operation("rhad:route@0x40C365")
    row191_envelope = row191.computed_branch_normalization.conditional_select_envelope
    row193 = plan.operation("rhad:route@0x40C3AA")
    row193_envelope = row193.computed_branch_normalization.conditional_select_envelope
    row195 = plan.operation("rhad:route@0x40C3F1")
    row195_envelope = row195.computed_branch_normalization.conditional_select_envelope
    row196 = plan.operation("route:rhad-direct@0x40C42C")
    row197 = plan.operation("rhad:route@0x40C446")
    row197_envelope = row197.computed_branch_normalization.conditional_select_envelope
    row198 = plan.operation("rhad:route@0x40C462")
    row198_envelope = row198.computed_branch_normalization.conditional_select_envelope
    row199 = plan.operation("rhad:route@0x40C47C")
    row199_envelope = row199.computed_branch_normalization.conditional_select_envelope
    row200 = plan.operation("rhad:route@0x40C498")
    row200_envelope = row200.computed_branch_normalization.conditional_select_envelope
    row201 = plan.operation("rhad:route@0x40C4B2")
    row201_envelope = row201.computed_branch_normalization.conditional_select_envelope
    row202 = plan.operation("rhad:route@0x40C4DA")
    row202_envelope = row202.computed_branch_normalization.conditional_select_envelope
    row203 = plan.operation("rhad:route@0x40C4F4")
    row203_envelope = row203.computed_branch_normalization.conditional_select_envelope
    row204 = plan.operation("rhad:route@0x40C525")
    row204_envelope = row204.computed_branch_normalization.conditional_select_envelope
    row205 = plan.operation("rhad:route@0x40C53F")
    row205_envelope = row205.computed_branch_normalization.conditional_select_envelope
    row206 = plan.operation("rhad:route@0x40C576")
    row206_envelope = row206.computed_branch_normalization.conditional_select_envelope
    row207 = plan.operation("rhad:route@0x40C590")
    ...
    row211 = plan.operation("rhad:route@0x40C649")
    row211_envelope = row211.computed_branch_normalization.conditional_select_envelope
    row212 = plan.operation("rhad:route@0x40C663")
    row212_envelope = row212.computed_branch_normalization.conditional_select_envelope
    row213 = plan.operation("rhad:route@0x40C694")
    row213_envelope = row213.computed_branch_normalization.conditional_select_envelope
    ...
    operation_topology = direct_sources | {
        ...
        row136.source_block_id,
        row136_envelope.selected_value_block_id,
        row136_envelope.join_block_id,
        row137.source_block_id,
        row137_envelope.selected_value_block_id,
        row137_envelope.join_block_id,
        row139.source_block_id,
        row139_envelope.selected_value_block_id,
        row139_envelope.join_block_id,
        row140.source_block_id,
        row140_envelope.selected_value_block_id,
        row140_envelope.join_block_id,
        row141.source_block_id,
        row141_envelope.selected_value_block_id,
        row141_envelope.join_block_id,
        row142.source_block_id,
        row142_envelope.selected_value_block_id,
        row142_envelope.join_block_id,
        row143.source_block_id,
        row143_envelope.selected_value_block_id,
        row143_envelope.join_block_id,
        row144.source_block_id,
        row144_envelope.selected_value_block_id,
        row144_envelope.join_block_id,
        row145.source_block_id,
        row145_envelope.selected_value_block_id,
        row145_envelope.join_block_id,
        row146.source_block_id,
        row146_envelope.selected_value_block_id,
        row146_envelope.join_block_id,
        row147.source_block_id,
        row147_envelope.selected_value_block_id,
        row147_envelope.join_block_id,
        row148.source_block_id,
        row148_envelope.selected_value_block_id,
        row148_envelope.join_block_id,
        ...
        row151.source_block_id,
        row151_envelope.selected_value_block_id,
        row151_envelope.join_block_id,
        row152.source_block_id,
        row152_envelope.selected_value_block_id,
        row152_envelope.join_block_id,
        row153.source_block_id,
        row153_envelope.selected_value_block_id,
        row153_envelope.join_block_id,
        row154.source_block_id,
        row154_envelope.selected_value_block_id,
        row154_envelope.join_block_id,
        row155.source_block_id,
        row155_envelope.selected_value_block_id,
        row155_envelope.join_block_id,
        row156.source_block_id,
        row156_envelope.selected_value_block_id,
        row156_envelope.join_block_id,
        row157.source_block_id,
        row157_envelope.selected_value_block_id,
        row157_envelope.join_block_id,
        row158.source_block_id,
        row158_envelope.selected_value_block_id,
        row158_envelope.join_block_id,
        row159.source_block_id,
        row159_envelope.selected_value_block_id,
        row159_envelope.join_block_id,
        row160.source_block_id,
        row160_envelope.selected_value_block_id,
        row160_envelope.join_block_id,
        row161.source_block_id,
        row161_envelope.selected_value_block_id,
        row161_envelope.join_block_id,
        row162.source_block_id,
        row162_envelope.selected_value_block_id,
        row162_envelope.join_block_id,
        row163.source_block_id,
        row163_envelope.selected_value_block_id,
        row163_envelope.join_block_id,
        ...
        row167.source_block_id,
        row168.source_block_id,
        row168_envelope.selected_value_block_id,
        row168_envelope.join_block_id,
        row169.source_block_id,
        row169_envelope.selected_value_block_id,
        row169_envelope.join_block_id,
        ...
        row173.source_block_id,
        row173_envelope.selected_value_block_id,
        row173_envelope.join_block_id,
        row174.source_block_id,
        row174_envelope.selected_value_block_id,
        row174_envelope.join_block_id,
        row176.source_block_id,
        row176_envelope.selected_value_block_id,
        row176_envelope.join_block_id,
        row177.source_block_id,
        row177_envelope.selected_value_block_id,
        row177_envelope.join_block_id,
        row178.source_block_id,
        row178_envelope.selected_value_block_id,
        row178_envelope.join_block_id,
        row179.source_block_id,
        row179_envelope.selected_value_block_id,
        row179_envelope.join_block_id,
        row181.source_block_id,
        row181_envelope.selected_value_block_id,
        row181_envelope.join_block_id,
        row182.source_block_id,
        row182_envelope.selected_value_block_id,
        row182_envelope.join_block_id,
        row183.source_block_id,
        row183_envelope.selected_value_block_id,
        row183_envelope.join_block_id,
        row184.source_block_id,
        row184_envelope.selected_value_block_id,
        row184_envelope.join_block_id,
        row185.source_block_id,
        row185_envelope.selected_value_block_id,
        row185_envelope.join_block_id,
        row187.source_block_id,
        row187_envelope.selected_value_block_id,
        row187_envelope.join_block_id,
        row189.source_block_id,
        row189_envelope.selected_value_block_id,
        row189_envelope.join_block_id,
        row191.source_block_id,
        row191_envelope.selected_value_block_id,
        row191_envelope.join_block_id,
        row193.source_block_id,
        row193_envelope.selected_value_block_id,
        row193_envelope.join_block_id,
        row195.source_block_id,
        row195_envelope.selected_value_block_id,
        row195_envelope.join_block_id,
        row196.source_block_id,
        row197.source_block_id,
        row197_envelope.selected_value_block_id,
        row197_envelope.join_block_id,
        row198.source_block_id,
        row198_envelope.selected_value_block_id,
        row198_envelope.join_block_id,
        row199.source_block_id,
        row199_envelope.selected_value_block_id,
        row199_envelope.join_block_id,
        row200.source_block_id,
        row200_envelope.selected_value_block_id,
        row200_envelope.join_block_id,
        row201.source_block_id,
        row201_envelope.selected_value_block_id,
        row201_envelope.join_block_id,
        row202.source_block_id,
        row202_envelope.selected_value_block_id,
        row202_envelope.join_block_id,
        row203.source_block_id,
        row203_envelope.selected_value_block_id,
        row203_envelope.join_block_id,
        row204.source_block_id,
        row204_envelope.selected_value_block_id,
        row204_envelope.join_block_id,
        row205.source_block_id,
        row205_envelope.selected_value_block_id,
        row205_envelope.join_block_id,
        row206.source_block_id,
        row206_envelope.selected_value_block_id,
        row206_envelope.join_block_id,
        row207.source_block_id,
        row207_envelope.selected_value_block_id,
        row207_envelope.join_block_id,
        ...
        row211.source_block_id,
        row211_envelope.selected_value_block_id,
        row211_envelope.join_block_id,
        row212.source_block_id,
        row212_envelope.selected_value_block_id,
        row212_envelope.join_block_id,
        row213.source_block_id,
...
def test_checksum_producer_compiles_row135_existing_dependency() -> None:
    ...
    assert {"native@0x40B972", "native@0x40BEE7"}.issubset(
        batch.native_body_entry_block_ids
    )


def test_checksum_producer_compiles_row136_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40B98A")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40B978
    assert normalization.unresolved_transfer_ea == 0x40B98A
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B98C",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C1F2",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 136
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "slt"
    assert payload["condition_producer_ea"] == 0x40B978
    assert payload["comparison_constant"] == 0xF0B56411
    assert payload["owned_corridor_instruction_eas"] == [
        0x40B972,
        0x40B978,
        0x40B97E,
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40B9A6]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40B98A"
    ).depends_on == ("rhad:route@0x40B970",)
    assert {"native@0x40B98C", "native@0x40C1F2"}.issubset(
        batch.native_body_entry_block_ids
    )


def test_checksum_producer_compiles_row137_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40B9A4")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40B992
    assert normalization.unresolved_transfer_ea == 0x40B9A4
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B9A6",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 137
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "eq"
    assert payload["condition_producer_ea"] == 0x40B992
    assert payload["comparison_constant"] == 0xEC71CA67
    assert payload["owned_corridor_instruction_eas"] == [
        0x40B98C,
        0x40B992,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40B9A4"
    ).depends_on == ("rhad:route@0x40B98A",)
    assert "native@0x40B9A6" in batch.native_body_entry_block_ids


def test_checksum_producer_compiles_row139_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BB8D")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BB7B
    assert normalization.unresolved_transfer_ea == 0x40BB8D
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BB8F",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BF8C",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 139
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "slt"
    assert payload["condition_producer_ea"] == 0x40BB7B
    assert payload["comparison_constant"] == 0xA0DBF1FA
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BB75,
        0x40BB7B,
        0x40BB81,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BB8D"
    ).depends_on == ("route:rhad-direct@0x40BB73",)
    assert {"native@0x40BB8F", "native@0x40BF8C"}.issubset(
        batch.native_body_entry_block_ids
    )


def test_checksum_producer_compiles_row140_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BBA7")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BB95
    assert normalization.unresolved_transfer_ea == 0x40BBA7
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BBA9",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C253",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 140
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "slt"
    assert payload["condition_producer_ea"] == 0x40BB95
    assert payload["comparison_constant"] == 0xA0716E5B
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BB8F,
        0x40BB95,
        0x40BB9B,
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40BBC3]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BBA7"
    ).depends_on == ("rhad:route@0x40BB8D",)
    assert {"native@0x40BBA9", "native@0x40C253"}.issubset(
        batch.native_body_entry_block_ids
    )


def test_checksum_producer_compiles_row141_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BBC1")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BBAF
    assert normalization.unresolved_transfer_ea == 0x40BBC1
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BBC3",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 141
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "eq"
    assert payload["condition_producer_ea"] == 0x40BBAF
    assert payload["comparison_constant"] == 0x9A607E2A
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BBA9,
        0x40BBAF,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BBC1"
    ).depends_on == ("rhad:route@0x40BBA7",)
...
def test_row142_inventory_corridor_includes_flag_producer() -> None:
    ...
    assert row142["current_generated_proof"] == {
        "accepted_commits": ["cc6968a63", "b35faf00c", "7bed7479f"],
...
def test_row143_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row143 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 143
    )

    assert row143["operation_id"] == "rhad:route@0x40BBF7"
    assert row143["flag_producer_native_ea"] == 0x40BBE5
    ...
    assert row143["imported_closure_block_anchor_eas"] == [
        0x40BBF9,
        0x40BC07,
        0x40BC0D,
        0x40BC11,
    ...
    assert row143["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40BC13, 0x40C2FB],
            "expected_generated_block_anchor_eas": [
                0x40BBF9,
                0x40BC07,
                0x40BC0D,
            ...
            "owned_native_block_entry_eas": [0x40BBF9, 0x40BC07, 0x40BC0D],
            "root_ea": 0x40BBF9,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40C527],
            "expected_generated_block_anchor_eas": [
                0x40BFDA,
                0x40BFE8,
                0x40BFEE,
            ...
            "owned_native_block_entry_eas": [0x40BFDA, 0x40BFE8, 0x40BFEE],
            "root_ea": 0x40BFDA,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
    ]
    assert row143["unavailable_closure_exit_eas"] == []
...
def test_row144_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row144 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 144
    )
    ...
    assert row144["imported_closure_block_anchor_eas"] == [
        0x40BC13,
        0x40BC21,
        0x40BC27,
        0x40BC2B,
    ...
    assert row144["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40BC2D],
            "expected_generated_block_anchor_eas": [
                0x40BC13,
                0x40BC21,
                0x40BC27,
            ...
            "owned_native_block_entry_eas": [0x40BC13, 0x40BC21, 0x40BC27],
            "root_ea": 0x40BC13,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40A5F0, 0x40C315],
            "expected_generated_block_anchor_eas": [
                0x40C2FB,
                0x40C309,
                0x40C30F,
            ...
            "owned_native_block_entry_eas": [0x40C2FB, 0x40C309, 0x40C30F],
            "root_ea": 0x40C2FB,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row146_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row146 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 146
    )

    assert row146["operation_id"] == "rhad:route@0x40BC5F"
    assert row146["operation_variant"] == "cmov_selected_indirect"
    assert row146["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert row146["source_native_ea"] == 0x40BC3C
    assert row146["source_block_anchor_ea"] == 0x40BC36
    assert row146["flag_producer_native_ea"] == 0x40BC4A
    ...
    assert row146["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row146["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row146["unavailable_closure_exit_eas"] == []
...
def test_row147_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row147 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 147
    )
    ...
    assert row147["predicate_native_ea"] == 0x40BC6D
    assert row147["transfer_native_ea"] == 0x40BC79
    assert row147["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    ...
    assert row147["imported_closure_block_anchor_eas"] == [
        0x40BC7B,
        0x40BC89,
        0x40BC8F,
        0x40BC93,
    ...
    assert row147["target_rooted_closures"] == [
        {
            ...
            "owned_native_block_entry_eas": [0x40BC7B, 0x40BC89, 0x40BC8F],
            "root_ea": 0x40BC7B,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40C05B, 0x40C578],
            "expected_generated_block_anchor_eas": [
                0x40C041,
                0x40C04F,
                0x40C055,
            ...
            "owned_native_block_entry_eas": [0x40C041, 0x40C04F, 0x40C055],
            "root_ea": 0x40C041,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
    ]
    assert row147["unavailable_closure_exit_eas"] == []
...
def test_row148_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row148 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 148
    )
    ...
    assert row148["predicate_native_ea"] == 0x40BC87
    assert row148["transfer_native_ea"] == 0x40BC93
    assert row148["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row148["current_generated_proof"] == {
        "accepted_commits": ["bfff07e8b", "5e89d0c17", "e51992c75"],
        "status": "accepted_generated_c6",
    }
    assert row148["owned_corridor_instruction_eas"] == [
        0x40BC7B,
        0x40BC81,
        0x40BC87,
        0x40BC89,
    ...
    assert row148["imported_closure_block_anchor_eas"] == [
        0x40BC95,
        0x40BCA3,
        0x40BCA9,
        0x40BCAD,
    ...
    assert row148["boundary_exit_eas"] == [0x40A5F0, 0x40BCAF, 0x40C367]
    assert row148["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40BCAF],
            "expected_generated_block_anchor_eas": [
                0x40BC95,
                0x40BCA3,
                0x40BCA9,
            ...
            "owned_native_block_entry_eas": [0x40BC95, 0x40BCA3, 0x40BCA9],
            "root_ea": 0x40BC95,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40A5F0, 0x40C367],
            "expected_generated_block_anchor_eas": [
                0x40C34D,
                0x40C35B,
                0x40C361,
            ...
            "owned_native_block_entry_eas": [0x40C34D, 0x40C35B, 0x40C361],
            "root_ea": 0x40C34D,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row149_inventory_owns_producer_and_join_anchor() -> None:
    ...
    assert row149["current_generated_proof"] == {
        "accepted_commits": [
            "fcfa6bd4a",
            "ffa4b4c7f",
            "99f6f24c6",
...
def test_row150_inventory_owns_cmov_producer_and_split_source() -> None:
    ...
    row150 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 150
    )

    assert row150["operation_id"] == "rhad:route@0x40BCC9"
    assert row150["operation_variant"] == "cmov_selected_indirect"
    assert row150["source_native_ea"] == 0x40BCBA
    assert row150["source_block_anchor_ea"] == 0x40BCAF
    ...
    assert row150["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row150["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row150["unavailable_closure_exit_eas"] == []
...
def test_row151_inventory_owns_producer_and_both_target_fragments() -> None:
    ...
    row151 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 151
    )

    assert row151["operation_id"] == "rhad:route@0x40BCE3"
    assert row151["operation_variant"] == "existing_conditional_plus_indirect"
    assert row151["source_native_ea"] == 0x40BCCB
    assert row151["source_block_anchor_ea"] == 0x40BCDF
    assert row151["flag_producer_native_ea"] == 0x40BCD1
    assert row151["predicate_native_ea"] == 0x40BCD7
    assert row151["transfer_native_ea"] == 0x40BCE3
    assert row151["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row151["current_generated_proof"] == {
        "accepted_commits": ["04232522d", "2c38a7a57", "915e09fe9"],
        "status": "accepted_generated_c6",
    }
    assert row151["owned_corridor_instruction_eas"] == [
        0x40BCCB,
        0x40BCD1,
        0x40BCD7,
        0x40BCD9,
    ...
    assert row151["imported_closure_block_anchor_eas"] == [
        0x40BCE5,
        0x40BCF3,
        0x40BCF9,
        0x40BCFD,
    ...
    assert row151["unavailable_closure_exit_eas"] == []
    assert row151["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40C392],
            "expected_generated_block_anchor_eas": [
                0x40BCE5,
                0x40BCF3,
                0x40BCF9,
            ...
            "owned_native_block_entry_eas": [0x40BCE5, 0x40BCF3, 0x40BCF9],
            "root_ea": 0x40BCE5,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40C5FB],
            "expected_generated_block_anchor_eas": [
                0x40C0A0,
                0x40C0AE,
                0x40C0B4,
            ...
            "owned_native_block_entry_eas": [0x40C0A0, 0x40C0AE, 0x40C0B4],
            "root_ea": 0x40C0A0,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row152_inventory_owns_producer_and_both_target_fragments() -> None:
    ...
    row152 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 152
    )

    assert row152["operation_id"] == "rhad:route@0x40BCFD"
    assert row152["operation_variant"] == "existing_conditional_plus_indirect"
    assert row152["source_native_ea"] == 0x40BCE5
    assert row152["source_block_anchor_ea"] == 0x40BCF9
    assert row152["flag_producer_native_ea"] == 0x40BCEB
    assert row152["predicate_native_ea"] == 0x40BCF1
    assert row152["transfer_native_ea"] == 0x40BCFD
    ...
    assert row152["imported_closure_block_anchor_eas"] == [
        0x40BCFF,
        0x40BD0D,
        0x40BD13,
        0x40BD17,
    ...
    assert row152["unavailable_closure_exit_eas"] == []
    assert row152["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40BD19],
            "expected_generated_block_anchor_eas": [
                0x40BCFF,
                0x40BD0D,
                0x40BD13,
            ...
            "owned_native_block_entry_eas": [0x40BCFF, 0x40BD0D, 0x40BD13],
            "root_ea": 0x40BCFF,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            ...
            "owned_native_block_entry_eas": [0x40C392, 0x40C3A0, 0x40C3A6],
            "root_ea": 0x40C392,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row153_inventory_owns_producer_join_and_both_target_fragments() -> None:
    ...
    row153 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 153
    )

    assert row153["operation_id"] == "rhad:route@0x40BD17"
    assert row153["operation_variant"] == "existing_conditional_plus_indirect"
    assert row153["source_native_ea"] == 0x40BCFF
    assert row153["source_block_anchor_ea"] == 0x40BD13
    assert row153["flag_producer_native_ea"] == 0x40BD05
    assert row153["predicate_native_ea"] == 0x40BD0B
    assert row153["transfer_native_ea"] == 0x40BD17
    assert row153["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row153["current_generated_proof"] == {
        "accepted_commits": [
            "c63166143",
            "dea631d46",
            "93f449bca",
    ...
    assert row153["owned_corridor_instruction_eas"] == [
        0x40BCFF,
        0x40BD05,
        0x40BD0B,
        0x40BD0D,
    ...
    assert row153["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BD19,
        0x40BD25,
    ...
    assert row153["unavailable_closure_exit_eas"] == []
    assert row153["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40BD19,
...
def test_row154_inventory_owns_cmov_producer_and_row153_source() -> None:
    ...
    row154 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 154
    )

    assert row154["operation_id"] == "rhad:route@0x40BD4E"
    assert row154["operation_variant"] == "cmov_selected_indirect"
    assert row154["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert row154["source_native_ea"] == 0x40BD2B
    assert row154["source_block_anchor_ea"] == 0x40BD25
    assert row154["flag_producer_native_ea"] == 0x40BD39
    ...
    assert row154["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row154["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row154["unavailable_closure_exit_eas"] == []
...
def test_row155_inventory_owns_producer_and_both_target_fragments() -> None:
    ...
    row155 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 155
    )
    ...
    assert row155["predicate_native_ea"] == 0x40BD5C
    assert row155["transfer_native_ea"] == 0x40BD68
    assert row155["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row155["current_generated_proof"] == {
        "accepted_commits": ["4bf2b4032", "b9b223b3a", "94672278d"],
        "status": "accepted_generated_c6",
    }
    assert row155["owned_corridor_instruction_eas"] == [
        0x40BD50,
        0x40BD56,
        0x40BD5C,
        0x40BD5E,
    ...
    assert row155["imported_closure_block_anchor_eas"] == [
        0x40BD6A,
        0x40BD78,
        0x40BD7E,
        0x40BD82,
    ...
    assert row155["boundary_exit_eas"] == [0x40A5F0, 0x40BD84, 0x40C3F3]
    assert row155["unavailable_closure_exit_eas"] == []
    assert row155["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40BD84],
            "expected_generated_block_anchor_eas": [
                0x40BD6A,
                0x40BD78,
                0x40BD7E,
            ...
            "owned_native_block_entry_eas": [0x40BD6A, 0x40BD78, 0x40BD7E],
            "root_ea": 0x40BD6A,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40A5F0, 0x40C3F3],
            "expected_generated_block_anchor_eas": [
                0x40C3D9,
                0x40C3E7,
                0x40C3ED,
            ...
            "owned_native_block_entry_eas": [0x40C3D9, 0x40C3E7, 0x40C3ED],
            "root_ea": 0x40C3D9,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row156_inventory_owns_producer_join_and_both_target_fragments() -> None:
    ...
    row156 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 156
    )
    ...
    assert row156["predicate_native_ea"] == 0x40BD76
    assert row156["transfer_native_ea"] == 0x40BD82
    assert row156["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row156["current_generated_proof"] == {
        "accepted_commits": [
            "1cb85cf2d",
            "cf063862b",
            "964d80ff9",
    ...
    assert row156["owned_corridor_instruction_eas"] == [
        0x40BD6A,
        0x40BD70,
        0x40BD76,
        0x40BD78,
    ...
    assert row156["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BD84,
        0x40BDBD,
    ...
    assert row156["unavailable_closure_exit_eas"] == []
...
def test_checksum_producer_compiles_row142_cmov_dependency() -> None:
    ...
    operation = plan.operation("rhad:route@0x40BBDD")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    ...
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BBD6"
    assert envelope.join_block_id == "native@0x40BBD9"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 142
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BBCE
    assert payload["source_block_anchor_ea"] == 0x40BBC3
    assert payload["source_value_block_id"] == "native@0x40BBC3"
    assert payload["condition_producer_ea"] == 0x40BBC8
    assert payload["predicate_anchor_ea"] == 0x40BBD6
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BBDD
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BBC8,
...
def test_row158_inventory_owns_producer_and_both_target_fragments() -> None:
    ...
    row158 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 158
    )
    ...
    assert row158["imported_closure_block_anchor_eas"] == [
        0x40BE49,
        0x40BE57,
        0x40BE5D,
        0x40BE61,
    ...
    assert row158["unavailable_closure_exit_eas"] == []
    assert row158["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40BE63],
            "expected_generated_block_anchor_eas": [
                0x40BE49,
                0x40BE57,
                0x40BE5D,
            ...
            "owned_native_block_entry_eas": [0x40BE49, 0x40BE57, 0x40BE5D],
            "root_ea": 0x40BE49,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            ...
            "owned_native_block_entry_eas": [0x40C42E, 0x40C43C, 0x40C442],
            "root_ea": 0x40C42E,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row159_inventory_owns_producer_join_and_complete_targets() -> None:
    ...
    row159 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 159
    )
    ...
    assert row159["predicate_native_ea"] == 0x40BE55
    assert row159["transfer_native_ea"] == 0x40BE61
    assert row159["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row159["current_generated_proof"] == {
        "accepted_commits": [
            "9e47ef2cf",
            "aa353d88e",
            "925031799",
    ...
    assert row159["owned_corridor_instruction_eas"] == [
        0x40BE49,
        0x40BE4F,
        0x40BE55,
        0x40BE57,
    ...
    assert row159["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BE63,
        0x40BE8F,
    ...
    assert row159["unavailable_closure_exit_eas"] == []
...
def test_row160_inventory_owns_cmov_producer_helper_and_complete_targets() -> None:
    ...
    row160 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 160
    )

    assert row160["operation_id"] == "rhad:route@0x40BE96"
    assert row160["operation_variant"] == "cmov_selected_indirect"
    assert row160["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert row160["source_native_ea"] == 0x40BE68
    assert row160["source_block_anchor_ea"] == 0x40BE63
    ...
    assert row160["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row160["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row160["unavailable_closure_exit_eas"] == []
    assert row160["target_rooted_closures"] == [
        {
...
def test_row161_inventory_owns_producer_and_complete_targets() -> None:
    ...
    row161 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 161
    )
    ...
    assert row161["current_generated_proof"] == {
        "accepted_commits": [
            "99af7f17c",
            "2207e6f2b",
            "6306b30e1",
    ...
    assert row161["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BEB2,
        0x40BEC0,
    ...
    assert row161["target_rooted_closures"] == [
        ...
        },
        {
            ...
            "owned_native_block_entry_eas": [0x40C464, 0x40C472, 0x40C478],
            "root_ea": 0x40C464,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row162_inventory_owns_producer_join_and_exact_target_split() -> None:
    ...
    row162 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 162
    )
    ...
    assert row162["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BECC,
        0x40BEDE,
    ...
    assert row162["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert row162["unavailable_closure_exit_eas"] == []
    assert row162["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40BECC,
            ...
            "owned_native_block_entry_eas": [0x40BECC, 0x40BEE1],
            "root_ea": 0x40BECC,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row164_inventory_owns_producer_join_and_complete_targets() -> None:
    ...
    row164 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 164
    )
    ...
    assert row164["current_generated_proof"] == {
        "accepted_commits": ["2815ccfc3", "e278a7b58", "c5d90d454"],
        "status": "accepted_generated_c6",
    }
    ...
    assert row164["semantic_targets"] == [
        {"ea": 0x40BF01, "role": "conditional_taken"},
        {"ea": 0x40C49A, "role": "conditional_fallthrough"},
    ]
    assert row164["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BF01,
        0x40BF0F,
    ...
    assert row164["boundary_exit_eas"] == [0x40A5F0, 0x40BF1B, 0x40C4B4]
    assert row164["unavailable_closure_exit_eas"] == []
    assert row164["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40BF1B],
            "expected_generated_block_anchor_eas": [
                0x40BF01,
                0x40BF0F,
                0x40BF15,
...
def test_row165_inventory_owns_producer_join_and_complete_targets() -> None:
    ...
    row165 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 165
    )
    ...
    assert row165["predicate_native_ea"] == 0x40BF0D
    assert row165["transfer_native_ea"] == 0x40BF19
    ...
    assert row165["semantic_targets"] == [
        {"ea": 0x40BF1B, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row165["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BF1B,
        0x40BF2F,
    ...
    assert row165["unavailable_closure_exit_eas"] == []
    assert row165["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40BF1B,
...
def test_row166_inventory_owns_direct_transfer_and_complete_target() -> None:
    ...
    assert row166["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
...
def test_checksum_producer_compiles_row146_cmov_dependency() -> None:
    ...
    operation = plan.operation("rhad:route@0x40BC5F")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BC4A
    assert normalization.unresolved_transfer_ea == 0x40BC5F
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BC58"
    assert envelope.join_block_id == "native@0x40BC5B"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 146
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BC3C
    assert payload["source_block_anchor_ea"] == 0x40BC36
    assert payload["source_value_block_id"] == "native@0x40BC36"
    assert payload["condition_producer_ea"] == 0x40BC4A
    assert payload["predicate_anchor_ea"] == 0x40BC58
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BC5F
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BC3C,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BC5F"
    ).depends_on == ("rhad:route@0x40BC2B",)


def test_checksum_producer_compiles_row147_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BC79")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BC67
    assert normalization.unresolved_transfer_ea == 0x40BC79
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C041",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BC7B",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BC67
    assert payload["predicate_anchor_ea"] == 0x40BC6D
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xBCDE2EFB
    assert payload["transfer_ea"] == 0x40BC79
    assert payload["true_target_ea"] == 0x40C041
    assert payload["false_target_ea"] == 0x40BC7B
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BC61,
        0x40BC67,
        0x40BC6D,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW147_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [
        0x40BC95,
        0x40C05B,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BC79"
    ).depends_on == ("rhad:route@0x40BC5F",)


def test_checksum_producer_compiles_row148_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BC93")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BC81
    assert normalization.unresolved_transfer_ea == 0x40BC93
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C34D",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BC95",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BC81
    assert payload["predicate_anchor_ea"] == 0x40BC87
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xB5D98F1E
    assert payload["transfer_ea"] == 0x40BC93
    assert payload["true_target_ea"] == 0x40C34D
    assert payload["false_target_ea"] == 0x40BC95
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BC7B,
        0x40BC81,
        0x40BC87,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW148_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40BCAF, 0x40C367]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BC93"
    ).depends_on == ("rhad:route@0x40BC79",)


def test_checksum_producer_compiles_row149_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BCAD")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BC9B
    assert normalization.unresolved_transfer_ea == 0x40BCAD
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40A5F0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BCAF",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 149
    assert payload["source_native_ea"] == 0x40BC95
    assert payload["source_block_anchor_ea"] == 0x40BCA9
    assert payload["condition_producer_ea"] == 0x40BC9B
    assert payload["predicate_anchor_ea"] == 0x40BCA1
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xB34CE2DF
    assert payload["transfer_ea"] == 0x40BCAD
    assert payload["true_target_ea"] == 0x40A5F0
    assert payload["false_target_ea"] == 0x40BCAF
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BC95,
        0x40BC9B,
        0x40BCA1,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW149_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BCAD"
    ).depends_on == ("rhad:route@0x40BC93",)


def test_checksum_producer_compiles_row150_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BCC9")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BCB4
    assert normalization.unresolved_transfer_ea == 0x40BCC9
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BCC2"
    assert envelope.join_block_id == "native@0x40BCC5"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 150
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BCBA
    assert payload["source_block_anchor_ea"] == 0x40BCAF
    assert payload["source_value_block_id"] == "native@0x40BCAF"
    assert payload["condition_producer_ea"] == 0x40BCB4
    assert payload["predicate_anchor_ea"] == 0x40BCC2
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BCC9
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BCB4,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BCC9"
    ).depends_on == ("rhad:route@0x40BCAD",)


def test_checksum_producer_compiles_row151_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BCE3")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BCD1
    assert normalization.unresolved_transfer_ea == 0x40BCE3
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C0A0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BCE5",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BCD1
    assert payload["predicate_anchor_ea"] == 0x40BCD7
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xFED7FAC0
    assert payload["transfer_ea"] == 0x40BCE3
    assert payload["true_target_ea"] == 0x40C0A0
    assert payload["false_target_ea"] == 0x40BCE5
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BCCB,
        0x40BCD1,
        0x40BCD7,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW151_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40C392, 0x40C5FB]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BCE3"
    ).depends_on == ("rhad:route@0x40BCC9",)
    assert {"native@0x40BCE5", "native@0x40C0A0"}.issubset(
        batch.native_body_entry_block_ids
    )

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BCCB].boundary_exit_eas == (0x40BCE5, 0x40C0A0)
    assert templates[0x40BCE5].owned_ranges == (
        (0x40BCE5, 0x40BCF3),
        (0x40BCF3, 0x40BCF9),
        (0x40BCF9, 0x40BCFF),
    )
    assert templates[0x40BCE5].owned_block_entry_eas == (
        0x40BCE5,
        0x40BCF3,
        0x40BCF9,
    )
    assert templates[0x40BCE5].boundary_exit_eas == (0x40BCFF, 0x40C392)
    assert templates[0x40BCE5].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BCFD,
            boundary_exit_eas=(0x40BCFF, 0x40C392),
        ),
    )
    assert templates[0x40C0A0].owned_ranges == (
        (0x40C0A0, 0x40C0AE),
        (0x40C0AE, 0x40C0B4),
        (0x40C0B4, 0x40C0BA),
    )
    assert templates[0x40C0A0].owned_block_entry_eas == (
        0x40C0A0,
        0x40C0AE,
        0x40C0B4,
    )
    assert templates[0x40C0A0].boundary_exit_eas == (0x40C0BA, 0x40C5FB)
    assert templates[0x40C0A0].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C0B8,
            boundary_exit_eas=(0x40C0BA, 0x40C5FB),
        ),
    )


def test_checksum_producer_compiles_row152_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BCFD")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BCEB
    assert normalization.unresolved_transfer_ea == 0x40BCFD
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C392",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BCFF",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BCEB
    assert payload["predicate_anchor_ea"] == 0x40BCF1
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xFA72F85A
    assert payload["transfer_ea"] == 0x40BCFD
    assert payload["true_target_ea"] == 0x40C392
    assert payload["false_target_ea"] == 0x40BCFF
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BCE5,
        0x40BCEB,
        0x40BCF1,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW152_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40BD19]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BCFD"
    ).depends_on == ("rhad:route@0x40BCE3",)
    assert {"native@0x40BCFF", "native@0x40C392"}.issubset(
        batch.native_body_entry_block_ids
    )

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BCE5].boundary_exit_eas == (0x40BCFF, 0x40C392)
    assert templates[0x40BCFF].owned_ranges == (
        (0x40BCFF, 0x40BD0D),
        (0x40BD0D, 0x40BD13),
        (0x40BD13, 0x40BD19),
    )
    assert templates[0x40BCFF].owned_block_entry_eas == (
        0x40BCFF,
        0x40BD0D,
        0x40BD13,
    )
    assert templates[0x40BCFF].boundary_exit_eas == (0x40A5F0, 0x40BD19)
    assert templates[0x40BCFF].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BD17,
            boundary_exit_eas=(0x40A5F0, 0x40BD19),
        ),
    )
    assert templates[0x40C392].owned_ranges == (
        (0x40C392, 0x40C3A0),
        (0x40C3A0, 0x40C3A6),
        (0x40C3A6, 0x40C3AC),
    )
    assert templates[0x40C392].owned_block_entry_eas == (
        0x40C392,
        0x40C3A0,
        0x40C3A6,
    )
    assert templates[0x40C392].boundary_exit_eas == (0x40A5F0, 0x40C3AC)
    assert templates[0x40C392].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C3AA,
            boundary_exit_eas=(0x40A5F0, 0x40C3AC),
        ),
    )


def test_checksum_producer_compiles_row153_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BD17")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BD05
    assert normalization.unresolved_transfer_ea == 0x40BD17
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40A5F0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BD19",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BD05
    assert payload["predicate_anchor_ea"] == 0x40BD0B
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xF7088159
    assert payload["transfer_ea"] == 0x40BD17
    assert payload["true_target_ea"] == 0x40A5F0
    assert payload["false_target_ea"] == 0x40BD19
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BCFF,
        0x40BD05,
        0x40BD0B,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BD17"
    ).depends_on == ("rhad:route@0x40BCFD",)
    assert "native@0x40BD19" in batch.native_body_entry_block_ids
    ...
    assert templates[0x40BD19].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BD4E,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row154_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BD4E")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BD39
    assert normalization.unresolved_transfer_ea == 0x40BD4E
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BD47"
    assert envelope.join_block_id == "native@0x40BD4A"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 154
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BD2B
    assert payload["source_block_anchor_ea"] == 0x40BD25
    assert payload["source_value_block_id"] == "native@0x40BD25"
    assert payload["condition_producer_ea"] == 0x40BD39
    assert payload["predicate_anchor_ea"] == 0x40BD47
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BD4E
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BD2B,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BD4E"
    ).depends_on == ("rhad:route@0x40BD17",)
    assert "rhad:route@0x40BD4E" in batch.native_body_proof_ids


def test_checksum_producer_compiles_row155_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BD68")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BD56
    assert normalization.unresolved_transfer_ea == 0x40BD68
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BD5E"
    assert envelope.join_block_id == "native@0x40BD64"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C3D9",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BD6A",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BD56
    assert payload["predicate_anchor_ea"] == 0x40BD5C
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x96B0D1E5
    assert payload["transfer_ea"] == 0x40BD68
    assert payload["true_target_ea"] == 0x40C3D9
    assert payload["false_target_ea"] == 0x40BD6A
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BD50,
        0x40BD56,
        0x40BD5C,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW155_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW155_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40BD6A",
        "native@0x40BD78",
        "native@0x40BD7E",
        "native@0x40BD82",
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40BD84, 0x40C3F3]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BD68"
    ).depends_on == ("rhad:route@0x40BD4E",)
    assert {"native@0x40BD6A", "native@0x40C3D9"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40BD68" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BD50].boundary_exit_eas == (0x40BD6A, 0x40C3D9)
    assert templates[0x40BD6A].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BD82,
            boundary_exit_eas=(0x40A5F0, 0x40BD84),
        ),
    )
    assert templates[0x40C3D9].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C3F1,
            boundary_exit_eas=(0x40A5F0, 0x40C3F3),
        ),
    )


def test_checksum_producer_compiles_row156_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BD82")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BD70
    assert normalization.unresolved_transfer_ea == 0x40BD82
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BD78"
    assert envelope.join_block_id == "native@0x40BD7E"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40A5F0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BD84",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 156
    assert payload["source_native_ea"] == 0x40BD6A
    assert payload["source_block_anchor_ea"] == 0x40BD7E
    assert payload["condition_producer_ea"] == 0x40BD70
    assert payload["predicate_anchor_ea"] == 0x40BD76
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["comparison_constant"] == 0x921C6083
    assert payload["transfer_ea"] == 0x40BD82
    assert payload["true_target_ea"] == 0x40A5F0
    assert payload["false_target_ea"] == 0x40BD84
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW156_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
    ...
    assert templates[0x40BD84].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BE2D,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row157_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BE2D")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BE1E
    assert normalization.unresolved_transfer_ea == 0x40BE2D
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BE26"
    assert envelope.join_block_id == "native@0x40BE29"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 157
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BDFC
    assert payload["source_block_anchor_ea"] == 0x40BE0A
    assert payload["source_value_block_id"] == "native@0x40BDD5"
    assert payload["condition_producer_ea"] == 0x40BE1E
    assert payload["predicate_anchor_ea"] == 0x40BE26
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BE2D
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BDFC,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BE2D"
    ).depends_on == ("rhad:route@0x40BD82",)
    assert "native@0x40BE26" in generated_reference.ROW156_TARGET_IMPORTED_BLOCK_IDS
    assert "rhad:route@0x40BE2D" in batch.native_body_proof_ids


def test_checksum_producer_compiles_row158_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BE47")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BE35
    assert normalization.unresolved_transfer_ea == 0x40BE47
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BE3D"
    assert envelope.join_block_id == "native@0x40BE43"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C42E",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BE49",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BE35
    assert payload["predicate_anchor_ea"] == 0x40BE3B
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xD44F0C43
    assert payload["transfer_ea"] == 0x40BE47
    assert payload["true_target_ea"] == 0x40C42E
    assert payload["false_target_ea"] == 0x40BE49
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BE2F,
        0x40BE35,
        0x40BE3B,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW158_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW158_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40BE49",
        "native@0x40BE57",
        "native@0x40BE5D",
        "native@0x40BE61",
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40BE63]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BE47"
    ).depends_on == ("rhad:route@0x40BE2D",)
    assert {"native@0x40BE49", "native@0x40C42E"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40BE47" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BE2F].boundary_exit_eas == (0x40BE49, 0x40C42E)
    assert templates[0x40BE49].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BE61,
            boundary_exit_eas=(0x40A5F0, 0x40BE63),
        ),
    )
    assert templates[0x40C42E].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
...
def test_checksum_producer_compiles_row159_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BE61")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BE4F
    assert normalization.unresolved_transfer_ea == 0x40BE61
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BE57"
    assert envelope.join_block_id == "native@0x40BE5D"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40A5F0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BE63",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BE4F
    assert payload["predicate_anchor_ea"] == 0x40BE55
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xCEA36423
    assert payload["transfer_ea"] == 0x40BE61
    assert payload["true_target_ea"] == 0x40A5F0
    assert payload["false_target_ea"] == 0x40BE63
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BE49,
        0x40BE4F,
        0x40BE55,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW159_TARGET_IMPORTED_BLOCK_IDS
    )
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BE61"
    ).depends_on == ("rhad:route@0x40BE47",)
    assert "native@0x40BE63" in batch.native_body_entry_block_ids
    assert "rhad:route@0x40BE61" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BE49].boundary_exit_eas == (0x40A5F0, 0x40BE63)
    assert templates[0x40BE63].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BE96,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row160_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BE96")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BE81
    assert normalization.unresolved_transfer_ea == 0x40BE96
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BE8F"
    assert envelope.join_block_id == "native@0x40BE92"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 160
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BE68
    assert payload["source_block_anchor_ea"] == 0x40BE63
    assert payload["source_value_block_id"] == "native@0x40BE63"
    assert payload["condition_producer_ea"] == 0x40BE81
    assert payload["predicate_anchor_ea"] == 0x40BE8F
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BE96
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BE68,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BE96"
    ).depends_on == ("rhad:route@0x40BE61",)
    assert "native@0x40BE63" in batch.native_body_entry_block_ids
    assert "native@0x40BE92" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40BE8F"
    ).stable_identity.exact_instruction_eas == frozenset({0x40BE8F})
    assert "rhad:route@0x40BE96" in batch.native_body_proof_ids


def test_checksum_producer_compiles_row161_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BEB0")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BE9E
    assert normalization.unresolved_transfer_ea == 0x40BEB0
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BEA6"
    assert envelope.join_block_id == "native@0x40BEAC"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BEB2",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C464",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BE9E
    assert payload["predicate_anchor_ea"] == 0x40BEA4
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xAE5A330B
    assert payload["transfer_ea"] == 0x40BEB0
    assert payload["true_target_ea"] == 0x40BEB2
    assert payload["false_target_ea"] == 0x40C464
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BE98,
        0x40BE9E,
        0x40BEA4,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW161_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW161_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40BEB2",
        "native@0x40BEC0",
        "native@0x40BEC6",
        "native@0x40BECA",
    ...
    assert templates[0x40C464].boundary_exit_eas == (0x40A5F0, 0x40C47E)


def test_checksum_producer_compiles_row162_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BECA")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BEB8
    assert normalization.unresolved_transfer_ea == 0x40BECA
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BEC0"
    assert envelope.join_block_id == "native@0x40BEC6"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40A5F0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BECC",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BEB8
    assert payload["predicate_anchor_ea"] == 0x40BEBE
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xABB95547
    assert payload["transfer_ea"] == 0x40BECA
    assert payload["true_target_ea"] == 0x40A5F0
    assert payload["false_target_ea"] == 0x40BECC
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BEB2,
        0x40BEB8,
        0x40BEBE,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW162_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW162_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40BECC",
        "native@0x40BEDE",
        "native@0x40BEE1",
        "native@0x40BEE5",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BECA"
    ).depends_on == ("rhad:route@0x40BEB0",)
    ...
    assert "rhad:route@0x40BECA" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BECC].owned_ranges == (
        (0x40BECC, 0x40BEE1),
        (0x40BEE1, 0x40BEE7),
    )
    assert templates[0x40BECC].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
...
def test_checksum_producer_compiles_row163_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BEE5")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BED0
    assert normalization.unresolved_transfer_ea == 0x40BEE5
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BEDE"
    assert envelope.join_block_id == "native@0x40BEE1"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 163
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BED6
    assert payload["source_block_anchor_ea"] == 0x40BECC
    assert payload["source_value_block_id"] == "native@0x40BECC"
    assert payload["condition_producer_ea"] == 0x40BED0
    assert payload["predicate_anchor_ea"] == 0x40BEDE
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BEE5
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BED0,
...
def test_checksum_producer_compiles_row164_existing_dependency() -> None:
    ...
    operation = plan.operation("rhad:route@0x40BEFF")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BEED
    assert normalization.unresolved_transfer_ea == 0x40BEFF
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BEF5"
    assert envelope.join_block_id == "native@0x40BEFB"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BF01",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C49A",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    ...
    assert payload["condition_producer_ea"] == 0x40BEED
    assert payload["predicate_anchor_ea"] == 0x40BEF3
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xF6A636EF
    assert payload["transfer_ea"] == 0x40BEFF
    assert payload["true_target_ea"] == 0x40BF01
    assert payload["false_target_ea"] == 0x40C49A
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BEE7,
        0x40BEED,
        0x40BEF3,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW164_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW164_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40BF01",
        "native@0x40BF0F",
        "native@0x40BF15",
        "native@0x40BF19",
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40BF1B, 0x40C4B4]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BEFF"
    ).depends_on == ("rhad:route@0x40BEE5",)
    assert {
        "native@0x40BF01",
        "native@0x40BF0F",
        "native@0x40BF15",
    ...
    assert plan.block(
        "native@0x40BF19"
    ).stable_identity.exact_instruction_eas == frozenset({0x40BF19})
    assert plan.block(
        "native@0x40C4B2"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C4B2})
    assert "rhad:route@0x40BEFF" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BF01].owned_ranges == (
        (0x40BF01, 0x40BF0F),
        (0x40BF0F, 0x40BF15),
        (0x40BF15, 0x40BF1B),
    )
    assert templates[0x40BF01].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BF19,
            boundary_exit_eas=(0x40A5F0, 0x40BF1B),
        ),
    )
    assert templates[0x40C49A].owned_ranges == (
        (0x40C49A, 0x40C4A8),
        (0x40C4A8, 0x40C4AE),
        (0x40C4AE, 0x40C4B4),
    )
    assert templates[0x40C49A].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
...
def test_checksum_producer_compiles_row166_simple_indirect_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40BF8A")
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert operation.source_block_id == "native@0x40BF80"
    assert rewrite.rewrite_anchor_ea == 0x40BF8A
    assert rewrite.owner_anchor_ea == 0x40BF80
    assert operation.edges[0].target_block_id == "native@0x40B6C0"
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_operation_id"] == "rhad:route@0x40BF8A"
    assert payload["reference_order"] == 166
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40BF68
    assert payload["source_block_anchor_ea"] == 0x40BF80
    assert payload["transfer_ea"] == 0x40BF8A
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BF68,
        0x40BF80,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40BF8A"
    ).depends_on == ("rhad:route@0x40BF19",)
    assert "route:rhad-direct@0x40BF8A" in batch.native_body_proof_ids


def test_checksum_producer_compiles_row167_setcc_table_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BFA2")
    normalization = operation.computed_branch_normalization
    assert isinstance(normalization, FragmentSetccIndexedTableNormalization)
    assert normalization.predicate_kind is PredicateKind.SGE
    assert (
    ...
    assert normalization.condition_producer_ea == 0x40BF8E
    assert normalization.unresolved_transfer_ea == 0x40BFA2
    evidence = normalization.table_evidence
    assert evidence.table_base_ea == 0x48B4D4
    assert evidence.index_scaling.kind.value == "explicit_shift"
    assert evidence.index_scaling.shift_ea == 0x40BF97
    assert evidence.index_scaling.shift_bits == 5
    assert evidence.stride_bytes == 0x20
    assert evidence.true_entry.raw_value == 0x0252A85B
    assert evidence.true_entry.decoded_target_ea == 0x40C4DC
    assert evidence.false_entry.raw_value == 0x0252A323
    assert evidence.false_entry.decoded_target_ea == 0x40BFA4
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C4DC",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BFA4",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 167
    assert payload["reference_symbol"] == "JumpInliner._fixup_index_access"
    assert payload["operation_variant"] == "setcc_indexed_table"
    assert payload["source_native_ea"] == 0x40BF8C
    assert payload["condition_producer_ea"] == 0x40BF8E
    assert payload["predicate_anchor_ea"] == 0x40BF94
    assert payload["fallthrough_delivery"] == "planned_helper"
    assert payload["transfer_ea"] == 0x40BFA2
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BF8C,
        0x40BF8E,
        0x40BF94,
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0]
    assert payload["proof_artifact"]["content_identity"] == artifact_identity
    assert batch.proof_artifact_identities[-1] == artifact_identity
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BFA2"
    ).depends_on == ("route:rhad-direct@0x40BF8A",)
    assert "rhad:route@0x40BFA2" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BFA4].owned_ranges == (
        (0x40BFA4, 0x40BFB2),
        (0x40BFB2, 0x40BFB8),
        (0x40BFB8, 0x40BFBE),
    )
    assert templates[0x40BFA4].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40BFBC,
            boundary_exit_eas=(0x40A5F0,),
        ),
    )
    assert templates[0x40C4DC].owned_ranges == (
        (0x40C4DC, 0x40C4EA),
        (0x40C4EA, 0x40C4F0),
        (0x40C4F0, 0x40C4F6),
    )
    assert templates[0x40C4DC].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C4F4,
            boundary_exit_eas=(0x40A5F0,),
        ),
    )
...
def test_row168_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row168 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 168
    )

    assert len(inventory["operations"]) == 228
    assert row168["operation_id"] == "rhad:route@0x40BFBC"
    assert row168["operation_variant"] == "existing_conditional_plus_indirect"
    assert row168["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row168["source_native_ea"] == 0x40BFA4
    assert row168["source_block_anchor_ea"] == 0x40BFB8
    assert row168["flag_producer_native_ea"] == 0x40BFAA
    assert row168["predicate_native_ea"] == 0x40BFB0
    assert row168["transfer_native_ea"] == 0x40BFBC
    assert row168["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row168["current_generated_proof"] == {
        "accepted_commits": [
            "e83b9518a",
            "0e631aa3b",
            "103882646",
    ...
    assert row168["owned_corridor_instruction_eas"] == [
        0x40BFA4,
        0x40BFAA,
        0x40BFB0,
        0x40BFB2,
    ...
    assert row168["semantic_targets"] == [
        {"ea": 0x40BFBE, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row168["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BFBE,
        0x40BFD1,
    ...
    assert row168["unavailable_closure_exit_eas"] == []
...
def test_checksum_producer_compiles_row168_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BFBC")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BFAA
    assert normalization.unresolved_transfer_ea == 0x40BFBC
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BFB2"
    assert envelope.join_block_id == "native@0x40BFB8"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BFBE",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 168
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40BFA4
    assert payload["source_block_anchor_ea"] == 0x40BFB8
    assert payload["condition_producer_ea"] == 0x40BFAA
    assert payload["predicate_anchor_ea"] == 0x40BFB0
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xA0DBF1FA
    assert payload["transfer_ea"] == 0x40BFBC
    assert payload["true_target_ea"] == 0x40BFBE
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BFA4,
        0x40BFAA,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW168_TARGET_IMPORTED_BLOCK_IDS
    )
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BFBC"
    ).depends_on == ("rhad:route@0x40BFA2",)
    assert "native@0x40BFBE" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40BFD8"
    ).stable_identity.exact_instruction_eas == frozenset({0x40BFD8})
...
def test_row169_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row169 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 169
    )

    assert len(inventory["operations"]) == 228
    assert row169["operation_id"] == "rhad:route@0x40BFD8"
    assert row169["operation_variant"] == "cmov_selected_indirect"
    assert row169["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert row169["source_native_ea"] == 0x40BFC9
    assert row169["source_block_anchor_ea"] == 0x40BFBE
    ...
    assert row169["current_generated_proof"] == {
        "accepted_commits": [
            "e3d7245e3",
            "b69a09f38",
            "9a496bae5",
    ...
    assert row169["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row169["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row169["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row169["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row169["target_rooted_closures"]
    )


def test_checksum_producer_compiles_row169_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BFD8")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BFC3
    assert normalization.unresolved_transfer_ea == 0x40BFD8
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BFD1"
    assert envelope.join_block_id == "native@0x40BFD4"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 169
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40BFC9
    assert payload["source_block_anchor_ea"] == 0x40BFBE
    assert payload["source_value_block_id"] == "native@0x40BFBE"
    assert payload["condition_producer_ea"] == 0x40BFC3
    assert payload["predicate_anchor_ea"] == 0x40BFD1
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40BFD8
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BFC3,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BFD8"
    ).depends_on == ("rhad:route@0x40BFBC",)
    assert "rhad:route@0x40BFD8" in batch.native_body_proof_ids
...
def test_row170_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row170 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 170
    )

    assert len(inventory["operations"]) == 228
    assert row170["operation_id"] == "rhad:route@0x40BFF2"
    assert row170["operation_variant"] == "existing_conditional_plus_indirect"
    assert row170["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row170["source_native_ea"] == 0x40BFDA
    assert row170["source_block_anchor_ea"] == 0x40BFEE
    ...
    assert row170["semantic_targets"] == [
        {"ea": 0x40BFF4, "role": "conditional_taken"},
        {"ea": 0x40C527, "role": "conditional_fallthrough"},
    ]
    assert row170["imported_closure_block_anchor_eas"] == [
        0x40BFF4,
        0x40C002,
        0x40C008,
        0x40C00C,
    ...
    assert row170["boundary_exit_eas"] == [0x40A5F0, 0x40C00E, 0x40C541]
    assert row170["unavailable_closure_exit_eas"] == []
    assert row170["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40C00E],
            "expected_generated_block_anchor_eas": [
                0x40BFF4,
                0x40C002,
                0x40C008,
            ...
            "owned_native_block_entry_eas": [0x40BFF4, 0x40C008],
            "root_ea": 0x40BFF4,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40A5F0, 0x40C541],
            "expected_generated_block_anchor_eas": [
                0x40C527,
                0x40C535,
                0x40C53B,
            ...
            "owned_native_block_entry_eas": [0x40C527, 0x40C53B],
            "root_ea": 0x40C527,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_checksum_producer_compiles_row170_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BFF2")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BFE0
    assert normalization.unresolved_transfer_ea == 0x40BFF2
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40BFE8"
    assert envelope.join_block_id == "native@0x40BFEE"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BFF4",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C527",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 170
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40BFDA
    assert payload["source_block_anchor_ea"] == 0x40BFEE
    assert payload["condition_producer_ea"] == 0x40BFE0
    assert payload["predicate_anchor_ea"] == 0x40BFE6
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xEC054ACC
    assert payload["transfer_ea"] == 0x40BFF2
    assert payload["true_target_ea"] == 0x40BFF4
    assert payload["false_target_ea"] == 0x40C527
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BFDA,
        0x40BFE0,
        0x40BFE6,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW170_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW170_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40BFF4",
        "native@0x40C002",
        "native@0x40C008",
        "native@0x40C00C",
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40C00E, 0x40C541]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BFF2"
    ).depends_on == ("rhad:route@0x40BFD8",)
    assert "native@0x40BFF4" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40BFF4"
    ).stable_identity.exact_instruction_eas == frozenset({0x40BFF4, 0x40BFFA, 0x40C000})
    assert plan.block(
        "native@0x40C00C"
    ...
    assert plan.block(
        "native@0x40C527"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C527, 0x40C52D, 0x40C533})
    assert "rhad:route@0x40BFF2" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40BFF4].owned_ranges == (
        (0x40BFF4, 0x40C008),
        (0x40C008, 0x40C00E),
    )
    assert templates[0x40BFF4].owned_block_entry_eas == (0x40BFF4, 0x40C008)
    assert templates[0x40BFF4].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C00C,
            boundary_exit_eas=(0x40A5F0, 0x40C00E),
        ),
    )
    assert templates[0x40C527].owned_ranges == (
        (0x40C527, 0x40C53B),
        (0x40C53B, 0x40C541),
    )
    assert templates[0x40C527].owned_block_entry_eas == (0x40C527, 0x40C53B)
    assert templates[0x40C527].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C53F,
            boundary_exit_eas=(0x40A5F0, 0x40C541),
        ),
    )
...
def test_row171_inventory_owns_producer_join_and_complete_target_closures() -> None:
    ...
    row171 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 171
    )

    assert len(inventory["operations"]) == 228
    assert row171["operation_id"] == "rhad:route@0x40C00C"
    assert row171["operation_variant"] == "existing_conditional_plus_indirect"
    assert row171["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row171["source_native_ea"] == 0x40BFF4
    assert row171["source_block_anchor_ea"] == 0x40C008
    ...
    assert row171["semantic_targets"] == [
        {"ea": 0x40C00E, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row171["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C00E,
        0x40C027,
    ...
    assert row171["unavailable_closure_exit_eas"] == []
    assert row171["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40C00E,
...
def test_checksum_producer_compiles_row171_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C00C")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BFFA
    assert normalization.unresolved_transfer_ea == 0x40C00C
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C002"
    assert envelope.join_block_id == "native@0x40C008"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C00E",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 171
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40BFF4
    assert payload["source_block_anchor_ea"] == 0x40C008
    assert payload["condition_producer_ea"] == 0x40BFFA
    assert payload["predicate_anchor_ea"] == 0x40C000
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xE6B7ADA3
    assert payload["transfer_ea"] == 0x40C00C
    assert payload["true_target_ea"] == 0x40C00E
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BFF4,
        0x40BFFA,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW171_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW171_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C00E",
        "native@0x40C027",
        "native@0x40C03B",
        "native@0x40C03F",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C00C"
    ).depends_on == ("rhad:route@0x40BFF2",)
    assert "native@0x40C00E" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40C00E"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C00E, 0x40C010, 0x40C014, 0x40C018, 0x40C01C, 0x40C021}
    )
    assert plan.block(
        "native@0x40C03F"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C03F})
    assert plan.block(
        "native@0x40C730"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C730, 0x40C735, 0x40C73B, 0x40C741, 0x40C743}
    )
    assert plan.block(
        "native@0x40C74F"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C74F})
    assert "rhad:route@0x40C00C" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C00E].owned_ranges == (
        (0x40C00E, 0x40C041),
        (0x40C730, 0x40C751),
    )
    assert templates[0x40C00E].owned_block_entry_eas == (
        0x40C00E,
        0x40C027,
        0x40C03B,
        0x40C730,
    ...
    assert templates[0x40C00E].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C03F,
            boundary_exit_eas=(0x40B6C0,),
        ),
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C74F,
            boundary_exit_eas=(0x40A607,),
        ),
    )


def test_checksum_producer_compiles_row172_simple_indirect_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C03F")
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert operation.source_block_id == "native@0x40C03B"
    assert rewrite.rewrite_anchor_ea == 0x40C03F
    assert rewrite.owner_anchor_ea == 0x40C03B
    assert operation.edges[0].target_block_id == "native@0x40B6C0"
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_operation_id"] == "rhad:route@0x40C03F"
    assert payload["reference_order"] == 172
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C027
    assert payload["source_block_anchor_ea"] == 0x40C03B
    assert payload["transfer_ea"] == 0x40C03F
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C027,
        0x40C03B,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C03F"
    ).depends_on == ("rhad:route@0x40C00C",)
    assert "route:rhad-direct@0x40C03F" in batch.native_body_proof_ids
...
def test_row172_inventory_records_complete_direct_route_evidence() -> None:
    ...
    row172 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 172
    )

    assert len(inventory["operations"]) == 228
    assert row172["operation_id"] == "rhad:route@0x40C03F"
    assert row172["operation_variant"] == "simple_indirect_jump"
    assert row172["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row172["source_native_ea"] == 0x40C027
    assert row172["source_block_anchor_ea"] == 0x40C03B
    assert row172["transfer_native_ea"] == 0x40C03F
    assert row172["flag_producer_native_ea"] is None
    assert row172["predicate_native_ea"] is None
    assert row172["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row172["current_generated_proof"] == {
        "accepted_commits": ["825d139f5", "44003e572"],
        "status": "accepted_generated_c6",
    }
    assert row172["owned_corridor_instruction_eas"] == [
        0x40C027,
        0x40C03B,
        0x40C03D,
        0x40C03F,
    ]
    assert row172["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row172["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row172["unavailable_closure_exit_eas"] == []
    assert row172["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row173_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row173 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 173
    )

    assert len(inventory["operations"]) == 228
    assert row173["operation_id"] == "rhad:route@0x40C059"
    assert row173["operation_variant"] == "existing_conditional_plus_indirect"
    assert row173["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row173["source_native_ea"] == 0x40C041
    assert row173["source_block_anchor_ea"] == 0x40C055
    assert row173["flag_producer_native_ea"] == 0x40C047
    assert row173["predicate_native_ea"] == 0x40C04D
    assert row173["transfer_native_ea"] == 0x40C059
    assert row173["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row173["current_generated_proof"] == {
        "accepted_commits": [
            "61214cb90",
            "099f1b2a7",
            "4ce828730",
    ...
    assert row173["owned_corridor_instruction_eas"] == [
        0x40C041,
        0x40C047,
        0x40C04D,
        0x40C04F,
    ...
    assert row173["semantic_targets"] == [
        {"ea": 0x40C05B, "role": "conditional_taken"},
        {"ea": 0x40C578, "role": "conditional_fallthrough"},
    ]
    assert row173["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C05B,
        0x40C069,
    ...
    assert row173["target_rooted_closures"] == [
        ...
        {
            "boundary_exit_eas": [0x40A5F0, 0x40C592],
            "expected_generated_block_anchor_eas": [
                0x40C578,
                0x40C586,
                0x40C58C,
            ...
            "owned_native_block_entry_eas": [0x40C578, 0x40C586, 0x40C58C],
            "root_ea": 0x40C578,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_checksum_producer_compiles_row173_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C059")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C047
    assert normalization.unresolved_transfer_ea == 0x40C059
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C04F"
    assert envelope.join_block_id == "native@0x40C055"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C05B",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C578",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 173
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C041
    assert payload["source_block_anchor_ea"] == 0x40C055
    assert payload["condition_producer_ea"] == 0x40C047
    assert payload["predicate_anchor_ea"] == 0x40C04D
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0xBD9A2C2A
    assert payload["transfer_ea"] == 0x40C059
    assert payload["true_target_ea"] == 0x40C05B
    assert payload["false_target_ea"] == 0x40C578
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C041,
        0x40C047,
        0x40C04D,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW173_TARGET_IMPORTED_BLOCK_IDS
    )
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C059"
    ).depends_on == ("route:rhad-direct@0x40C03F",)
    assert "native@0x40C05B" in batch.native_body_entry_block_ids
    ...
    assert templates[0x40C578].owned_block_entry_eas == (
        0x40C578,
        0x40C586,
        0x40C58C,
    )
    assert templates[0x40C578].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C590,
            boundary_exit_eas=(0x40A5F0, 0x40C592),
        ),
    )
...
def test_row174_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    row174 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 174
    )

    assert len(inventory["operations"]) == 228
    assert row174["operation_id"] == "rhad:route@0x40C073"
    assert row174["operation_variant"] == "existing_conditional_plus_indirect"
    assert row174["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    ...
    assert row174["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row174["current_generated_proof"] == {
        "accepted_commits": [
            "cb495863e",
            "03bd6945b",
            "6d8e06f47",
    ...
    assert row174["owned_corridor_instruction_eas"] == [
        0x40C05B,
        0x40C061,
        0x40C067,
        0x40C069,
    ...
    assert row174["semantic_targets"] == [
        {"ea": 0x40C075, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row174["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C075,
        0x40C088,
    ...
    assert row174["unavailable_closure_exit_eas"] == []
    assert row174["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40C075,
...
def test_checksum_producer_compiles_row174_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C073")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C061
    assert normalization.unresolved_transfer_ea == 0x40C073
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C069"
    assert envelope.join_block_id == "native@0x40C06F"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C075",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 174
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C05B
    assert payload["source_block_anchor_ea"] == 0x40C06F
    assert payload["condition_producer_ea"] == 0x40C061
    assert payload["predicate_anchor_ea"] == 0x40C067
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xBCDE2EFB
    assert payload["transfer_ea"] == 0x40C073
    assert payload["true_target_ea"] == 0x40C075
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C05B,
        0x40C061,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW174_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW174_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C075",
        "native@0x40C088",
        "native@0x40C09A",
        "native@0x40C09E",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C073"
    ).depends_on == ("rhad:route@0x40C059",)
    assert "native@0x40C075" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40C075"
    ).stable_identity.exact_instruction_eas == frozenset(
    ...
    assert plan.block(
        "native@0x40C09A"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C09A, 0x40C09C, 0x40C09E})
    assert plan.block(
        "native@0x40C09E"
    ...
    assert plan.block(
        ...
        {0x40C768, 0x40C76A, 0x40C76C, 0x40C76E}
    )
    assert plan.block(
        "native@0x40C76E"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C76E})
    assert "rhad:route@0x40C073" in batch.native_body_proof_ids
...
def test_checksum_producer_compiles_row175_simple_indirect_dependency() -> None:
    ...
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert operation.source_block_id == "native@0x40C09A"
    assert rewrite.rewrite_anchor_ea == 0x40C09E
    assert rewrite.owner_anchor_ea == 0x40C09A
    assert operation.edges[0].target_block_id == "native@0x40B6C0"
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_operation_id"] == "rhad:route@0x40C09E"
    assert payload["reference_order"] == 175
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C088
    assert payload["source_block_anchor_ea"] == 0x40C09A
    assert payload["transfer_ea"] == 0x40C09E
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C088,
        0x40C09A,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C09E"
    ).depends_on == ("rhad:route@0x40C073",)
    assert "route:rhad-direct@0x40C09E" in batch.native_body_proof_ids
...
def test_row176_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row176 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 176
    )
    ...
    assert row176["current_generated_proof"] == {
        "accepted_commits": ["09d4a50a1", "e0b072118", "09e9cb826"],
        "status": "accepted_generated_c6",
    }
    ...
    assert row176["source_block_anchor_ea"] == 0x40C0B4
    assert row176["transfer_native_ea"] == 0x40C0B8
    assert row176["owned_corridor_instruction_eas"] == [
        0x40C0A0,
        0x40C0A6,
        0x40C0AC,
        0x40C0AE,
    ...
    assert row176["semantic_targets"] == [
        {"ea": 0x40C0BA, "role": "conditional_taken"},
        {"ea": 0x40C5FB, "role": "conditional_fallthrough"},
    ]
    assert row176["imported_closure_block_anchor_eas"] == [
        0x40C0BA,
        0x40C0C8,
        0x40C0CE,
        0x40C0D2,
    ...
    assert row176["unavailable_closure_exit_eas"] == []
    assert row176["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0],
            "expected_generated_block_anchor_eas": [
                0x40C0BA,
            ...
            "owned_native_block_entry_eas": [0x40C0BA, 0x40C0C8, 0x40C0CE],
            "root_ea": 0x40C0BA,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40C64B],
            "expected_generated_block_anchor_eas": [
                0x40C5FB,
                0x40C609,
                0x40C60F,
            ...
            "owned_native_block_entry_eas": [0x40C5FB, 0x40C609, 0x40C60F],
            "root_ea": 0x40C5FB,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row177_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row177 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 177
    )
    ...
    assert row177["current_generated_proof"] == {
        "accepted_commits": [
            "e509ba90b",
            "dca98b2f4",
            "baa02b5bd",
    ...
    assert row177["source_native_ea"] == 0x40C0BA
    assert row177["source_block_anchor_ea"] == 0x40C0CE
    assert row177["transfer_native_ea"] == 0x40C0D2
    assert row177["owned_corridor_instruction_eas"] == [
        0x40C0BA,
        0x40C0C0,
        0x40C0C6,
        0x40C0C8,
    ...
    assert row177["semantic_targets"] == [
        {"ea": 0x40C0D4, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row177["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C0D4,
        0x40C0E7,
    ...
    assert row177["unavailable_closure_exit_eas"] == []
    assert row177["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40C0D4,
            ...
            "owned_native_block_entry_eas": [0x40C0D4, 0x40C0E7, 0x40C0EA],
            "root_ea": 0x40C0D4,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row178_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row178 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 178
    )
    ...
    assert row178["current_generated_proof"] == {
        "accepted_commits": ["5bf319d43", "717697b0a", "76c1e3be6"],
        "status": "accepted_generated_c6",
    }
    assert row178["flag_producer_native_ea"] == 0x40C0D9
    assert row178["predicate_native_ea"] == 0x40C0E7
    assert row178["source_native_ea"] == 0x40C0DF
    assert row178["source_block_anchor_ea"] == 0x40C0D4
    assert row178["transfer_native_ea"] == 0x40C0EE
    assert row178["owned_corridor_instruction_eas"] == [
        0x40C0D9,
        0x40C0DF,
        0x40C0E1,
        0x40C0E7,
    ...
    assert row178["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row178["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row178["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row178["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row178["target_rooted_closures"]
    )
...
def test_row179_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row179 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 179
    )

    assert len(inventory["operations"]) == 228
    assert row179["operation_id"] == "rhad:route@0x40C108"
    assert row179["operation_variant"] == "existing_conditional_plus_indirect"
    assert row179["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row179["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row179["current_generated_proof"] == {
        "accepted_commits": ["312d846aa", "cb2dabb89", "2c67c621b"],
        "status": "accepted_generated_c6",
    }
    assert row179["flag_producer_native_ea"] == 0x40C0F6
    assert row179["predicate_native_ea"] == 0x40C0FC
    assert row179["source_native_ea"] == 0x40C0F0
    assert row179["source_block_anchor_ea"] == 0x40C104
    assert row179["transfer_native_ea"] == 0x40C108
    assert row179["owned_corridor_instruction_eas"] == [
        0x40C0F0,
        0x40C0F6,
        0x40C0FC,
        0x40C0FE,
    ...
    assert row179["semantic_targets"] == [
        {"ea": 0x40C10A, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row179["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C10A,
        0x40C132,
    ...
    assert row179["unavailable_closure_exit_eas"] == []
    assert row179["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40C10A,
...
def test_row180_inventory_has_exact_direct_target_closure() -> None:
    ...
    row180 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 180
    )

    assert len(inventory["operations"]) == 228
    assert row180["operation_id"] == "rhad:route@0x40C14E"
    assert row180["operation_variant"] == "simple_indirect_jump"
    assert row180["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    ...
    assert row180["source_block_anchor_ea"] == 0x40C144
    assert row180["transfer_native_ea"] == 0x40C14E
    assert row180["owned_corridor_instruction_eas"] == [
        0x40C132,
        0x40C144,
        0x40C146,
        0x40C148,
    ...
    assert row180["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row180["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row180["unavailable_closure_exit_eas"] == []
    assert row180["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row181_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row181 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 181
    )

    assert len(inventory["operations"]) == 228
    assert row181["operation_id"] == "rhad:route@0x40C168"
    assert row181["operation_variant"] == "existing_conditional_plus_indirect"
    assert row181["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    ...
    assert row181["source_block_anchor_ea"] == 0x40C164
    assert row181["transfer_native_ea"] == 0x40C168
    assert row181["owned_corridor_instruction_eas"] == [
        0x40C150,
        0x40C156,
        0x40C15C,
        0x40C15E,
    ...
    assert row181["semantic_targets"] == [
        {"ea": 0x40C16A, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row181["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C16A,
        0x40C17D,
    ...
    assert row181["unavailable_closure_exit_eas"] == []
    assert row181["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A607, 0x40B6C0],
            "expected_generated_block_anchor_eas": [
                0x40C16A,
            ...
            "owned_native_block_entry_eas": [0x40C16A, 0x40C17D, 0x40C180],
            "root_ea": 0x40C16A,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row182_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row182 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 182
    )

    assert len(inventory["operations"]) == 228
    assert row182["operation_id"] == "rhad:route@0x40C184"
    assert row182["operation_variant"] == "cmov_selected_indirect"
    assert row182["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert row182["current_compiler_support"] == "typed_cmov_selected_indirect"
    assert row182["current_generated_proof"] == {
        "accepted_commits": ["6bfbd2fee", "7f2439b89", "5ac733c9c"],
        "status": "accepted_generated_c6",
    }
    assert row182["flag_producer_native_ea"] == 0x40C16F
    assert row182["predicate_native_ea"] == 0x40C17D
    assert row182["source_native_ea"] == 0x40C175
    assert row182["source_block_anchor_ea"] == 0x40C16A
    assert row182["transfer_native_ea"] == 0x40C184
    assert row182["owned_corridor_instruction_eas"] == [
        0x40C16F,
        0x40C175,
        0x40C177,
        0x40C17D,
    ...
    assert row182["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row182["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row182["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row182["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row182["target_rooted_closures"]
    )
...
def test_row183_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row183 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 183
    )

    assert len(inventory["operations"]) == 228
    assert row183["operation_id"] == "rhad:route@0x40C19E"
    assert row183["operation_variant"] == "existing_conditional_plus_indirect"
    assert row183["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row183["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row183["current_generated_proof"] == {
        "accepted_commits": ["12201f090", "8e246a135", "e73c91e2e"],
        "status": "accepted_generated_c6",
    }
    assert row183["flag_producer_native_ea"] == 0x40C18C
    assert row183["predicate_native_ea"] == 0x40C192
    assert row183["source_native_ea"] == 0x40C186
    assert row183["source_block_anchor_ea"] == 0x40C19A
    assert row183["transfer_native_ea"] == 0x40C19E
    assert row183["owned_corridor_instruction_eas"] == [
        0x40C186,
        0x40C18C,
        0x40C192,
        0x40C194,
    ...
    assert row183["semantic_targets"] == [
        {"ea": 0x40C1A0, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row183["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C1A0,
        0x40C1C0,
    ...
    assert row183["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row183["target_rooted_closures"]
    )
...
def test_row184_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row184 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 184
    )

    assert len(inventory["operations"]) == 228
    assert row184["operation_id"] == "rhad:route@0x40C1F0"
    ...
    assert row184["source_block_anchor_ea"] == 0x40C1C0
    assert row184["transfer_native_ea"] == 0x40C1F0
    assert row184["owned_corridor_instruction_eas"] == [
        0x40C1C6,
        0x40C1DB,
        0x40C1E1,
        0x40C1E3,
    ...
    assert row184["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row184["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row184["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row184["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row184["target_rooted_closures"]
    )
...
def test_row185_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row185 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 185
    )

    assert len(inventory["operations"]) == 228
    assert row185["operation_id"] == "rhad:route@0x40C20A"
    assert row185["operation_variant"] == "existing_conditional_plus_indirect"
    assert row185["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row185["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row185["current_generated_proof"] == {
        "accepted_commits": ["84953cf26", "7485239ed", "f0b3fc290"],
        "status": "accepted_generated_c6",
    }
    assert row185["flag_producer_native_ea"] == 0x40C1F8
    assert row185["predicate_native_ea"] == 0x40C1FE
    assert row185["source_native_ea"] == 0x40C1F2
    assert row185["source_block_anchor_ea"] == 0x40C206
    assert row185["transfer_native_ea"] == 0x40C20A
    assert row185["owned_corridor_instruction_eas"] == [
        0x40C1F2,
        0x40C1F8,
        0x40C1FE,
        0x40C200,
    ...
    assert row185["semantic_targets"] == [
        {"ea": 0x40C20C, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row185["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C20C,
        0x40C235,
    ...
    assert row185["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row185["target_rooted_closures"]
    )
...
def test_row186_inventory_has_exact_direct_target_closure() -> None:
    ...
    row186 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 186
    )

    assert len(inventory["operations"]) == 228
    assert row186["operation_id"] == "rhad:route@0x40C251"
    assert row186["operation_variant"] == "simple_indirect_jump"
    assert row186["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row186["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row186["current_generated_proof"] == {
        "accepted_commits": ["bdba21a50", "f0fc45443", "2ee0eb413"],
        "status": "accepted_generated_c6",
    }
    assert row186["flag_producer_native_ea"] is None
    assert row186["predicate_native_ea"] is None
    assert row186["source_native_ea"] == 0x40C235
    assert row186["source_block_anchor_ea"] == 0x40C247
    assert row186["transfer_native_ea"] == 0x40C251
    assert row186["owned_corridor_instruction_eas"] == [
        0x40C235,
        0x40C247,
        0x40C249,
        0x40C24B,
    ...
    assert row186["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row186["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row186["unavailable_closure_exit_eas"] == []
    assert row186["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row187_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row187 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 187
    )

    assert len(inventory["operations"]) == 228
    assert row187["operation_id"] == "rhad:route@0x40C26B"
    assert row187["operation_variant"] == "existing_conditional_plus_indirect"
    assert row187["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert row187["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    ...
    assert row187["predicate_native_ea"] == 0x40C25F
    assert row187["source_native_ea"] == 0x40C253
    assert row187["source_block_anchor_ea"] == 0x40C267
    assert row187["transfer_native_ea"] == 0x40C26B
    assert row187["owned_corridor_instruction_eas"] == [
        0x40C253,
        0x40C259,
        0x40C25F,
        0x40C261,
    ...
    assert row187["semantic_targets"] == [
        {"ea": 0x40C26D, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row187["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C26D,
        0x40C2AF,
    ...
    assert row187["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row187["target_rooted_closures"]
    )
...
def test_row188_inventory_has_exact_direct_target_closure() -> None:
    ...
    row188 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 188
    )

    assert len(inventory["operations"]) == 228
    assert row188["operation_id"] == "rhad:route@0x40C2F9"
    assert row188["operation_variant"] == "simple_indirect_jump"
    assert row188["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row188["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row188["current_generated_proof"] == {
        "accepted_commits": ["34e4a102b", "bd732ed20", "7839b9c1e"],
        "status": "accepted_generated_c6",
    }
    assert row188["flag_producer_native_ea"] is None
    assert row188["predicate_native_ea"] is None
    assert row188["source_native_ea"] == 0x40C2D7
    assert row188["source_block_anchor_ea"] == 0x40C2EF
    assert row188["transfer_native_ea"] == 0x40C2F9
    assert row188["owned_corridor_instruction_eas"] == [
        0x40C2D7,
        0x40C2EF,
        0x40C2F1,
        0x40C2F3,
    ...
    assert row188["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row188["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row188["unavailable_closure_exit_eas"] == []
    assert row188["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row189_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row189 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 189
    )

    assert len(inventory["operations"]) == 228
    assert row189["operation_id"] == "rhad:route@0x40C313"
    assert row189["operation_variant"] == "existing_conditional_plus_indirect"
    assert row189["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row189["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row189["current_generated_proof"] == {
        "accepted_commits": ["7eddc2730", "82b28a4ed", "dde35e92b"],
        "status": "accepted_generated_c6",
    }
    assert row189["flag_producer_native_ea"] == 0x40C301
    assert row189["predicate_native_ea"] == 0x40C307
    assert row189["source_native_ea"] == 0x40C2FB
    assert row189["source_block_anchor_ea"] == 0x40C30F
    assert row189["transfer_native_ea"] == 0x40C313
    assert row189["owned_corridor_instruction_eas"] == [
        0x40C2FB,
        0x40C301,
        0x40C307,
        0x40C309,
    ...
    assert row189["semantic_targets"] == [
        {"ea": 0x40C315, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row189["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C315,
        0x40C335,
    ...
    assert row189["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row189["target_rooted_closures"]
    )
...
def test_row190_inventory_has_exact_direct_target_closure() -> None:
    ...
    row190 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 190
    )

    assert len(inventory["operations"]) == 228
    assert row190["operation_id"] == "rhad:route@0x40C34B"
    assert row190["operation_variant"] == "simple_indirect_jump"
    assert row190["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row190["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row190["current_generated_proof"] == {
        "accepted_commits": ["f2dd63539", "b28b63dda", "41b2420e8"],
        "status": "accepted_generated_c6",
    }
    assert row190["flag_producer_native_ea"] is None
    assert row190["predicate_native_ea"] is None
    assert row190["source_native_ea"] == 0x40C335
    assert row190["source_block_anchor_ea"] == 0x40C347
    assert row190["transfer_native_ea"] == 0x40C34B
    assert row190["owned_corridor_instruction_eas"] == [
        0x40C335,
        0x40C347,
        0x40C349,
        0x40C34B,
    ]
    assert row190["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row190["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row190["unavailable_closure_exit_eas"] == []
    assert row190["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row191_inventory_has_producer_inclusive_exact_target_closures() -> None:
    ...
    row191 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 191
    )

    assert len(inventory["operations"]) == 228
    assert row191["operation_id"] == "rhad:route@0x40C365"
    assert row191["operation_variant"] == "existing_conditional_plus_indirect"
    assert row191["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row191["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row191["current_generated_proof"] == {
        "accepted_commits": ["ab234411f", "4be169937", "8d1cc35e6"],
        "status": "accepted_generated_c6",
    }
    assert row191["flag_producer_native_ea"] == 0x40C353
    assert row191["predicate_native_ea"] == 0x40C359
    assert row191["source_native_ea"] == 0x40C34D
    assert row191["source_block_anchor_ea"] == 0x40C361
    assert row191["transfer_native_ea"] == 0x40C365
    assert row191["owned_corridor_instruction_eas"] == [
        0x40C34D,
        0x40C353,
        0x40C359,
        0x40C35B,
    ...
    assert row191["semantic_targets"] == [
        {"ea": 0x40C367, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row191["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C367,
        0x40C37A,
    ...
    assert row191["unavailable_closure_exit_eas"] == []
    assert all(
        closure["status"] == "complete" and closure["unavailable_exit_eas"] == []
        for closure in row191["target_rooted_closures"]
    )
...
def test_row192_inventory_has_exact_direct_target_closure() -> None:
    ...
    row192 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 192
    )

    assert len(inventory["operations"]) == 228
    assert row192["operation_id"] == "rhad:route@0x40C390"
    assert row192["operation_variant"] == "simple_indirect_jump"
    assert row192["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row192["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row192["current_generated_proof"] == {
        "accepted_commits": ["8416256a6", "f0efa20d8", "1b47c460e"],
        "status": "accepted_generated_c6",
    }
    assert row192["flag_producer_native_ea"] is None
    assert row192["predicate_native_ea"] is None
    assert row192["source_native_ea"] == 0x40C37A
    assert row192["source_block_anchor_ea"] == 0x40C38C
    assert row192["transfer_native_ea"] == 0x40C390
    assert row192["owned_corridor_instruction_eas"] == [
        0x40C37A,
        0x40C38C,
        0x40C38E,
        0x40C390,
    ]
    assert row192["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row192["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row192["unavailable_closure_exit_eas"] == []
    assert row192["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row193_inventory_has_exact_producer_and_target_closure() -> None:
    ...
    row193 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 193
    )

    assert len(inventory["operations"]) == 228
    assert row193["operation_id"] == "rhad:route@0x40C3AA"
    assert row193["operation_variant"] == "existing_conditional_plus_indirect"
    assert row193["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row193["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row193["current_generated_proof"] == {
        "accepted_commits": ["244e1abfd", "1a0a9d28b", "0a2eb24a0"],
        "status": "accepted_generated_c6",
    }
    assert row193["source_native_ea"] == 0x40C392
    assert row193["source_block_anchor_ea"] == 0x40C3A6
    assert row193["flag_producer_native_ea"] == 0x40C398
    assert row193["predicate_native_ea"] == 0x40C39E
    assert row193["transfer_native_ea"] == 0x40C3AA
    assert row193["owned_corridor_instruction_eas"] == [
        0x40C392,
        0x40C398,
        0x40C39E,
        0x40C3A0,
    ...
    assert row193["semantic_targets"] == [
        {"ea": 0x40C3AC, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row193["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C3AC,
        0x40C3C1,
    ...
    assert row193["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row193["target_rooted_closures"]
    }
    assert closures[0x40C3AC] == {
        "boundary_exit_eas": [0x40A607, 0x40B6C0],
        "expected_generated_block_anchor_eas": [
            0x40C3AC,
            0x40C3C1,
...
def test_row194_inventory_has_exact_direct_target_closure() -> None:
    ...
    row194 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 194
    )

    assert len(inventory["operations"]) == 228
    assert row194["operation_id"] == "rhad:route@0x40C3D7"
    assert row194["operation_variant"] == "simple_indirect_jump"
    assert row194["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row194["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row194["current_generated_proof"] == {
        "accepted_commits": ["76d2ebabe", "77cfd883c", "b8806f0ba"],
        "status": "accepted_generated_c6",
    }
    assert row194["flag_producer_native_ea"] is None
    assert row194["predicate_native_ea"] is None
    assert row194["source_native_ea"] == 0x40C3C1
    assert row194["source_block_anchor_ea"] == 0x40C3D3
    assert row194["transfer_native_ea"] == 0x40C3D7
    assert row194["owned_corridor_instruction_eas"] == [
        0x40C3C1,
        0x40C3D3,
        0x40C3D5,
        0x40C3D7,
    ]
    assert row194["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row194["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row194["unavailable_closure_exit_eas"] == []
    assert row194["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row195_inventory_has_exact_producer_and_target_closure() -> None:
    ...
    row195 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 195
    )

    assert len(inventory["operations"]) == 228
    assert row195["operation_id"] == "rhad:route@0x40C3F1"
    assert row195["operation_variant"] == "existing_conditional_plus_indirect"
    assert row195["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    ...
    assert row195["predicate_native_ea"] == 0x40C3E5
    assert row195["transfer_native_ea"] == 0x40C3F1
    assert row195["owned_corridor_instruction_eas"] == [
        0x40C3D9,
        0x40C3DF,
        0x40C3E5,
        0x40C3E7,
    ...
    assert row195["semantic_targets"] == [
        {"ea": 0x40C3F3, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row195["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C3F3,
        0x40C3F9,
    ...
    assert row195["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row195["target_rooted_closures"]
    }
    assert closures[0x40C3F3] == {
        "boundary_exit_eas": [0x40A607, 0x40B6C0],
        "expected_generated_block_anchor_eas": [
            0x40C3F3,
            0x40C3F9,
...
def test_row196_inventory_has_exact_direct_target_closure() -> None:
    ...
    row196 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 196
    )

    assert len(inventory["operations"]) == 228
    assert row196["operation_id"] == "rhad:route@0x40C42C"
    assert row196["operation_variant"] == "simple_indirect_jump"
    assert row196["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row196["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row196["current_generated_proof"] == {
        "accepted_commits": ["9921de372", "347034e02", "e85b3861e"],
        "status": "accepted_generated_c6",
    }
    assert row196["flag_producer_native_ea"] is None
    assert row196["predicate_native_ea"] is None
    assert row196["source_native_ea"] == 0x40C40A
    assert row196["source_block_anchor_ea"] == 0x40C422
    assert row196["transfer_native_ea"] == 0x40C42C
    assert row196["owned_corridor_instruction_eas"] == [
        0x40C40A,
        0x40C422,
        0x40C424,
        0x40C426,
    ...
    assert row196["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row196["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row196["unavailable_closure_exit_eas"] == []
    assert row196["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row197_inventory_has_exact_producer_and_target_closure() -> None:
    ...
    row197 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 197
    )

    assert len(inventory["operations"]) == 228
    assert row197["operation_id"] == "rhad:route@0x40C446"
    assert row197["operation_variant"] == "existing_conditional_plus_indirect"
    assert row197["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row197["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row197["current_generated_proof"] == {
        "accepted_commits": ["488f1a642", "bbc73882a", "5733375a6"],
        "status": "accepted_generated_c6",
    }
    assert row197["source_native_ea"] == 0x40C42E
    assert row197["source_block_anchor_ea"] == 0x40C442
    assert row197["flag_producer_native_ea"] == 0x40C434
    assert row197["predicate_native_ea"] == 0x40C43A
    assert row197["transfer_native_ea"] == 0x40C446
    assert row197["owned_corridor_instruction_eas"] == [
        0x40C42E,
        0x40C434,
        0x40C43A,
        0x40C43C,
    ...
    assert row197["semantic_targets"] == [
        {"ea": 0x40C448, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row197["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C448,
        0x40C45E,
    ...
    assert row197["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row197["target_rooted_closures"]
    }
    assert closures[0x40C448] == {
        "boundary_exit_eas": [0x40A607, 0x40B6C0],
        "expected_generated_block_anchor_eas": [0x40C448, 0x40C45E, 0x40C462],
        "owned_native_block_entry_eas": [0x40C448, 0x40C45E],
        "root_ea": 0x40C448,
        "status": "complete",
        "unavailable_exit_eas": [],
    }
...
def test_row198_inventory_has_exact_cmov_producer_and_reused_closures() -> None:
    ...
    row198 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 198
    )

    assert len(inventory["operations"]) == 228
    assert row198["operation_id"] == "rhad:route@0x40C462"
    assert row198["operation_variant"] == "cmov_selected_indirect"
    assert row198["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert row198["current_compiler_support"] == "typed_cmov_selected_indirect"
    assert row198["current_generated_proof"] == {
        "accepted_commits": ["0b273a413", "d8a7e54c6", "9b84dc2fc"],
        "status": "accepted_generated_c6",
    }
    assert row198["source_native_ea"] == 0x40C453
    assert row198["source_block_anchor_ea"] == 0x40C448
    assert row198["flag_producer_native_ea"] == 0x40C44D
    assert row198["predicate_native_ea"] == 0x40C45B
    assert row198["transfer_native_ea"] == 0x40C462
    assert row198["owned_corridor_instruction_eas"] == [
        0x40C44D,
        0x40C453,
        0x40C455,
        0x40C45B,
    ...
    assert row198["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row198["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row198["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row198["target_rooted_closures"]
    }
...
def test_row199_inventory_has_exact_producer_and_partitioned_target_closure() -> None:
    ...
    row199 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 199
    )

    assert len(inventory["operations"]) == 228
    assert row199["operation_id"] == "rhad:route@0x40C47C"
    assert row199["operation_variant"] == "existing_conditional_plus_indirect"
    assert row199["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row199["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row199["current_generated_proof"] == {
        "accepted_commits": ["8ce35b1a9", "8fa2b6b25", "071a6dab4"],
        "status": "accepted_generated_c6",
    }
    assert row199["source_native_ea"] == 0x40C464
    assert row199["source_block_anchor_ea"] == 0x40C478
    assert row199["flag_producer_native_ea"] == 0x40C46A
    assert row199["predicate_native_ea"] == 0x40C470
    assert row199["transfer_native_ea"] == 0x40C47C
    assert row199["owned_corridor_instruction_eas"] == [
        0x40C464,
        0x40C46A,
        0x40C470,
        0x40C472,
    ...
    assert row199["semantic_targets"] == [
        {"ea": 0x40C47E, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row199["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C47E,
        0x40C494,
    ...
    assert row199["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row199["target_rooted_closures"]
    }
    assert closures[0x40C47E] == {
        "boundary_exit_eas": [0x40A607, 0x40B6C0],
        "expected_generated_block_anchor_eas": [0x40C47E, 0x40C494, 0x40C498],
        "owned_native_block_entry_eas": [0x40C47E, 0x40C494],
        "root_ea": 0x40C47E,
        "status": "complete",
        "unavailable_exit_eas": [],
    }
...
def test_row200_inventory_has_exact_cmov_producer_and_reused_closures() -> None:
    ...
    row200 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 200
    )

    assert len(inventory["operations"]) == 228
    assert row200["operation_id"] == "rhad:route@0x40C498"
    assert row200["operation_variant"] == "cmov_selected_indirect"
    assert row200["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert row200["current_compiler_support"] == "typed_cmov_selected_indirect"
    assert row200["current_generated_proof"] == {
        "accepted_commits": ["63003afd5", "638bee9dc", "e4cda5238"],
        "status": "accepted_generated_c6",
    }
    assert row200["source_native_ea"] == 0x40C489
    assert row200["source_block_anchor_ea"] == 0x40C47E
    assert row200["flag_producer_native_ea"] == 0x40C483
    assert row200["predicate_native_ea"] == 0x40C491
    assert row200["transfer_native_ea"] == 0x40C498
    assert row200["owned_corridor_instruction_eas"] == [
        0x40C483,
        0x40C489,
        0x40C48B,
        0x40C491,
    ...
    assert row200["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row200["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row200["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row200["target_rooted_closures"]
    }
    assert closures[0x40B6C0] == {
        "boundary_exit_eas": [0x40B790],
        "expected_generated_block_anchor_eas": [
...
def test_row201_inventory_has_exact_producer_and_complete_target_closure() -> None:
    ...
    row201 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 201
    )

    assert len(inventory["operations"]) == 228
    assert row201["operation_id"] == "rhad:route@0x40C4B2"
    assert row201["operation_variant"] == "existing_conditional_plus_indirect"
    assert row201["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row201["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row201["current_generated_proof"] == {
        "accepted_commits": [
            "f57ce61f3",
            "e81502f2e",
            "b43cc34e2",
    ...
    assert row201["source_native_ea"] == 0x40C49A
    assert row201["source_block_anchor_ea"] == 0x40C4AE
    assert row201["flag_producer_native_ea"] == 0x40C4A0
    assert row201["predicate_native_ea"] == 0x40C4A6
    assert row201["transfer_native_ea"] == 0x40C4B2
    assert row201["owned_corridor_instruction_eas"] == [
        0x40C49A,
        0x40C4A0,
        0x40C4A6,
        0x40C4A8,
    ...
    assert row201["semantic_targets"] == [
        {"ea": 0x40C4B4, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row201["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40ADA2,
        0x40ADBC,
    ...
    closures = {
        closure["root_ea"]: closure for closure in row201["target_rooted_closures"]
    }
    assert closures[0x40C4B4] == {
        "boundary_exit_eas": [0x40A607, 0x40B6C0],
        "expected_generated_block_anchor_eas": [
            0x40ADA2,
            0x40ADBC,
...
def test_row202_inventory_has_exact_producer_and_reused_target_closures() -> None:
    ...
    assert row202["current_generated_proof"] == {
        "accepted_commits": ["28b5b8bf4", "b3b478d7d", "1bafdf09b"],
        "status": "accepted_generated_c6",
    }
...
def test_row203_inventory_has_exact_producer_and_complete_target_closure() -> None:
    ...
    row203 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 203
    )

    assert len(inventory["operations"]) == 228
    assert row203["operation_id"] == "rhad:route@0x40C4F4"
    assert row203["operation_variant"] == "existing_conditional_plus_indirect"
    assert row203["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row203["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row203["current_generated_proof"] == {
        "accepted_commits": ["1374ff27a", "96e0f22de", "96d428234"],
        "status": "accepted_generated_c6",
    }
    assert row203["source_native_ea"] == 0x40C4DC
    assert row203["source_block_anchor_ea"] == 0x40C4F0
    assert row203["flag_producer_native_ea"] == 0x40C4E2
    assert row203["predicate_native_ea"] == 0x40C4E8
    assert row203["transfer_native_ea"] == 0x40C4F4
    assert row203["owned_corridor_instruction_eas"] == [
        0x40C4DC,
        0x40C4E2,
        0x40C4E8,
        0x40C4EA,
    ...
    assert row203["semantic_targets"] == [
        {"ea": 0x40C4F6, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row203["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C4F6,
        0x40C521,
    ...
    assert row203["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row203["target_rooted_closures"]
    }
    assert closures[0x40C4F6] == {
        "boundary_exit_eas": [0x40A607, 0x40B6C0],
        "expected_generated_block_anchor_eas": [0x40C4F6, 0x40C521, 0x40C525],
        "owned_native_block_entry_eas": [0x40C4F6, 0x40C521],
        "root_ea": 0x40C4F6,
        "status": "complete",
        "unavailable_exit_eas": [],
    }
...
def test_row204_inventory_has_exact_cmov_source_alias_and_reused_closures() -> None:
    ...
    row204 = next(
        operation
        for operation in inventory["operations"]
        if operation["reference_order"] == 204
    )

    assert len(inventory["operations"]) == 228
    assert row204["operation_id"] == "rhad:route@0x40C525"
    ...
    assert row204["predicate_native_ea"] == 0x40C51E
    assert row204["transfer_native_ea"] == 0x40C525
    assert row204["owned_corridor_instruction_eas"] == [
        0x40C510,
        0x40C516,
        0x40C518,
        0x40C51E,
    ...
    assert row204["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row204["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row204["unavailable_closure_exit_eas"] == []
    closures = {
        closure["root_ea"]: closure for closure in row204["target_rooted_closures"]
    }
...
def test_row205_inventory_has_exact_producer_and_complete_target_closure() -> None:
    ...
    assert row205["predicate_native_ea"] == 0x40C533
    assert row205["transfer_native_ea"] == 0x40C53F
    assert row205["owned_corridor_instruction_eas"] == [
        0x40C527, 0x40C52D, 0x40C533, 0x40C535, 0x40C53B, 0x40C53D, 0x40C53F,
    ]
    assert row205["semantic_targets"] == [
        {"ea": 0x40C541, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
...
def test_row207_inventory_owns_producer_and_complete_target_closures() -> None:
    ...
    assert row207["operation_variant"] == "existing_conditional_plus_indirect"
    assert row207["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert row207["current_compiler_support"] == "typed_existing_conditional_plus_indirect"
    assert row207["current_generated_proof"] == {
        "accepted_commits": ["6510c1b4b", "2f47719a4", "bc7a01964"],
        "status": "accepted_generated_c6",
    }
    assert row207["source_native_ea"] == 0x40C578
    assert row207["source_block_anchor_ea"] == 0x40C58C
    assert row207["flag_producer_native_ea"] == 0x40C57E
    assert row207["predicate_native_ea"] == 0x40C584
    assert row207["transfer_native_ea"] == 0x40C590
    assert row207["owned_corridor_instruction_eas"] == [
        0x40C578,
        0x40C57E,
        0x40C584,
        0x40C586,
    ...
    assert row207["semantic_targets"] == [
        {"ea": 0x40C592, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row207["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C592,
        0x40C5BD,
    ...
    assert row207["unavailable_closure_exit_eas"] == []
    closures = {closure["root_ea"]: closure for closure in row207["target_rooted_closures"]}
    assert closures[0x40C592] == {
        "boundary_exit_eas": [0x40A607, 0x40B6C0],
        "expected_generated_block_anchor_eas": [
            0x40C592,
            0x40C5BD,
...
def test_row208_inventory_reuses_exact_direct_source_and_target_closure() -> None:
    ...
    assert row208["predicate_native_ea"] is None
    assert row208["transfer_native_ea"] == 0x40C5F9
    assert row208["owned_corridor_instruction_eas"] == [
        0x40C5D7,
        0x40C5EF,
        0x40C5F1,
        0x40C5F3,
    ...
    assert row208["semantic_targets"] == [{"ea": 0x40B6C0, "role": "direct"}]
    assert row208["imported_closure_block_anchor_eas"] == [
        0x40B6C0,
        0x40B6CA,
        0x40B6D0,
        0x40B6D4,
    ...
    assert row208["unavailable_closure_exit_eas"] == []
    assert row208["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row209_inventory_owns_producer_and_both_target_corridors() -> None:
    ...
    assert row209["predicate_native_ea"] == 0x40C607
    assert row209["transfer_native_ea"] == 0x40C613
    assert row209["owned_corridor_instruction_eas"] == [
        0x40C5FB,
        0x40C601,
        0x40C607,
        0x40C609,
    ...
    assert row209["semantic_targets"] == [
        {"ea": 0x40C64B, "role": "conditional_taken"},
        {"ea": 0x40C615, "role": "conditional_fallthrough"},
    ]
    assert row209["imported_closure_block_anchor_eas"] == [
        0x40C615,
        0x40C623,
        0x40C629,
        0x40C62D,
    ...
    assert row209["boundary_exit_eas"] == [0x40A5F0, 0x40C62F, 0x40C665]
    assert row209["unavailable_closure_exit_eas"] == []
    assert row209["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40C62F],
            "expected_generated_block_anchor_eas": [
                0x40C615,
                0x40C623,
                0x40C629,
            ...
            "owned_native_block_entry_eas": [0x40C615, 0x40C623, 0x40C629],
            "root_ea": 0x40C615,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            ...
            "owned_native_block_entry_eas": [0x40C64B, 0x40C659, 0x40C65F],
            "root_ea": 0x40C64B,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
...
def test_row210_inventory_owns_producer_join_and_c62f_target_corridor() -> None:
    ...
    assert row210["predicate_native_ea"] == 0x40C621
    assert row210["transfer_native_ea"] == 0x40C62D
    assert row210["owned_corridor_instruction_eas"] == [
        0x40C615,
        0x40C61B,
        0x40C621,
        0x40C623,
    ...
    assert row210["semantic_targets"] == [
        {"ea": 0x40C62F, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row210["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C62F,
        0x40C642,
    ...
    assert row210["unavailable_closure_exit_eas"] == []
...
def test_row212_inventory_owns_c651_producer_and_c665_target_corridor() -> None:
    ...
    assert row212["operation_variant"] == "existing_conditional_plus_indirect"
    assert row212["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    ...
    assert row212["predicate_native_ea"] == 0x40C657
    assert row212["transfer_native_ea"] == 0x40C663
    assert row212["owned_corridor_instruction_eas"] == [
        0x40C64B,
        0x40C651,
        0x40C657,
        0x40C659,
    ...
    assert row212["semantic_targets"] == [
        {"ea": 0x40C665, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row212["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40C665,
        0x40C68D,
    ...
    assert row212["unavailable_closure_exit_eas"] == []
...
def test_row213_inventory_owns_c67f_producer_and_reuses_row212_topology() -> None:
    ...
    assert row213["predicate_native_ea"] == 0x40C68D
    assert row213["transfer_native_ea"] == 0x40C694
    assert row213["owned_corridor_instruction_eas"] == [
        0x40C67F,
        0x40C685,
        0x40C687,
        0x40C68D,
    ...
    assert row213["semantic_targets"] == [
        {"ea": 0x40B6C0, "role": "conditional_taken"},
        {"ea": 0x40A607, "role": "conditional_fallthrough"},
    ]
    assert row213["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row213["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert row213["unavailable_closure_exit_eas"] == []
    assert row213["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40B790],
            "expected_generated_block_anchor_eas": [
                0x40B6C0,
...
def test_row214_inventory_reuses_row121_source_and_a607_closure() -> None:
    ...
    assert row214["operation_variant"] == "simple_indirect_jump"
    assert row214["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row214["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row214["current_generated_proof"] == {
        "accepted_commits": ["03552713e", "8b8e2a680", "a03295222"],
        "status": "accepted_generated_c6",
    }
    assert row214["source_native_ea"] == 0x40B765
    assert row214["source_block_anchor_ea"] == 0x40C6AD
    assert row214["flag_producer_native_ea"] is None
    assert row214["predicate_native_ea"] is None
    assert row214["transfer_native_ea"] == 0x40C6B3
    assert row214["owned_corridor_instruction_eas"] == [
        0x40B765,
        0x40B777,
        0x40C6AD,
        0x40C6AF,
    ...
    assert row214["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row214["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row214["unavailable_closure_exit_eas"] == []
    assert row214["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A61B, 0x40A68C],
            "expected_generated_block_anchor_eas": [
                0x40A607,
...
def test_row215_inventory_reuses_row132_source_and_a607_closure() -> None:
    ...
    assert row215["operation_variant"] == "simple_indirect_jump"
    assert row215["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row215["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row215["current_generated_proof"] == {
        "accepted_commits": ["67a79d707", "8cd268929", "8d92316de"],
        "status": "accepted_generated_c6",
    }
    assert row215["source_native_ea"] == 0x40B90F
    assert row215["source_block_anchor_ea"] == 0x40C6CC
    assert row215["flag_producer_native_ea"] is None
    assert row215["predicate_native_ea"] is None
    assert row215["transfer_native_ea"] == 0x40C6D8
    assert row215["owned_corridor_instruction_eas"] == [
        0x40B90F,
        0x40B921,
        0x40C6CC,
        0x40C6CE,
    ...
    assert row215["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row215["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row215["unavailable_closure_exit_eas"] == []
...
def test_row216_inventory_reuses_row137_persistent_source_and_a607_closure() -> None:
    ...
    assert row216["operation_variant"] == "simple_indirect_jump"
    assert row216["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row216["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row216["current_generated_proof"] == {
        "accepted_commits": ["fa757218e", "cb3332bec", "af52f5b87"],
        "status": "accepted_generated_c6",
    }
    assert row216["source_native_ea"] == 0x40BB4B
    assert row216["source_block_anchor_ea"] == 0x40C6F7
    assert row216["flag_producer_native_ea"] is None
    assert row216["predicate_native_ea"] is None
    assert row216["transfer_native_ea"] == 0x40C703
    assert row216["owned_corridor_instruction_eas"] == [
        0x40BB4B,
        0x40BB5D,
        0x40BB63,
        0x40C6EB,
    ...
    assert row216["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row216["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row216["unavailable_closure_exit_eas"] == []
    assert row216["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A61B, 0x40A68C],
            "expected_generated_block_anchor_eas": [
                0x40A607,
...
def test_row217_inventory_reuses_row165_source_and_a607_closure() -> None:
    ...
    assert row217["owned_corridor_instruction_eas"] == [
        0x40BF62, 0x40BF74, 0x40BF7A, 0x40C716, 0x40C722,
        0x40C724, 0x40C726, 0x40C728, 0x40C72E,
    ]
    assert row217["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row217["imported_closure_block_anchor_eas"] == [
        0x40A607, 0x40A615, 0x40A619, 0x40A680, 0x40A68A,
    ]
    assert row217["boundary_exit_eas"] == [0x40A61B, 0x40A68C]
    assert row217["unavailable_closure_exit_eas"] == []
...
def test_row218_inventory_reuses_row171_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row218["operation_id"] == "rhad:route@0x40C74F"
    assert row218["operation_variant"] == "simple_indirect_jump"
    assert row218["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row218["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row218["current_generated_proof"] == {
        "accepted_commits": ["65a9b5df1", "14641d2db", "1f1b3c15c"],
        "status": "accepted_generated_c6",
    }
    assert row218["source_native_ea"] == 0x40C00E
    assert row218["source_block_anchor_ea"] == 0x40C749
    assert row218["flag_producer_native_ea"] is None
    assert row218["predicate_native_ea"] is None
    assert row218["transfer_native_ea"] == 0x40C74F
    assert row218["owned_corridor_instruction_eas"] == [
        0x40C00E,
        0x40C021,
        0x40C033,
        0x40C035,
    ...
    assert row218["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row218["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row218["unavailable_closure_exit_eas"] == []
    assert row218["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A61B, 0x40A68C],
            "expected_generated_block_anchor_eas": [
                0x40A607,
...
def test_row219_inventory_reuses_row174_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row219["operation_id"] == "rhad:route@0x40C76E"
    assert row219["operation_variant"] == "simple_indirect_jump"
    assert row219["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row219["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row219["current_generated_proof"] == {
        "accepted_commits": ["7a7d5a659", "f0050531a", "75d63ec0c"],
        "status": "accepted_generated_c6",
    }
    assert row219["source_native_ea"] == 0x40C082
    assert row219["source_block_anchor_ea"] == 0x40C768
    assert row219["flag_producer_native_ea"] is None
    assert row219["predicate_native_ea"] is None
    assert row219["transfer_native_ea"] == 0x40C76E
    assert row219["owned_corridor_instruction_eas"] == [
        0x40C082,
        0x40C094,
        0x40C768,
        0x40C76A,
    ...
    assert row219["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row219["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row219["unavailable_closure_exit_eas"] == []
    assert row219["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A61B, 0x40A68C],
            "expected_generated_block_anchor_eas": [
                0x40A607,
...
def test_row220_inventory_reuses_row179_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row220["operation_id"] == "rhad:route@0x40C793"
    assert row220["operation_variant"] == "simple_indirect_jump"
    assert row220["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row220["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row220["current_generated_proof"] == {
        "accepted_commits": ["0e0a88d1a", "b512d0161", "c8873e361"],
        "status": "accepted_generated_c6",
    }
    assert row220["source_native_ea"] == 0x40C12C
    assert row220["source_block_anchor_ea"] == 0x40C787
    assert row220["flag_producer_native_ea"] is None
    assert row220["predicate_native_ea"] is None
    assert row220["transfer_native_ea"] == 0x40C793
    assert row220["owned_corridor_instruction_eas"] == [
        0x40C12C,
        0x40C13E,
        0x40C787,
        0x40C789,
    ...
    assert row220["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row220["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row220["unavailable_closure_exit_eas"] == []
    assert row220["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A61B, 0x40A68C],
            "expected_generated_block_anchor_eas": [
                0x40A607,
...
def test_row221_inventory_reuses_row185_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row221["operation_id"] == "rhad:route@0x40C7B8"
    assert row221["operation_variant"] == "simple_indirect_jump"
    assert row221["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row221["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row221["current_generated_proof"] == {
        "accepted_commits": ["6d3749c41", "924b0ce32", "158d06fdb"],
        "status": "accepted_generated_c6",
    }
    assert row221["source_native_ea"] == 0x40C22F
    assert row221["source_block_anchor_ea"] == 0x40C7AC
    assert row221["flag_producer_native_ea"] is None
    assert row221["predicate_native_ea"] is None
    assert row221["transfer_native_ea"] == 0x40C7B8
    assert row221["owned_corridor_instruction_eas"] == [
        0x40C22F,
        0x40C241,
        0x40C7AC,
        0x40C7AE,
    ...
    assert row221["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row221["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row221["unavailable_closure_exit_eas"] == []
    assert row221["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A61B, 0x40A68C],
            "expected_generated_block_anchor_eas": [
                0x40A607,
...
def test_row222_inventory_reuses_row187_source_and_a607_closure() -> None:
    ...
    assert row222["current_generated_proof"] == {
        "accepted_commits": ["3b46b764c", "a3a8cf2ec", "cd4df56cf"],
        "status": "accepted_generated_c6",
    }
...
def test_row223_inventory_reuses_row189_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row223["operation_id"] == "rhad:route@0x40C802"
    assert row223["operation_variant"] == "simple_indirect_jump"
    assert row223["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    ...
    assert row223["predicate_native_ea"] is None
    assert row223["transfer_native_ea"] == 0x40C802
    assert row223["owned_corridor_instruction_eas"] == [
        0x40C32F,
        0x40C341,
        0x40C7FC,
        0x40C7FE,
    ...
    assert row223["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row223["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row223["unavailable_closure_exit_eas"] == []
...
def test_row224_inventory_reuses_row191_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row224["operation_id"] == "rhad:route@0x40C821"
    assert row224["operation_variant"] == "simple_indirect_jump"
    assert row224["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row224["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row224["current_generated_proof"] == {
        "accepted_commits": ["13fe648ff", "6883fad93", "5514f5fa0"],
        "status": "accepted_generated_c6",
    }
    assert row224["source_native_ea"] == 0x40C374
    assert row224["source_block_anchor_ea"] == 0x40C81B
    assert row224["flag_producer_native_ea"] is None
    assert row224["predicate_native_ea"] is None
    assert row224["transfer_native_ea"] == 0x40C821
    assert row224["owned_corridor_instruction_eas"] == [
        0x40C374,
        0x40C386,
        0x40C81B,
        0x40C81D,
    ...
    assert row224["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row224["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row224["unavailable_closure_exit_eas"] == []
...
def test_row225_inventory_reuses_row193_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row225["operation_id"] == "rhad:route@0x40C840"
    assert row225["operation_variant"] == "simple_indirect_jump"
    assert row225["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row225["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row225["current_generated_proof"] == {
        "accepted_commits": ["8a2d8cb56", "a56768630", "784b22a13"],
        "status": "accepted_generated_c6",
    }
    assert row225["source_native_ea"] == 0x40C3BB
    assert row225["source_block_anchor_ea"] == 0x40C83A
    assert row225["flag_producer_native_ea"] is None
    assert row225["predicate_native_ea"] is None
    assert row225["transfer_native_ea"] == 0x40C840
    assert row225["owned_corridor_instruction_eas"] == [
        0x40C3BB,
        0x40C3CD,
        0x40C83A,
        0x40C83C,
    ...
    assert row225["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row225["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row225["unavailable_closure_exit_eas"] == []
...
def test_row226_inventory_reuses_row195_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row226["operation_id"] == "rhad:route@0x40C86B"
    assert row226["operation_variant"] == "simple_indirect_jump"
    assert row226["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row226["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row226["current_generated_proof"] == {
        "accepted_commits": ["1f762b2c9", "162281020", "2af563243"],
        "status": "accepted_generated_c6",
    }
    assert row226["source_native_ea"] == 0x40C404
    assert row226["source_block_anchor_ea"] == 0x40C85F
    assert row226["flag_producer_native_ea"] is None
    assert row226["predicate_native_ea"] is None
    assert row226["transfer_native_ea"] == 0x40C86B
    assert row226["owned_corridor_instruction_eas"] == [
        0x40C404,
        0x40C416,
        0x40C41C,
        0x40C853,
    ...
    assert row226["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row226["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
    ...
    assert row226["unavailable_closure_exit_eas"] == []
...
def test_row227_inventory_reuses_row207_source_and_a607_closure() -> None:
    ...
    assert len(inventory["operations"]) == 228
    assert row227["operation_id"] == "rhad:route@0x40C896"
    assert row227["operation_variant"] == "simple_indirect_jump"
    assert row227["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert row227["current_compiler_support"] == "typed_simple_indirect_jump"
    assert row227["current_generated_proof"] == {
        "accepted_commits": ["d3ad3dec6", "bcd544707", "3094e5dbc"],
        "status": "accepted_generated_c6",
    }
    assert row227["source_native_ea"] == 0x40C5D1
    assert row227["source_block_anchor_ea"] == 0x40C88A
    assert row227["flag_producer_native_ea"] is None
    assert row227["predicate_native_ea"] is None
    assert row227["transfer_native_ea"] == 0x40C896
    assert row227["owned_corridor_instruction_eas"] == [
        0x40C5D1,
        0x40C5E3,
        0x40C5E9,
        0x40C87E,
    ...
    assert row227["semantic_targets"] == [{"ea": 0x40A607, "role": "direct"}]
    assert row227["imported_closure_block_anchor_eas"] == [
        0x40A607,
        0x40A615,
        0x40A619,
        0x40A680,
...
def test_constant_inventory_is_exact_reference_ordered_and_identity_bound() -> None:
    ...
    assert second == {
        ...
        "current_generated_proof": {
            ...
            "diagnostic_db": (
                ".tmp/logs/"
                "000000000040a560_accepted_398_constant_row1.diag.sqlite3"
            ),
            "diagnostic_db_sha256": (
                "86aab08f5805e704403a1cc73631ad7c01e7c7f33618a621318ab969b5f8efb0"
            ),
            "status": "accepted_generated_c6",
        },
        "data_native_ea": 0x48AE10,
        "destination_register": "edx",
        "destination_width_bits": 32,
        "encoding_variant": "mov_r32_absolute",
        "materialized_value": 0x2F192B3A,
        "operation_id": "rhad:constant@0x40A710",
    ...
    assert third == {
        ...
        "current_generated_proof": {
            ...
            "diagnostic_db": (
                ".tmp/logs/"
                "000000000040a560_accepted_399_constant_row2.diag.sqlite3"
            ),
            "diagnostic_db_sha256": (
                "530f56777fe8da434c8651b8f32126739f4d8b96676baa39858587920d420add"
            ),
            "status": "accepted_generated_c6",
        },
        ...
        "operation_id": "rhad:constant@0x40A868",
        "operation_variant": "mov_absolute",
    ...
    assert fourth == {
        ...
        "current_generated_proof": {
            "accepted_commits": ["a28bf860d", "72d1a180d"],
            "aggregate_program_identity": (
                "sha256:27cf1a0cf423fdcdaedf3f375360399b5452d4cfe8d37d3052b1fc6d99d1cd5f"
            ),
            "diagnostic_db": (
                ".tmp/logs/"
                "000000000040a560_accepted_400_constant_row3.diag.sqlite3"
            ),
            "diagnostic_db_sha256": (
                "5b3fbfe034bf121d8e4ddcdb3f3a20aad43eb7a2a88459051047926408837210"
            ),
            "status": "accepted_generated_c6",
        },
        ...
        "operation_id": "rhad:constant@0x40A903",
        "operation_variant": "mov_absolute",
    ...
    assert fifth == {
        ...
        "current_generated_proof": {
            "accepted_commits": ["62c19e6c3", "b9f59524b"],
            "aggregate_program_identity": (
                "sha256:79f919aae8c31db8ba96f348c886b93d566b7ca3f38e613adb7aa8bc3a881cab"
            ),
            "diagnostic_db": (
                ".tmp/logs/"
                "000000000040a560_accepted_401_constant_row4.diag.sqlite3"
            ),
            "diagnostic_db_sha256": (
                "8120f43001e94757bc225d962a8723f1bcf61aeb8309aae175a6116c5bfe273a"
            ),
            "status": "accepted_generated_c6",
        },
        ...
        "operation_id": "rhad:constant@0x40A922",
        "operation_variant": "mov_absolute",
    ...
    assert sixth == {
        ...
        "current_generated_proof": {
            "accepted_commits": ["bc4762a46", "d7e8ae213"],
            "aggregate_program_identity": (
                "sha256:89ef0237cc6483b5fedc5520d40df47dd465c79abbd4bb5c3b4dee0d494b3983"
            ),
            "diagnostic_db": (
                ".tmp/logs/"
                "000000000040a560_accepted_402_constant_row5.diag.sqlite3"
            ),
            "diagnostic_db_sha256": (
                "19acd861a775d2054c8ca206e2a9ab120c80e6a7c40b91a6ae9a909f751287aa"
            ),
            "status": "accepted_generated_c6",
        },
        ...
        "operation_id": "rhad:constant@0x40A9AE",
        "operation_variant": "mov_absolute",
...
def test_constant_row0_compiles_typed_materialization_and_binds_identity() -> None:
    ...
    assert operation.encoding_variant.value == "add_r32_absolute"
    ...
    assert operation.reference_raw_value == 0x3776723F
    assert operation.materialized_value == 0x3776723F
    assert operation.source_instruction_bytes == "0305ccad4800"
    assert operation.replacement_instruction_bytes == "81c03f727637"
    assert operation.depends_on == ("route:rhad-direct@0x40C896",)

    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(),
        evidence_generation=7,
    )
    assert len(plan.constant_materializations) == 7
    ...
    assert plan.block("native@0x40A560").stable_identity.native_ranges.contains(
        0x40A574
    )
    assert plan.plan_id.endswith(batch.aggregate_program_identity)
...
def test_constant_row1_compiles_typed_mov_from_imported_source() -> None:
    ...
    assert operation.encoding_variant.value == "mov_r32_absolute"
    ...
    assert operation.reference_data_bytes_le == "3a2b192f"
    assert operation.materialized_value == 0x2F192B3A
    assert operation.source_instruction_bytes == "8b1510ae4800"
    assert operation.replacement_instruction_bytes == "90ba3a2b192f"
    assert operation.depends_on == ("constant:rhad-add-absolute@0x40A574",)
    ...
    assert source.role.value == "imported"
...
def test_constant_row2_reuses_imported_global_move_contract() -> None:
    ...
    assert operation.reference_order == 2
    assert operation.operation_variant.value == "mov_absolute"
    assert operation.encoding_variant.value == "mov_eax_absolute"
    assert operation.publication_envelope.value == "imported_global_move"
    assert operation.source_block_id == "native@0x40A868"
    assert operation.source_native_ea == 0x40A868
    assert operation.data_native_ea == 0x48AE28
    assert operation.destination_storage == StorageIdentity(
        kind=StorageIdentityKind.REGISTER,
        offset=8,
    )
    assert operation.reference_data_bytes_le == "2cac5d0c"
    assert operation.materialized_value == 0x0C5DAC2C
    assert operation.source_instruction_bytes == "a128ae4800"
    assert operation.replacement_instruction_bytes == "b82cac5d0c"
    assert operation.depends_on == ("constant:rhad-mov-absolute@0x40A710",)
...
def test_constant_row3_reuses_mov_eax_absolute_contract() -> None:
    ...
    assert operation.reference_order == 3
    assert operation.operation_variant.value == "mov_absolute"
    assert operation.encoding_variant.value == "mov_eax_absolute"
    assert operation.publication_envelope.value == "imported_global_move"
    assert operation.source_block_id == "native@0x40A903"
    assert operation.source_native_ea == 0x40A903
    assert operation.data_native_ea == 0x48AE80
    assert operation.destination_storage == StorageIdentity(
        kind=StorageIdentityKind.REGISTER,
        offset=8,
    )
    assert operation.reference_data_bytes_le == "9578d1df"
    assert operation.materialized_value == 0xDFD17895
    assert operation.source_instruction_bytes == "a180ae4800"
    assert operation.replacement_instruction_bytes == "b89578d1df"
    assert operation.depends_on == ("constant:rhad-mov-absolute@0x40A868",)
...
def test_constant_row4_reuses_mov_r32_absolute_contract_for_ecx() -> None:
    ...
    assert operation.reference_order == 4
    assert operation.operation_variant.value == "mov_absolute"
    assert operation.encoding_variant.value == "mov_r32_absolute"
    assert operation.publication_envelope.value == "imported_global_move"
    assert operation.source_block_id == "native@0x40A922"
    assert operation.source_native_ea == 0x40A922
    assert operation.data_native_ea == 0x48AE84
    assert operation.destination_storage == StorageIdentity(
        kind=StorageIdentityKind.REGISTER,
        offset=16,
    )
    assert operation.reference_data_bytes_le == "46d862eb"
    assert operation.materialized_value == 0xEB62D846
    assert operation.source_instruction_bytes == "8b0d84ae4800"
    assert operation.replacement_instruction_bytes == "90b946d862eb"
    assert operation.depends_on == ("constant:rhad-mov-absolute@0x40A903",)
...
def test_constant_row5_reuses_mov_eax_absolute_contract_at_template_root() -> None:
    ...
    assert operation.reference_order == 5
    assert operation.operation_variant.value == "mov_absolute"
    assert operation.encoding_variant.value == "mov_eax_absolute"
    assert operation.publication_envelope.value == "imported_global_move"
    assert operation.source_block_id == "native@0x40A9AE"
    assert operation.source_native_ea == 0x40A9AE
    assert operation.data_native_ea == 0x48AE2C
    assert operation.destination_storage == StorageIdentity(
        kind=StorageIdentityKind.REGISTER,
        offset=8,
    )
    assert operation.reference_data_bytes_le == "63ff6f58"
    assert operation.materialized_value == 0x586FFF63
    assert operation.source_instruction_bytes == "a12cae4800"
    assert operation.replacement_instruction_bytes == "b863ff6f58"
    assert operation.depends_on == ("constant:rhad-mov-absolute@0x40A922",)
    ...
    assert "native@0x40A9DC" in native_body.preserved_native_transfer_block_ids
...
def test_constant_row6_reuses_mov_r32_absolute_contract_inside_template() -> None:
    ...
    assert operation.reference_order == 6
    assert operation.operation_variant.value == "mov_absolute"
    assert operation.encoding_variant.value == "mov_r32_absolute"
    assert operation.publication_envelope.value == "imported_global_move"
    assert operation.source_block_id == "native@0x40AAAE"
    assert operation.source_native_ea == 0x40AAC2
    assert operation.data_native_ea == 0x48ADFC
    assert operation.destination_storage == StorageIdentity(
        kind=StorageIdentityKind.REGISTER,
        offset=12,
    )
    assert operation.reference_data_bytes_le == "64f625b7"
    assert operation.materialized_value == 0xB725F664
    assert operation.source_instruction_bytes == "8b15fcad4800"
    assert operation.replacement_instruction_bytes == "90ba64f625b7"
    assert operation.depends_on == ("constant:rhad-mov-absolute@0x40A9AE",)
    ...
    assert "native@0x40AAEF" in native_body.preserved_native_transfer_block_ids
...
def test_constant_row0_value_changes_aggregate_program_identity() -> None:
    ...
    changed_batch = replace(
        batch,
        operations=(*batch.operations[:-7], changed, *batch.operations[-6:]),
    )
...
def test_checksum_producer_compiles_row176_existing_dependency() -> None:
    ...
    operation = plan.operation("rhad:route@0x40C0B8")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C0A6
    assert normalization.unresolved_transfer_ea == 0x40C0B8
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C0AE"
    assert envelope.join_block_id == "native@0x40C0B4"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C0BA",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C5FB",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 176
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C0A0
    assert payload["source_block_anchor_ea"] == 0x40C0B4
    assert payload["condition_producer_ea"] == 0x40C0A6
    assert payload["predicate_anchor_ea"] == 0x40C0AC
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0872BFF1
    assert payload["transfer_ea"] == 0x40C0B8
    assert payload["true_target_ea"] == 0x40C0BA
    assert payload["false_target_ea"] == 0x40C5FB
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C0A0,
        0x40C0A6,
        0x40C0AC,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW176_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW176_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C0BA",
        "native@0x40C0C8",
        "native@0x40C0CE",
        "native@0x40C0D2",
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40C64B]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C0B8"
    ).depends_on == ("route:rhad-direct@0x40C09E",)
    assert {"native@0x40C0BA", "native@0x40C5FB"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert plan.block(
        "native@0x40C0BA"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C0BA, 0x40C0C0, 0x40C0C6})
    assert plan.block(
        "native@0x40C0D2"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C0D2})
    assert plan.block(
        "native@0x40C5FB"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C5FB, 0x40C601, 0x40C607})
    assert plan.block(
        "native@0x40C613"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C613})
    assert "rhad:route@0x40C0B8" in batch.native_body_proof_ids
    ...
    assert templates[0x40C0BA].owned_ranges == (
        (0x40C0BA, 0x40C0C8),
        (0x40C0C8, 0x40C0CE),
        (0x40C0CE, 0x40C0D4),
    )
    assert templates[0x40C0BA].owned_block_entry_eas == (
        0x40C0BA,
        0x40C0C8,
        0x40C0CE,
    )
    assert templates[0x40C0BA].boundary_exit_eas == (0x40A5F0, 0x40C0D4)
    assert templates[0x40C0BA].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C0D2,
            boundary_exit_eas=(0x40A5F0, 0x40C0D4),
        ),
    )
    assert templates[0x40C5FB].owned_ranges == (
        (0x40C5FB, 0x40C609),
        (0x40C609, 0x40C60F),
        (0x40C60F, 0x40C615),
    )
    assert templates[0x40C5FB].owned_block_entry_eas == (
        0x40C5FB,
        0x40C609,
        0x40C60F,
    )
    assert templates[0x40C5FB].boundary_exit_eas == (0x40C615, 0x40C64B)
    assert templates[0x40C5FB].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C613,
            boundary_exit_eas=(0x40C615, 0x40C64B),
        ),
    )


def test_checksum_producer_compiles_row177_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C0D2")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C0C0
    assert normalization.unresolved_transfer_ea == 0x40C0D2
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C0C8"
    assert envelope.join_block_id == "native@0x40C0CE"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C0D4",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 177
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C0BA
    assert payload["source_block_anchor_ea"] == 0x40C0CE
    assert payload["condition_producer_ea"] == 0x40C0C0
    assert payload["predicate_anchor_ea"] == 0x40C0C6
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xFED7FAC0
    assert payload["transfer_ea"] == 0x40C0D2
    assert payload["true_target_ea"] == 0x40C0D4
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C0BA,
        0x40C0C0,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW177_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW177_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C0D4",
        "native@0x40C0E7",
        "native@0x40C0EA",
        "native@0x40C0EE",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C0D2"
    ).depends_on == ("rhad:route@0x40C0B8",)
    assert "native@0x40C0D4" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40C0D4"
    ).stable_identity.exact_instruction_eas == frozenset(
        {
    ...
    assert plan.block(
        "native@0x40C0E7"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C0E7})
    assert plan.block(
        "native@0x40C0EA"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C0EA, 0x40C0EC, 0x40C0EE})
    assert plan.block(
        "native@0x40C0EE"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C0EE})
    assert "rhad:route@0x40C0D2" in batch.native_body_proof_ids
    ...
    assert templates[0x40C0D4].owned_ranges == ((0x40C0D4, 0x40C0F0),)
    assert templates[0x40C0D4].owned_block_entry_eas == (
        0x40C0D4,
        0x40C0E7,
        0x40C0EA,
    )
    assert templates[0x40C0D4].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C0D4].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C0EE,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row178_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C0EE")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C0D9
    assert normalization.unresolved_transfer_ea == 0x40C0EE
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C0E7"
    assert envelope.join_block_id == "native@0x40C0EA"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 178
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C0DF
    assert payload["source_block_anchor_ea"] == 0x40C0D4
    assert payload["source_value_block_id"] == "native@0x40C0D4"
    assert payload["condition_producer_ea"] == 0x40C0D9
    assert payload["predicate_anchor_ea"] == 0x40C0E7
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C0EE
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C0D9,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C0EE"
    ).depends_on == ("rhad:route@0x40C0D2",)
    assert "rhad:route@0x40C0EE" in batch.native_body_proof_ids
...
def test_checksum_producer_compiles_row179_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C108")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C0F6
    assert normalization.unresolved_transfer_ea == 0x40C108
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C0FE"
    assert envelope.join_block_id == "native@0x40C104"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C10A",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 179
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C0F0
    assert payload["source_block_anchor_ea"] == 0x40C104
    assert payload["condition_producer_ea"] == 0x40C0F6
    assert payload["predicate_anchor_ea"] == 0x40C0FC
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0x886CCA9F
    assert payload["transfer_ea"] == 0x40C108
    assert payload["true_target_ea"] == 0x40C10A
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C0F0,
        0x40C0F6,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW179_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW179_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C10A",
        "native@0x40C132",
        "native@0x40C144",
        "native@0x40C14E",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C108"
    ).depends_on == ("rhad:route@0x40C0EE",)
    assert "native@0x40C10A" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40C10A"
    ).stable_identity.exact_instruction_eas == frozenset(
        {
    ...
    assert plan.block(
        "native@0x40C132"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C132, 0x40C138, 0x40C13E})
    assert plan.block(
        "native@0x40C144"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C144, 0x40C146, 0x40C148, 0x40C14E}
    )
    assert plan.block(
        "native@0x40C14E"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C14E})
    assert plan.block(
        "native@0x40C770"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C770, 0x40C775, 0x40C77B, 0x40C781}
    )
    assert plan.block(
        "native@0x40C787"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C787, 0x40C789, 0x40C78B, 0x40C78D, 0x40C793}
    )
    assert plan.block(
        "native@0x40C793"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C793})
    assert "rhad:route@0x40C108" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C10A].owned_ranges == (
        (0x40C10A, 0x40C150),
        (0x40C770, 0x40C795),
    )
    assert templates[0x40C10A].owned_block_entry_eas == (
        0x40C10A,
        0x40C132,
        0x40C144,
        0x40C770,
    ...
    assert templates[0x40C10A].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C10A].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C14E,
            boundary_exit_eas=(0x40B6C0,),
        ),
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C793,
            boundary_exit_eas=(0x40A607,),
        ),
    )


def test_checksum_producer_compiles_row180_direct_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C14E")
    ...
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.route_proof_id == "rhad-direct@0x40C14E"
    assert rewrite.owner_anchor_ea == 0x40C144
    assert rewrite.rewrite_anchor_ea == 0x40C14E
    assert rewrite.proof_corridor_instruction_eas == (
        0x40C132,
        0x40C144,
        0x40C146,
    ...
    assert payload["reference_order"] == 180
    assert payload["reference_operation_id"] == "rhad:route@0x40C14E"
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C132
    assert payload["source_block_anchor_ea"] == 0x40C144
    assert payload["transfer_ea"] == 0x40C14E
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C132,
        0x40C144,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C14E"
    ).depends_on == ("rhad:route@0x40C108",)
    assert "native@0x40C144" in batch.native_body_entry_block_ids
    assert "native@0x40B6C0" in batch.native_body_entry_block_ids
    assert "route:rhad-direct@0x40C14E" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C144"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C144, 0x40C146, 0x40C148, 0x40C14E}
...
def test_checksum_producer_compiles_row181_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C168")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C156
    assert normalization.unresolved_transfer_ea == 0x40C168
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C15E"
    assert envelope.join_block_id == "native@0x40C164"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C16A",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 181
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C150
    assert payload["source_block_anchor_ea"] == 0x40C164
    assert payload["condition_producer_ea"] == 0x40C156
    assert payload["predicate_anchor_ea"] == 0x40C15C
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xCCEC5DE0
    assert payload["transfer_ea"] == 0x40C168
    assert payload["true_target_ea"] == 0x40C16A
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C150,
        0x40C156,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW181_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW181_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C16A",
        "native@0x40C17D",
        "native@0x40C180",
        "native@0x40C184",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C168"
    ).depends_on == ("route:rhad-direct@0x40C14E",)
    assert "native@0x40C16A" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40C16A"
    ).stable_identity.exact_instruction_eas == frozenset(
        {
    ...
    assert plan.block(
        "native@0x40C17D"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C17D})
    assert plan.block(
        "native@0x40C180"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C180, 0x40C182, 0x40C184})
    assert plan.block(
        "native@0x40C184"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C184})
    assert "rhad:route@0x40C168" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C16A].owned_ranges == ((0x40C16A, 0x40C186),)
    assert templates[0x40C16A].owned_block_entry_eas == (
        0x40C16A,
        0x40C17D,
        0x40C180,
    )
    assert templates[0x40C16A].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C16A].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C184,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row182_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C184")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C16F
    assert normalization.unresolved_transfer_ea == 0x40C184
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C17D"
    assert envelope.join_block_id == "native@0x40C180"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 182
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C175
    assert payload["source_block_anchor_ea"] == 0x40C16A
    assert payload["condition_producer_ea"] == 0x40C16F
    assert payload["predicate_anchor_ea"] == 0x40C17D
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C184
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C16F,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C184"
    ).depends_on == ("rhad:route@0x40C168",)
    assert "native@0x40C16A" in batch.native_body_entry_block_ids
    assert "native@0x40B6C0" in batch.native_body_entry_block_ids
    assert "native@0x40A607" in batch.native_body_entry_block_ids
    assert "rhad:route@0x40C184" in batch.native_body_proof_ids


def test_checksum_producer_compiles_row183_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    assert batch.aggregate_program_identity == (
        "sha256:831b0839ebc7df3b715ed1054c3ed04401bb3565b8268b15f7c2efb20fa07856"
    )
    assert len(batch.operations) == 230
    ...
    assert len(plan.blocks) == 890
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C18C
    assert normalization.unresolved_transfer_ea == 0x40C19E
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C194"
    assert envelope.join_block_id == "native@0x40C19A"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C1A0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 183
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C186
    assert payload["source_block_anchor_ea"] == 0x40C19A
    assert payload["condition_producer_ea"] == 0x40C18C
    assert payload["predicate_anchor_ea"] == 0x40C192
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xA7933EA0
    assert payload["transfer_ea"] == 0x40C19E
    assert payload["true_target_ea"] == 0x40C1A0
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C186,
        0x40C18C,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW183_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW183_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C1A0",
        "native@0x40C1C0",
        "native@0x40C1E9",
        "native@0x40C1EC",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C19E"
    ).depends_on == ("rhad:route@0x40C184",)
    assert "native@0x40C186" in batch.native_body_entry_block_ids
    assert "native@0x40C1A0" in batch.native_body_entry_block_ids
    assert plan.block(
        "native@0x40C1A0"
    ).stable_identity.exact_instruction_eas == frozenset(
        {
    ...
    assert plan.block(
        "native@0x40C1E9"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C1E9})
    assert plan.block(
        "native@0x40C1EC"
    ).stable_identity.exact_instruction_eas == frozenset(
        {
    ...
    assert plan.block(
        "native@0x40C1F0"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C1F0})
    assert "rhad:route@0x40C19E" in batch.native_body_proof_ids

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C1A0].owned_ranges == (
        (0x40C1A0, 0x40C1C0),
        (0x40C1C0, 0x40C1F2),
    )
    assert templates[0x40C1A0].owned_block_entry_eas == (
        0x40C1A0,
        0x40C1C0,
        0x40C1EC,
    )
    assert templates[0x40C1A0].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C1A0].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C1F0,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row184_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C1F0")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C1DB
    assert normalization.unresolved_transfer_ea == 0x40C1F0
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C1E9"
    assert envelope.join_block_id == "native@0x40C1EC"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 184
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C1C6
    assert payload["source_block_anchor_ea"] == 0x40C1C0
    assert payload["condition_producer_ea"] == 0x40C1DB
    assert payload["predicate_anchor_ea"] == 0x40C1E9
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C1F0
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C1C6,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C1F0"
    ).depends_on == ("rhad:route@0x40C19E",)
    assert "native@0x40C1C0" in batch.native_body_entry_block_ids
    assert "native@0x40B6C0" in batch.native_body_entry_block_ids
    assert "native@0x40A607" in batch.native_body_entry_block_ids
    assert "rhad:route@0x40C1F0" in batch.native_body_proof_ids


def test_checksum_producer_compiles_row185_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C20A")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C1F8
    assert normalization.unresolved_transfer_ea == 0x40C20A
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C200"
    assert envelope.join_block_id == "native@0x40C206"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C20C",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 185
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C1F2
    assert payload["source_block_anchor_ea"] == 0x40C206
    assert payload["condition_producer_ea"] == 0x40C1F8
    assert payload["predicate_anchor_ea"] == 0x40C1FE
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xF0B56411
    assert payload["transfer_ea"] == 0x40C20A
    assert payload["true_target_ea"] == 0x40C20C
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C1F2,
        0x40C1F8,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW185_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C20A"
    ).depends_on == ("rhad:route@0x40C1F0",)
    assert "native@0x40C1F2" in batch.native_body_entry_block_ids
    assert "native@0x40C20C" in batch.native_body_entry_block_ids
    assert "rhad:route@0x40C20A" in batch.native_body_proof_ids


def test_checksum_producer_compiles_row186_direct_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C251")
    assert operation.predicate_anchor_ea is None
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40B6C0",
    }
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.route_proof_id == "rhad-direct@0x40C251"
    assert rewrite.owner_anchor_ea == 0x40C247
    assert rewrite.rewrite_anchor_ea == 0x40C251
    assert rewrite.proof_corridor_instruction_eas == (
        0x40C235,
        0x40C247,
        0x40C249,
    ...
    assert payload["reference_order"] == 186
    assert payload["reference_operation_id"] == "rhad:route@0x40C251"
    assert payload["reference_symbol"] == ("JumpInliner._fixup_jmp_and_possible_jcc")
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C235
    assert payload["source_block_anchor_ea"] == 0x40C247
    assert payload["transfer_ea"] == 0x40C251
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C235,
        0x40C247,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C251"
    ).depends_on == ("rhad:route@0x40C20A",)
    assert "native@0x40C247" in batch.native_body_entry_block_ids
    assert "native@0x40B6C0" in batch.native_body_entry_block_ids
    assert "route:rhad-direct@0x40C251" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C235"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C235, 0x40C23B, 0x40C241})
    assert plan.block(
        "native@0x40C247"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C247, 0x40C249, 0x40C24B, 0x40C251}
    )
    assert plan.block(
        "native@0x40C251"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C251})


def test_checksum_producer_compiles_row187_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C26B")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C259
    assert normalization.unresolved_transfer_ea == 0x40C26B
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C261"
    assert envelope.join_block_id == "native@0x40C267"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C26D",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 187
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C253
    assert payload["source_block_anchor_ea"] == 0x40C267
    assert payload["condition_producer_ea"] == 0x40C259
    assert payload["predicate_anchor_ea"] == 0x40C25F
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xA0716E5B
    assert payload["transfer_ea"] == 0x40C26B
    assert payload["true_target_ea"] == 0x40C26D
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C253,
        0x40C259,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW187_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C26B"
    ).depends_on == ("route:rhad-direct@0x40C251",)
    assert {"native@0x40C253", "native@0x40C26D"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C26B" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C26D"
    ).stable_identity.exact_instruction_eas == frozenset(
        {
    ...
    assert plan.block(
        ...
        {0x40C2AF, 0x40C2B5, 0x40C2BA, 0x40C2BC, 0x40C2BD, 0x40C2BE}
    )
    assert plan.block(
        "native@0x40C2C3"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C2C3, 0x40C2C6, 0x40C2CB, 0x40C2CF, 0x40C2D1}
    )
    assert plan.block(
        "native@0x40C2D7"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C2D7, 0x40C2DD, 0x40C2E3, 0x40C2E9}
    )
    assert plan.block(
        "native@0x40C2EF"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C2EF, 0x40C2F1, 0x40C2F3, 0x40C2F9}
    )
    assert plan.block(
        "native@0x40C2F9"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C2F9})
    assert plan.block(
        "native@0x40C7BA"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C7BA, 0x40C7BF, 0x40C7C5, 0x40C7CB, 0x40C7D1}
    )
    assert plan.block(
        "native@0x40C7D7"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C7D7, 0x40C7D9, 0x40C7DB, 0x40C7DD, 0x40C7E3}
    )
    assert plan.block(
        "native@0x40C7E3"
    ...
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C253].boundary_exit_eas == (0x40A5F0, 0x40C26D)
    assert templates[0x40C26D].owned_ranges == (
        (0x40C26D, 0x40C2AF),
        (0x40C2AF, 0x40C2C3),
        (0x40C2C3, 0x40C2D7),
        (0x40C2D7, 0x40C2FB),
    ...
    assert templates[0x40C26D].owned_block_entry_eas == (
        0x40C26D,
        0x40C2AF,
        0x40C2C3,
        0x40C2D7,
    ...
    assert templates[0x40C26D].boundary_exit_eas == (0x40A607, 0x40B6C0)


def test_checksum_producer_compiles_row188_direct_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C2F9")
    ...
    assert payload["reference_order"] == 188
    assert payload["reference_operation_id"] == "rhad:route@0x40C2F9"
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C2D7
    assert payload["source_block_anchor_ea"] == 0x40C2EF
    assert payload["transfer_ea"] == 0x40C2F9
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C2D7,
        0x40C2EF,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C2F9"
    ).depends_on == ("rhad:route@0x40C26B",)
    assert {"native@0x40C2D7", "native@0x40C2EF", "native@0x40B6C0"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "route:rhad-direct@0x40C2F9" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C2D7"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C2D7, 0x40C2DD, 0x40C2E3, 0x40C2E9}
...
def test_checksum_producer_compiles_row189_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C313")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C301
    assert normalization.unresolved_transfer_ea == 0x40C313
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C309"
    assert envelope.join_block_id == "native@0x40C30F"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C315",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 189
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C2FB
    assert payload["source_block_anchor_ea"] == 0x40C30F
    assert payload["condition_producer_ea"] == 0x40C301
    assert payload["predicate_anchor_ea"] == 0x40C307
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xE41F690E
    assert payload["transfer_ea"] == 0x40C313
    assert payload["true_target_ea"] == 0x40C315
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C2FB,
        0x40C301,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW189_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C313"
    ).depends_on == ("route:rhad-direct@0x40C2F9",)
    assert {"native@0x40C2FB", "native@0x40C315"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C313" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C315"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C315, 0x40C31F, 0x40C322, 0x40C328, 0x40C32D, 0x40C32F}
    )
    assert plan.block(
        "native@0x40C335"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C335, 0x40C33B, 0x40C341})
    assert plan.block(
        "native@0x40C347"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C347, 0x40C349, 0x40C34B})
    assert plan.block(
        "native@0x40C34B"
    ...
    assert plan.block(
        ...
        {0x40C7E5, 0x40C7EA, 0x40C7F0, 0x40C7F6}
    )
    assert plan.block(
        "native@0x40C7FC"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C7FC, 0x40C7FE, 0x40C800, 0x40C802}
    )
    assert plan.block(
        "native@0x40C802"
    ...
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C2FB].boundary_exit_eas == (0x40A5F0, 0x40C315)
    assert templates[0x40C315].owned_ranges == (
        (0x40C315, 0x40C335),
        (0x40C335, 0x40C347),
        (0x40C347, 0x40C34D),
        (0x40C7E5, 0x40C7FC),
    ...
    assert templates[0x40C315].owned_block_entry_eas == (
        0x40C315,
        0x40C335,
        0x40C347,
        0x40C7E5,
...
def test_checksum_producer_compiles_row191_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C365")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C353
    assert normalization.unresolved_transfer_ea == 0x40C365
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C35B"
    assert envelope.join_block_id == "native@0x40C361"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C367",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 191
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C34D
    assert payload["source_block_anchor_ea"] == 0x40C361
    assert payload["condition_producer_ea"] == 0x40C353
    assert payload["predicate_anchor_ea"] == 0x40C359
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xB5D98F1E
    assert payload["transfer_ea"] == 0x40C365
    assert payload["true_target_ea"] == 0x40C367
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C34D,
        0x40C353,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW191_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C365"
    ).depends_on == ("route:rhad-direct@0x40C34B",)
    assert {"native@0x40C34D", "native@0x40C367"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C365" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C367"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C367, 0x40C36F, 0x40C374}
    )
    assert plan.block(
        "native@0x40C37A"
    ).stable_identity.exact_instruction_eas == frozenset(
    ...
    assert plan.block(
        ...
        {0x40C804, 0x40C809, 0x40C80F, 0x40C815}
    )
    assert plan.block(
        "native@0x40C81B"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C81B, 0x40C81D, 0x40C81F, 0x40C821}
    )
    assert plan.block(
        "native@0x40C821"
    ...
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C34D].boundary_exit_eas == (0x40A5F0, 0x40C367)
    assert templates[0x40C367].owned_ranges == (
        (0x40C367, 0x40C37A),
        (0x40C37A, 0x40C38C),
        (0x40C38C, 0x40C392),
        (0x40C804, 0x40C81B),
    ...
    assert templates[0x40C367].owned_block_entry_eas == (
        0x40C367,
        0x40C37A,
        0x40C38C,
        0x40C804,
...
def test_checksum_producer_compiles_row193_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C3AA")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C398
    assert normalization.unresolved_transfer_ea == 0x40C3AA
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C3A0"
    assert envelope.join_block_id == "native@0x40C3A6"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C3AC",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 193
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C392
    assert payload["source_block_anchor_ea"] == 0x40C3A6
    assert payload["condition_producer_ea"] == 0x40C398
    assert payload["predicate_anchor_ea"] == 0x40C39E
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xFA72F85A
    assert payload["transfer_ea"] == 0x40C3AA
    assert payload["true_target_ea"] == 0x40C3AC
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C392,
        0x40C398,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW193_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C3AA"
    ).depends_on == ("route:rhad-direct@0x40C390",)
    assert {"native@0x40C392", "native@0x40C3AC"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C3AA" in batch.native_body_proof_ids
    for block_id, exact_eas in {
        "native@0x40C3AC": {0x40C3AC, 0x40C3B0, 0x40C3B5, 0x40C3B9, 0x40C3BB},
        "native@0x40C3C1": {0x40C3C1, 0x40C3C7, 0x40C3CD},
        "native@0x40C3D3": {0x40C3D3, 0x40C3D5, 0x40C3D7},
        "native@0x40C3D7": {0x40C3D7},
        "native@0x40C823": {0x40C823, 0x40C828, 0x40C82E, 0x40C834},
        "native@0x40C83A": {0x40C83A, 0x40C83C, 0x40C83E, 0x40C840},
        "native@0x40C840": {0x40C840},
    }.items():
        assert plan.block(block_id).stable_identity.exact_instruction_eas == frozenset(
            exact_eas
        )

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C392].boundary_exit_eas == (0x40A5F0, 0x40C3AC)
    assert templates[0x40C3AC].owned_ranges == (
        (0x40C3AC, 0x40C3C1),
        (0x40C3C1, 0x40C3D3),
        (0x40C3D3, 0x40C3D9),
        (0x40C823, 0x40C83A),
    ...
    assert templates[0x40C3AC].owned_block_entry_eas == (
        0x40C3AC,
        0x40C3C1,
        0x40C3D3,
        0x40C823,
    ...
    assert templates[0x40C3AC].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C3AC].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C3D7,
            boundary_exit_eas=(0x40B6C0,),
        ),
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C840,
            boundary_exit_eas=(0x40A607,),
        ),
    )


def test_checksum_producer_compiles_row194_direct_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C3D7")
    assert operation.direct_transfer_rewrite is not None
    assert operation.direct_transfer_rewrite.rewrite_anchor_ea == 0x40C3D7
    assert operation.direct_transfer_rewrite.owner_anchor_ea == 0x40C3D3
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40B6C0"
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C3D7"
    assert payload["reference_order"] == 194
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C3C1
    assert payload["source_block_anchor_ea"] == 0x40C3D3
    assert payload["transfer_ea"] == 0x40C3D7
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C3C1,
        0x40C3D3,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C3D7"
    ).depends_on == ("rhad:route@0x40C3AA",)
    assert "route:rhad-direct@0x40C3D7" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C3C1"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C3C1, 0x40C3C7, 0x40C3CD}
    )
    assert plan.block(
        "native@0x40C3D3"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C3D3, 0x40C3D5, 0x40C3D7}
    )
    assert plan.block(
        "native@0x40C3D7"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C3D7})

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C3AC].preserved_unresolved_transfers[0] == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C3D7,
            boundary_exit_eas=(0x40B6C0,),
        )
...
def test_checksum_producer_compiles_row195_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C3F1")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C3DF
    assert normalization.unresolved_transfer_ea == 0x40C3F1
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C3E7"
    assert envelope.join_block_id == "native@0x40C3ED"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C3F3",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 195
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C3D9
    assert payload["source_block_anchor_ea"] == 0x40C3ED
    assert payload["condition_producer_ea"] == 0x40C3DF
    assert payload["predicate_anchor_ea"] == 0x40C3E5
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0x96B0D1E5
    assert payload["transfer_ea"] == 0x40C3F1
    assert payload["true_target_ea"] == 0x40C3F3
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C3D9,
        0x40C3DF,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW195_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C3F1"
    ).depends_on == ("route:rhad-direct@0x40C3D7",)
    assert {"native@0x40C3D9", "native@0x40C3F3"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C3F1" in batch.native_body_proof_ids
    for block_id, exact_eas in {
        "native@0x40C3F3": {0x40C3F3},
        "native@0x40C3F9": {0x40C3F9, 0x40C3FE, 0x40C402, 0x40C404},
        "native@0x40C40A": {0x40C40A, 0x40C410, 0x40C416, 0x40C41C},
        "native@0x40C422": {0x40C422, 0x40C424, 0x40C426, 0x40C42C},
        "native@0x40C42C": {0x40C42C},
        "native@0x40C842": {0x40C842, 0x40C847, 0x40C84D, 0x40C853, 0x40C859},
        "native@0x40C85F": {0x40C85F, 0x40C861, 0x40C863, 0x40C865, 0x40C86B},
        "native@0x40C86B": {0x40C86B},
    }.items():
        assert plan.block(block_id).stable_identity.exact_instruction_eas == frozenset(
            exact_eas
        )
    ...
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C3D9].boundary_exit_eas == (0x40A5F0, 0x40C3F3)
    assert templates[0x40C3F3].owned_ranges == (
        (0x40C3F3, 0x40C3F9),
        (0x40C3F9, 0x40C40A),
        (0x40C40A, 0x40C422),
        (0x40C422, 0x40C42E),
    ...
    assert templates[0x40C3F3].owned_block_entry_eas == (
        0x40C3F3,
        0x40C3F9,
        0x40C40A,
        0x40C422,
    ...
    assert templates[0x40C3F3].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C3F3].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C42C,
            boundary_exit_eas=(0x40B6C0,),
        ),
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C86B,
            boundary_exit_eas=(0x40A607,),
        ),
    )


def test_checksum_producer_compiles_row196_direct_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C42C")
    assert operation.source_block_id == "native@0x40C422"
    assert operation.direct_transfer_rewrite is not None
    assert operation.direct_transfer_rewrite.owner_anchor_ea == 0x40C422
    assert operation.direct_transfer_rewrite.rewrite_anchor_ea == 0x40C42C
    assert operation.edges[0].role is SemanticEdgeRole.DIRECT
    assert operation.edges[0].target_block_id == "native@0x40B6C0"
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_operation_id"] == "rhad:route@0x40C42C"
    assert payload["reference_order"] == 196
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C40A
    assert payload["source_block_anchor_ea"] == 0x40C422
    assert payload["transfer_ea"] == 0x40C42C
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C40A,
        0x40C422,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C42C"
    ).depends_on == ("rhad:route@0x40C3F1",)
    assert "native@0x40C422" in batch.native_body_entry_block_ids
    assert "native@0x40B6C0" in batch.native_body_entry_block_ids
    assert "route:rhad-direct@0x40C42C" in batch.native_body_proof_ids
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C3F3].preserved_unresolved_transfers[0] == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C42C,
            boundary_exit_eas=(0x40B6C0,),
        )
...
def test_checksum_producer_compiles_row197_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C446")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C434
    assert normalization.unresolved_transfer_ea == 0x40C446
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C43C"
    assert envelope.join_block_id == "native@0x40C442"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C448",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 197
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C42E
    assert payload["source_block_anchor_ea"] == 0x40C442
    assert payload["condition_producer_ea"] == 0x40C434
    assert payload["predicate_anchor_ea"] == 0x40C43A
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xD44F0C43
    assert payload["transfer_ea"] == 0x40C446
    assert payload["true_target_ea"] == 0x40C448
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C42E,
        0x40C434,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW197_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C446"
    ).depends_on == ("route:rhad-direct@0x40C42C",)
    assert {"native@0x40C42E", "native@0x40C448"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C446" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C448"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C448, 0x40C44D, 0x40C453, 0x40C455, 0x40C45B}
    )
    assert plan.block(
        "native@0x40C45E"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C45E, 0x40C460, 0x40C462}
    )
    assert plan.block(
        "native@0x40C462"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C462})

    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C42E].boundary_exit_eas == (0x40A5F0, 0x40C448)
    assert templates[0x40C448].owned_ranges == (
        (0x40C448, 0x40C45E),
        (0x40C45E, 0x40C464),
    )
    assert templates[0x40C448].owned_block_entry_eas == (0x40C448, 0x40C45E)
    assert templates[0x40C448].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C448].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
...
def test_checksum_producer_compiles_row198_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C462")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C44D
    assert normalization.unresolved_transfer_ea == 0x40C462
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C45B"
    assert envelope.join_block_id == "native@0x40C45E"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 198
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C453
    assert payload["source_block_anchor_ea"] == 0x40C448
    assert payload["condition_producer_ea"] == 0x40C44D
    assert payload["predicate_anchor_ea"] == 0x40C45B
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C462
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C44D,
    ...
    assert payload["imported_closure_block_ids"] == [
        *generated_reference.ACCEPTED_IMPORTED_BLOCK_IDS,
        *generated_reference.ROW198_SOURCE_IMPORTED_BLOCK_IDS,
    ]
    assert payload["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C462"
    ).depends_on == ("rhad:route@0x40C446",)
    assert "native@0x40C448" in batch.native_body_entry_block_ids
    assert "native@0x40C45B" in generated_reference.IMPORTED_BLOCK_IDS
    assert "native@0x40B6C0" in batch.native_body_entry_block_ids
    assert "native@0x40A607" in batch.native_body_entry_block_ids
...
def test_checksum_producer_compiles_row199_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C47C")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C46A
    assert normalization.unresolved_transfer_ea == 0x40C47C
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C472"
    assert envelope.join_block_id == "native@0x40C478"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C47E",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 199
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C464
    assert payload["source_block_anchor_ea"] == 0x40C478
    assert payload["condition_producer_ea"] == 0x40C46A
    assert payload["predicate_anchor_ea"] == 0x40C470
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xAE5A330B
    assert payload["transfer_ea"] == 0x40C47C
    assert payload["true_target_ea"] == 0x40C47E
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C464,
        0x40C46A,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW199_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C47C"
    ).depends_on == ("rhad:route@0x40C462",)
    assert {"native@0x40C464", "native@0x40C47E"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C47C" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C47E"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C47E, 0x40C483, 0x40C489, 0x40C48B, 0x40C491}
    )
    assert plan.block(
        "native@0x40C494"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C494, 0x40C496, 0x40C498}
    )
    assert plan.block(
        "native@0x40C498"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C498})
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C464].boundary_exit_eas == (0x40A5F0, 0x40C47E)
    assert templates[0x40C47E].owned_ranges == (
        (0x40C47E, 0x40C494),
        (0x40C494, 0x40C49A),
    )
    assert templates[0x40C47E].owned_block_entry_eas == (0x40C47E, 0x40C494)
    assert templates[0x40C47E].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C47E].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C498,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row200_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C498")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C483
    assert normalization.unresolved_transfer_ea == 0x40C498
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C491"
    assert envelope.join_block_id == "native@0x40C494"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 200
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C489
    assert payload["source_block_anchor_ea"] == 0x40C47E
    assert payload["condition_producer_ea"] == 0x40C483
    assert payload["predicate_anchor_ea"] == 0x40C491
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C498
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C483,
    ...
    assert payload["imported_closure_block_ids"] == [
        *generated_reference.ACCEPTED_IMPORTED_BLOCK_IDS,
        *generated_reference.ROW200_SOURCE_IMPORTED_BLOCK_IDS,
    ]
    assert payload["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C498"
    ).depends_on == ("rhad:route@0x40C47C",)
    assert "native@0x40C47E" in batch.native_body_entry_block_ids
    assert "native@0x40C491" in generated_reference.IMPORTED_BLOCK_IDS
    assert "native@0x40B6C0" in batch.native_body_entry_block_ids
    assert "native@0x40A607" in batch.native_body_entry_block_ids
    assert "rhad:route@0x40C498" in batch.native_body_proof_ids
    block_ids = [block.block_id for block in plan.blocks]
    source_index = block_ids.index("native@0x40C47E")
    assert block_ids[source_index : source_index + 3] == [
        "native@0x40C47E",
        "native@0x40C491",
        "native@0x40C494",
    ...
    assert plan.block(
        "native@0x40C491"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C491})


def test_checksum_producer_compiles_row201_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C4B2")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C4A0
    assert normalization.unresolved_transfer_ea == 0x40C4B2
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C4A8"
    assert envelope.join_block_id == "native@0x40C4AE"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C4B4",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 201
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C49A
    assert payload["source_block_anchor_ea"] == 0x40C4AE
    assert payload["condition_producer_ea"] == 0x40C4A0
    assert payload["predicate_anchor_ea"] == 0x40C4A6
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xF6A636EF
    assert payload["transfer_ea"] == 0x40C4B2
    assert payload["true_target_ea"] == 0x40C4B4
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C49A,
        0x40C4A0,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C4B2"
    ).depends_on == ("rhad:route@0x40C498",)
    assert {"native@0x40C49A", "native@0x40C4B4"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C4B2" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C4B4"
    ).stable_identity.exact_instruction_eas == frozenset(
...
def test_checksum_producer_compiles_row202_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C4DA")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C4CC
    assert normalization.unresolved_transfer_ea == 0x40C4DA
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C4D4"
    assert envelope.join_block_id == "native@0x40C4D6"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 202
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C4C6
    assert payload["source_block_anchor_ea"] == 0x40C4D6
    assert payload["condition_producer_ea"] == 0x40C4CC
    assert payload["predicate_anchor_ea"] == 0x40C4D2
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C4DA
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C4C6,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C4DA"
    ).depends_on == ("rhad:route@0x40C4B2",)
    assert {"native@0x40C4C6", "native@0x40C4D4", "native@0x40C4D6"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C4DA" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C4D4"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C4D4})


def test_checksum_producer_compiles_row203_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C4F4")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C4E2
    assert normalization.unresolved_transfer_ea == 0x40C4F4
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C4EA"
    assert envelope.join_block_id == "native@0x40C4F0"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C4F6",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 203
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C4DC
    assert payload["source_block_anchor_ea"] == 0x40C4F0
    assert payload["condition_producer_ea"] == 0x40C4E2
    assert payload["predicate_anchor_ea"] == 0x40C4E8
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xA5540595
    assert payload["transfer_ea"] == 0x40C4F4
    assert payload["true_target_ea"] == 0x40C4F6
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C4DC,
        0x40C4E2,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW203_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C4F4"
    ).depends_on == ("rhad:route@0x40C4DA",)
    assert {"native@0x40C4DC", "native@0x40C4EA", "native@0x40C4F0"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C4F4" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C4F6"
    ).stable_identity.exact_instruction_eas == frozenset(
        {
    ...
    assert plan.block(
        "native@0x40C525"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C525})
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C4F6].owned_ranges == (
        (0x40C4F6, 0x40C521),
        (0x40C521, 0x40C527),
    )
    assert templates[0x40C4F6].owned_block_entry_eas == (0x40C4F6, 0x40C521)
    assert templates[0x40C4F6].boundary_exit_eas == (0x40A607, 0x40B6C0)
    assert templates[0x40C4F6].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C525,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row204_cmov_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C525")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C510
    assert normalization.unresolved_transfer_ea == 0x40C525
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C51E"
    assert envelope.join_block_id == "native@0x40C521"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 204
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C516
    assert payload["source_block_anchor_ea"] == 0x40C4F6
    assert payload["condition_producer_ea"] == 0x40C510
    assert payload["predicate_anchor_ea"] == 0x40C51E
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C525
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C510,
    ...
    assert payload["imported_closure_block_ids"] == [
        *generated_reference.ACCEPTED_IMPORTED_BLOCK_IDS,
        *generated_reference.ROW204_SOURCE_IMPORTED_BLOCK_IDS,
    ]
    assert payload["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C525"
    ).depends_on == ("rhad:route@0x40C4F4",)
    assert {"native@0x40C4F6", "native@0x40C51E", "native@0x40C521"}.issubset(
        batch.native_body_entry_block_ids
    )
    assert "rhad:route@0x40C525" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C51E"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C51E})
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C4F6].owned_ranges == (
        (0x40C4F6, 0x40C521),
        (0x40C521, 0x40C527),
...
def test_checksum_producer_compiles_row205_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(native_key=_native_key(), evidence_generation=7)
    batch = reference_batch_for_native_key(_native_key())
    assert batch is not None
    operation = plan.operation("rhad:route@0x40C53F")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C52D
    assert normalization.unresolved_transfer_ea == 0x40C53F
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C535"
    assert envelope.join_block_id == "native@0x40C53B"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C541",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(operation.reference_route_authority.reference_route.reference_ledger_json)
    assert payload["reference_order"] == 205
    assert payload["condition_producer_ea"] == 0x40C52D
    assert payload["comparison_constant"] == 0xEC054ACC
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C527, 0x40C52D, 0x40C533, 0x40C535, 0x40C53B, 0x40C53D, 0x40C53F,
    ]
...
def test_checksum_producer_compiles_row206_cmov_dependency_without_new_template() -> None:
    plan = build_rhad_generated_reference_plan(native_key=_native_key(), evidence_generation=7)
    batch = reference_batch_for_native_key(_native_key())
    assert batch is not None
    operation = plan.operation("rhad:route@0x40C576")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C561
    assert normalization.unresolved_transfer_ea == 0x40C576
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C56F"
    assert envelope.join_block_id == "native@0x40C572"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    payload = json.loads(operation.reference_route_authority.reference_route.reference_ledger_json)
    assert payload["reference_order"] == 206
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C553
    assert payload["source_block_anchor_ea"] == 0x40C54D
    assert payload["condition_producer_ea"] == 0x40C561
    assert payload["predicate_anchor_ea"] == 0x40C56F
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C576
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C553,
    ...
    assert payload["imported_closure_block_ids"] == [
        *generated_reference.ACCEPTED_IMPORTED_BLOCK_IDS,
        *generated_reference.ROW206_SOURCE_IMPORTED_BLOCK_IDS,
    ]
    assert payload["boundary_exit_eas"] == [0x40A61B, 0x40A68C, 0x40B790]
    assert next(
        row for row in batch.operations if row.operation_id == "rhad:route@0x40C576"
    ).depends_on == ("rhad:route@0x40C53F",)
    ...
    assert templates[0x40C541].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C576,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row207_existing_dependency_and_target_closure() -> None:
    plan = build_rhad_generated_reference_plan(native_key=_native_key(), evidence_generation=7)
    batch = reference_batch_for_native_key(_native_key())
    assert batch is not None
    operation = plan.operation("rhad:route@0x40C590")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C57E
    assert normalization.unresolved_transfer_ea == 0x40C590
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C586"
    assert envelope.join_block_id == "native@0x40C58C"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C592",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(operation.reference_route_authority.reference_route.reference_ledger_json)
    assert payload["reference_order"] == 207
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C578
    assert payload["source_block_anchor_ea"] == 0x40C58C
    assert payload["condition_producer_ea"] == 0x40C57E
    assert payload["predicate_anchor_ea"] == 0x40C584
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0xBD9A2C2A
    assert payload["transfer_ea"] == 0x40C590
    assert payload["true_target_ea"] == 0x40C592
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C578,
        0x40C57E,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW207_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A607, 0x40B6C0]
    assert next(
        row for row in batch.operations if row.operation_id == "rhad:route@0x40C590"
    ).depends_on == ("rhad:route@0x40C576",)
    assert {
        "native@0x40C578",
        "native@0x40C592",
        "native@0x40C5BD",
    ...
    assert "rhad:route@0x40C590" in batch.native_body_proof_ids
    assert plan.block("native@0x40C592").stable_identity.exact_instruction_eas == frozenset(
        {0x40C592, 0x40C597, 0x40C59C, 0x40C59E, 0x40C5A4, 0x40C5A9, 0x40C5AB, 0x40C5AC, 0x40C5AD, 0x40C5AF, 0x40C5B6, 0x40C5B7}
    )
    assert plan.block("native@0x40C5F9").stable_identity.exact_instruction_eas == frozenset({0x40C5F9})
    assert plan.block("native@0x40C896").stable_identity.exact_instruction_eas == frozenset({0x40C896})
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C592].owned_ranges == (
        (0x40C592, 0x40C5FB),
        (0x40C86D, 0x40C898),
    )
    assert templates[0x40C592].owned_block_entry_eas == (
        0x40C592,
        0x40C5BD,
        0x40C5D7,
        0x40C5EF,
    ...
    assert templates[0x40C592].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C5F9,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C896,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row208_direct_dependency_and_reused_closure() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C5F9")
    assert operation.source_block_id == "native@0x40C5EF"
    assert operation.direct_transfer_rewrite is not None
    assert operation.direct_transfer_rewrite.owner_anchor_ea == 0x40C5EF
    assert operation.direct_transfer_rewrite.rewrite_anchor_ea == 0x40C5F9
    assert operation.edges[0].role is SemanticEdgeRole.DIRECT
    assert operation.edges[0].target_block_id == "native@0x40B6C0"
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_operation_id"] == "rhad:route@0x40C5F9"
    assert payload["reference_order"] == 208
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C5D7
    assert payload["source_block_anchor_ea"] == 0x40C5EF
    assert payload["transfer_ea"] == 0x40C5F9
    assert payload["direct_target_block_id"] == "native@0x40B6C0"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C5D7,
        0x40C5EF,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C5F9"
    ).depends_on == ("rhad:route@0x40C590",)
...
def test_checksum_producer_compiles_row209_existing_dependency_and_both_target_corridors() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C613")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C601
    assert normalization.unresolved_transfer_ea == 0x40C613
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C609"
    assert envelope.join_block_id == "native@0x40C60F"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C64B",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40C615",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 209
    assert payload["reference_symbol"] == "JumpInliner._fixup_jmp_and_possible_jcc"
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C5FB
    assert payload["source_block_anchor_ea"] == 0x40C60F
    assert payload["condition_producer_ea"] == 0x40C601
    assert payload["predicate_anchor_ea"] == 0x40C607
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x09FE690C
    assert payload["transfer_ea"] == 0x40C613
    assert payload["true_target_ea"] == 0x40C64B
    assert payload["false_target_ea"] == 0x40C615
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C5FB,
        0x40C601,
        0x40C607,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW209_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW209_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C615",
        "native@0x40C623",
        "native@0x40C629",
        "native@0x40C62D",
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40C62F, 0x40C665]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C613"
    ).depends_on == ("route:rhad-direct@0x40C5F9",)
    assert {
        "native@0x40C5FB",
        "native@0x40C615",
        "native@0x40C623",
    ...
    assert "rhad:route@0x40C613" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C62D"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C62D})
    assert plan.block(
        "native@0x40C663"
    ...
    assert templates[0x40C615].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C62D,
            boundary_exit_eas=(0x40A5F0, 0x40C62F),
        ),
    )
    assert templates[0x40C64B].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
...
def test_checksum_producer_compiles_row211_cmov_from_reused_split_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C649")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C634
    assert normalization.unresolved_transfer_ea == 0x40C649
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C642"
    assert envelope.join_block_id == "native@0x40C645"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 211
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C63A
    assert payload["source_block_anchor_ea"] == 0x40C62F
    assert payload["condition_producer_ea"] == 0x40C634
    assert payload["predicate_anchor_ea"] == 0x40C642
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C649
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C634,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C649"
    ).depends_on == ("rhad:route@0x40C62D",)
    assert {
        "native@0x40C62F",
        "native@0x40C642",
        "native@0x40C645",
    }.issubset(batch.native_body_entry_block_ids)
    assert "rhad:route@0x40C649" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C642"
...
def test_checksum_producer_compiles_row212_existing_and_c665_target() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C663")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40C651
    assert normalization.unresolved_transfer_ea == 0x40C663
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C659"
    assert envelope.join_block_id == "native@0x40C65F"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C665",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A5F0",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 212
    assert payload["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["source_native_ea"] == 0x40C64B
    assert payload["source_block_anchor_ea"] == 0x40C65F
    assert payload["condition_producer_ea"] == 0x40C651
    assert payload["predicate_anchor_ea"] == 0x40C657
    assert payload["predicate_kind"] == PredicateKind.NE.value
    assert payload["observed_predicate_kind"] == PredicateKind.EQ.value
    assert payload["comparison_constant"] == 0x09FE690C
    assert payload["transfer_ea"] == 0x40C663
    assert payload["true_target_ea"] == 0x40C665
    assert payload["false_target_ea"] == 0x40A5F0
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C64B,
        0x40C651,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW212_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW212_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40C665",
        "native@0x40C68D",
        "native@0x40C690",
        "native@0x40C694",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C663"
    ).depends_on == ("rhad:route@0x40C649",)
    assert {
        "native@0x40C64B",
        "native@0x40C659",
        "native@0x40C65F",
    ...
    assert "rhad:route@0x40C663" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C694"
    ...
    assert len(plan.blocks) == 890
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40C665].owned_ranges == (
        (0x40C665, 0x40C690),
        (0x40C690, 0x40C696),
    )
    assert templates[0x40C665].owned_block_entry_eas == (0x40C665, 0x40C690)
    assert templates[0x40C665].preserved_unresolved_transfers == (
        generated_reference.RhadGeneratedPreservedTransfer(
            transfer_ea=0x40C694,
            boundary_exit_eas=(0x40A607, 0x40B6C0),
        ),
    )


def test_checksum_producer_compiles_row213_cmov_from_row212_split_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40C694")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40C67F
    assert normalization.unresolved_transfer_ea == 0x40C694
    envelope = normalization.conditional_select_envelope
    assert isinstance(envelope, FragmentReferencedImportedConditionalSelectEnvelope)
    assert envelope.selected_value_block_id == "native@0x40C68D"
    assert envelope.join_block_id == "native@0x40C690"
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40B6C0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40A607",
    }
    ...
    assert payload["reference_order"] == 213
    assert payload["reference_symbol"] == "JumpInliner._fixup_cmov"
    assert payload["operation_variant"] == "cmov_selected_indirect"
    assert payload["source_native_ea"] == 0x40C685
    assert payload["source_block_anchor_ea"] == 0x40C665
    assert payload["condition_producer_ea"] == 0x40C67F
    assert payload["predicate_anchor_ea"] == 0x40C68D
    assert payload["predicate_kind"] == PredicateKind.SGE.value
    assert payload["observed_predicate_kind"] == PredicateKind.SLT.value
    assert payload["comparison_constant"] == 0x0BB2D365
    assert payload["transfer_ea"] == 0x40C694
    assert payload["true_target_ea"] == 0x40B6C0
    assert payload["false_target_ea"] == 0x40A607
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C67F,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40C694"
    ).depends_on == ("rhad:route@0x40C663",)
    assert {
        "native@0x40C665",
        "native@0x40C68D",
        "native@0x40C690",
    }.issubset(batch.native_body_entry_block_ids)
    assert "rhad:route@0x40C694" in batch.native_body_proof_ids
    assert plan.block(
        "native@0x40C68D"
...
def test_checksum_producer_compiles_row214_direct_from_row121_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C6B3")
    assert operation.source_block_id == "native@0x40C6AD"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.rewrite_anchor_ea == 0x40C6B3
    assert rewrite.owner_anchor_ea == 0x40C6AD
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C6B3"
    assert payload["reference_order"] == 214
    assert payload["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40B765
    assert payload["source_block_anchor_ea"] == 0x40C6AD
    assert payload["transfer_ea"] == 0x40C6B3
    assert payload["direct_target_block_id"] == "native@0x40A607"
    assert payload["owned_corridor_instruction_eas"] == [
        0x40B765,
        0x40B777,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C6B3"
    ).depends_on == ("rhad:route@0x40C694",)
    assert {
        "native@0x40B758",
        "native@0x40B76B",
        "native@0x40B77D",
    ...
    assert len(plan.blocks) == 890
    templates = {fragment.root_ea: fragment for fragment in batch.template_fragments}
    assert templates[0x40B758].owned_ranges == (
        (0x40B758, 0x40B76B),
        (0x40B76B, 0x40B77D),
        (0x40B77D, 0x40B783),
        (0x40C696, 0x40C6AD),
...
def test_checksum_producer_compiles_row215_direct_from_row132_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C6D8")
    assert operation.source_block_id == "native@0x40C6CC"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.rewrite_anchor_ea == 0x40C6D8
    assert rewrite.owner_anchor_ea == 0x40C6CC
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C6D8"
    assert payload["reference_order"] == 215
    assert payload["source_native_ea"] == 0x40B90F
    assert payload["source_block_anchor_ea"] == 0x40C6CC
    assert payload["transfer_ea"] == 0x40C6D8
    assert payload["owned_corridor_instruction_eas"] == [
        0x40B90F,
        0x40B921,
        0x40C6CC,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW215_TARGET_IMPORTED_BLOCK_IDS
    )
    assert payload["boundary_exit_eas"] == [0x40A61B, 0x40A68C]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C6D8"
    ).depends_on == ("route:rhad-direct@0x40C6B3",)
    assert {
        "native@0x40B8E6",
        "native@0x40B915",
        "native@0x40B927",
...
def test_checksum_producer_compiles_row216_direct_from_row137_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C703")
    assert operation.source_block_id == "native@0x40C6F7"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.rewrite_anchor_ea == 0x40C703
    assert rewrite.owner_anchor_ea == 0x40C6F7
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C703"
    assert payload["reference_order"] == 216
    assert payload["source_native_ea"] == 0x40BB4B
    assert payload["source_block_anchor_ea"] == 0x40C6F7
    assert payload["transfer_ea"] == 0x40C703
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BB4B,
        0x40BB5D,
        0x40BB63,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C703"
    ).depends_on == ("route:rhad-direct@0x40C6D8",)
    assert {
        "native@0x40B9A6",
        "native@0x40BB3A",
        "native@0x40BB51",
    ...
    assert plan.block(
        ...
        {0x40C6F7, 0x40C6F9, 0x40C6FB, 0x40C6FD, 0x40C703}
    )
    assert plan.block(
        "native@0x40C703"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C703})
...
def test_checksum_producer_compiles_row217_direct_from_row165_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C72E")
    assert operation.source_block_id == "native@0x40C722"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C722
    assert rewrite.rewrite_anchor_ea == 0x40C72E
    assert operation.edges[0].target_block_id == "native@0x40A607"
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 217
    assert payload["source_native_ea"] == 0x40BF62
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BF62,
        0x40BF74,
        0x40BF7A,
    ...
    ).depends_on == ("route:rhad-direct@0x40C703",)
    assert plan.block(
        "native@0x40C722"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C722, 0x40C724, 0x40C726, 0x40C728, 0x40C72E}
    )
    assert plan.block(
        "native@0x40C72E"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C72E})
...
def test_checksum_producer_compiles_row218_direct_from_row171_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C74F")
    assert operation.source_block_id == "native@0x40C749"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C749
    assert rewrite.rewrite_anchor_ea == 0x40C74F
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C74F"
    assert payload["reference_order"] == 218
    assert payload["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C00E
    assert payload["source_block_anchor_ea"] == 0x40C749
    assert payload["transfer_ea"] == 0x40C74F
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C00E,
        0x40C021,
        0x40C033,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW218_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW218_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C74F"
    ).depends_on == ("route:rhad-direct@0x40C72E",)
    assert {
        "native@0x40C00E",
        "native@0x40C027",
        "native@0x40C03B",
    ...
    assert plan.block(
        ...
        {0x40C749, 0x40C74B, 0x40C74D, 0x40C74F}
    )
    assert plan.block(
        "native@0x40C74F"
    ).stable_identity.exact_instruction_eas == frozenset({0x40C74F})
...
def test_checksum_producer_compiles_row219_direct_from_row174_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C76E")
    assert operation.source_block_id == "native@0x40C768"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C768
    assert rewrite.rewrite_anchor_ea == 0x40C76E
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C76E"
    assert payload["reference_order"] == 219
    assert payload["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C082
    assert payload["source_block_anchor_ea"] == 0x40C768
    assert payload["transfer_ea"] == 0x40C76E
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C082,
        0x40C094,
        0x40C768,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW219_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW219_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C76E"
    ).depends_on == ("route:rhad-direct@0x40C74F",)
    assert {
        "native@0x40C075",
        "native@0x40C088",
        "native@0x40C09A",
...
def test_checksum_producer_compiles_row220_direct_from_row179_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C793")
    assert operation.source_block_id == "native@0x40C787"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C787
    assert rewrite.rewrite_anchor_ea == 0x40C793
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C793"
    assert payload["reference_order"] == 220
    assert payload["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C12C
    assert payload["source_block_anchor_ea"] == 0x40C787
    assert payload["transfer_ea"] == 0x40C793
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C12C,
        0x40C13E,
        0x40C787,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW220_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW220_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C793"
    ).depends_on == ("route:rhad-direct@0x40C76E",)
    assert {
        "native@0x40C10A",
        "native@0x40C132",
        "native@0x40C144",
...
def test_checksum_producer_compiles_row221_direct_from_row185_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C7B8")
    assert operation.source_block_id == "native@0x40C7AC"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C7AC
    assert rewrite.rewrite_anchor_ea == 0x40C7B8
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C7B8"
    assert payload["reference_order"] == 221
    assert payload["reference_symbol"] == (
        "JumpInliner._fixup_jmp_and_possible_jcc"
    )
    assert payload["operation_variant"] == "simple_indirect_jump"
    assert payload["source_native_ea"] == 0x40C22F
    assert payload["source_block_anchor_ea"] == 0x40C7AC
    assert payload["transfer_ea"] == 0x40C7B8
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C22F,
        0x40C241,
        0x40C7AC,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW221_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW221_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "route:rhad-direct@0x40C7B8"
    ).depends_on == ("route:rhad-direct@0x40C793",)
    assert {
        "native@0x40C20C",
        "native@0x40C235",
        "native@0x40C247",
    ...
    assert plan.block(
        ...
        {0x40C7AC, 0x40C7AE, 0x40C7B0, 0x40C7B2, 0x40C7B8}
    )
    assert plan.block(
        "native@0x40C7B8"
...
def test_checksum_producer_compiles_row222_direct_from_row187_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C7E3")
    assert operation.source_block_id == "native@0x40C7D7"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C7D7
    assert rewrite.rewrite_anchor_ea == 0x40C7E3
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C7E3"
    assert payload["reference_order"] == 222
    assert payload["source_native_ea"] == 0x40C2D1
    assert payload["source_block_anchor_ea"] == 0x40C7D7
    assert payload["transfer_ea"] == 0x40C7E3
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C2D1,
        0x40C2E3,
        0x40C2E9,
    ...
    assert next(
        ...
        for candidate in batch.operations
        if candidate.operation_id == operation.operation_id
    ).depends_on == ("route:rhad-direct@0x40C7B8",)
    assert plan.block(
        "native@0x40C7D7"
    ).stable_identity.exact_instruction_eas == frozenset(
        {0x40C7D7, 0x40C7D9, 0x40C7DB, 0x40C7DD, 0x40C7E3}
...
def test_checksum_producer_compiles_row223_direct_from_row189_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C802")
    assert operation.source_block_id == "native@0x40C7FC"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C7FC
    assert rewrite.rewrite_anchor_ea == 0x40C802
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C802"
    assert payload["reference_order"] == 223
    assert payload["source_native_ea"] == 0x40C32F
    assert payload["source_block_anchor_ea"] == 0x40C7FC
    assert payload["transfer_ea"] == 0x40C802
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C32F,
        0x40C341,
        0x40C7FC,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW223_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW223_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        ...
        for candidate in batch.operations
        if candidate.operation_id == operation.operation_id
    ).depends_on == ("route:rhad-direct@0x40C7E3",)
    assert {
        "native@0x40C315",
        "native@0x40C335",
        "native@0x40C347",
...
def test_checksum_producer_compiles_row224_direct_from_row191_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C821")
    assert operation.source_block_id == "native@0x40C81B"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C81B
    assert rewrite.rewrite_anchor_ea == 0x40C821
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C821"
    assert payload["reference_order"] == 224
    assert payload["source_native_ea"] == 0x40C374
    assert payload["source_block_anchor_ea"] == 0x40C81B
    assert payload["transfer_ea"] == 0x40C821
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C374,
        0x40C386,
        0x40C81B,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW224_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW224_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        ...
        for candidate in batch.operations
        if candidate.operation_id == operation.operation_id
    ).depends_on == ("route:rhad-direct@0x40C802",)
    assert {
        "native@0x40C367",
        "native@0x40C37A",
        "native@0x40C38C",
...
def test_checksum_producer_compiles_row226_direct_from_row195_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C86B")
    assert operation.source_block_id == "native@0x40C85F"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C85F
    assert rewrite.rewrite_anchor_ea == 0x40C86B
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C86B"
    assert payload["reference_order"] == 226
    assert payload["source_native_ea"] == 0x40C404
    assert payload["source_block_anchor_ea"] == 0x40C85F
    assert payload["transfer_ea"] == 0x40C86B
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C404,
        0x40C416,
        0x40C41C,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW226_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW226_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        ...
        for candidate in batch.operations
        if candidate.operation_id == operation.operation_id
    ).depends_on == ("route:rhad-direct@0x40C840",)
    assert {
        "native@0x40C3F3",
        "native@0x40C3F9",
        "native@0x40C40A",
    ...
    assert plan.block(
        ...
        {0x40C85F, 0x40C861, 0x40C863, 0x40C865, 0x40C86B}
    )
    assert plan.block(
        "native@0x40C86B"
...
def test_checksum_producer_compiles_row227_direct_from_row207_source() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("route:rhad-direct@0x40C896")
    assert operation.source_block_id == "native@0x40C88A"
    rewrite = operation.direct_transfer_rewrite
    assert rewrite is not None
    assert rewrite.owner_anchor_ea == 0x40C88A
    assert rewrite.rewrite_anchor_ea == 0x40C896
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.DIRECT: "native@0x40A607",
    }
    payload = json.loads(
    ...
    assert payload["reference_operation_id"] == "rhad:route@0x40C896"
    assert payload["reference_order"] == 227
    assert payload["source_native_ea"] == 0x40C5D1
    assert payload["source_block_anchor_ea"] == 0x40C88A
    assert payload["transfer_ea"] == 0x40C896
    assert payload["owned_corridor_instruction_eas"] == [
        0x40C5D1,
        0x40C5E3,
        0x40C5E9,
    ...
    assert payload["imported_closure_block_ids"] == list(
        generated_reference.ROW227_TARGET_IMPORTED_BLOCK_IDS
    )
    assert generated_reference.ROW227_TARGET_IMPORTED_BLOCK_IDS == (
        "native@0x40A607",
        "native@0x40A615",
        "native@0x40A619",
        "native@0x40A680",
    ...
    assert next(
        ...
        for candidate in batch.operations
        if candidate.operation_id == operation.operation_id
    ).depends_on == ("route:rhad-direct@0x40C86B",)
    assert {
        "native@0x40C592",
        "native@0x40C5BD",
        "native@0x40C5D7",
    ...
    assert plan.block(
        ...
        {0x40C88A, 0x40C88C, 0x40C88E, 0x40C890, 0x40C896}
    )
    assert plan.block(
        "native@0x40C896"
...
def test_checksum_producer_compiles_row143_existing_dependency() -> None:
    ...
    operation = plan.operation("rhad:route@0x40BBF7")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BBE5
    assert normalization.unresolved_transfer_ea == 0x40BBF7
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40BBF9",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BFDA",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 143
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "slt"
    assert payload["condition_producer_ea"] == 0x40BBE5
    assert payload["comparison_constant"] == 0xE6B7ADA3
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BBDF,
        0x40BBE5,
    ...
    assert payload["boundary_exit_eas"] == [0x40BC13, 0x40C2FB, 0x40C527]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BBF7"
    ).depends_on == ("rhad:route@0x40BBDD",)
    assert {"native@0x40BBF9", "native@0x40BFDA"}.issubset(
        batch.native_body_entry_block_ids
    )


def test_checksum_producer_compiles_row144_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BC11")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.SGE
    assert normalization.condition_producer_ea == 0x40BBFF
    assert normalization.unresolved_transfer_ea == 0x40BC11
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40C2FB",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BC13",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 144
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "slt"
    assert payload["condition_producer_ea"] == 0x40BBFF
    assert payload["comparison_constant"] == 0xE41F690E
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BBF9,
        0x40BBFF,
    ...
    assert payload["boundary_exit_eas"] == [0x40A5F0, 0x40BC2D, 0x40C315]
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BC11"
    ).depends_on == ("rhad:route@0x40BBF7",)
    assert {"native@0x40BC13", "native@0x40C2FB"}.issubset(
        batch.native_body_entry_block_ids
    )


def test_checksum_producer_compiles_row145_existing_dependency() -> None:
    plan = build_rhad_generated_reference_plan(
        native_key=_native_key(), evidence_generation=7
    )
    batch = reference_batch_for_native_key(_native_key())
    ...
    operation = plan.operation("rhad:route@0x40BC2B")
    normalization = operation.computed_branch_normalization
    assert normalization is not None
    assert normalization.predicate_kind is PredicateKind.NE
    assert normalization.condition_producer_ea == 0x40BC19
    assert normalization.unresolved_transfer_ea == 0x40BC2B
    assert {edge.role: edge.target_block_id for edge in operation.edges} == {
        SemanticEdgeRole.CONDITIONAL_TAKEN: "native@0x40A5F0",
        SemanticEdgeRole.CONDITIONAL_FALLTHROUGH: "native@0x40BC2D",
    }
    payload = json.loads(
        operation.reference_route_authority.reference_route.reference_ledger_json
    )
    assert payload["reference_order"] == 145
    assert payload["operation_variant"] == "existing_conditional_plus_indirect"
    assert payload["observed_predicate_kind"] == "eq"
    assert payload["condition_producer_ea"] == 0x40BC19
    assert payload["comparison_constant"] == 0xDEF4B7E6
    assert payload["owned_corridor_instruction_eas"] == [
        0x40BC13,
        0x40BC19,
    ...
    assert next(
        candidate
        for candidate in batch.operations
        if candidate.operation_id == "rhad:route@0x40BC2B"
    ).depends_on == ("rhad:route@0x40BC11",)
    assert {"native@0x40BC2D", "native@0x40BC36"}.issubset(
        batch.native_body_entry_block_ids
    )
...
def test_row167_proof_artifact_is_required_and_content_addressed(
    tmp_path: Path,
) -> None:
    artifact = generated_reference.load_row167_table_proof_artifact()
    checked_in = json.loads(
        generated_reference.ROW167_TABLE_PROOF_PATH.read_text(encoding="utf-8")
    )
    ...
    assert artifact.proof_payload == checked_in["proof"]
    assert artifact.operation_id == "rhad:route@0x40BFA2"
    assert artifact.reference_order == 167

    with pytest.raises(RhadCompilerRejection, match="artifact is unavailable"):
        generated_reference.load_row167_table_proof_artifact(
            tmp_path / "missing-row167-proof.json"
        )

    mismatched_path = tmp_path / "mismatched-row167-proof.json"
    checked_in["content_identity"] = "sha256:" + ("0" * 64)
    mismatched_path.write_text(json.dumps(checked_in), encoding="utf-8")
    with pytest.raises(RhadCompilerRejection, match="content identity"):
        generated_reference.load_row167_table_proof_artifact(mismatched_path)
...
def test_stable_228_row_inventory_references_required_table_artifacts() -> None:
    ...
    row139 = next(
        operation for operation in operations if operation["reference_order"] == 139
    )
    row140 = next(
        operation for operation in operations if operation["reference_order"] == 140
    )
    row141 = next(
        operation for operation in operations if operation["reference_order"] == 141
    )
    batch = reference_batch_for_native_key(_native_key())
    assert batch is not None
    ...
    assert row135["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row135["current_generated_proof"] == {
        "accepted_commits": [
            "8f2b1c74b",
            "7d7439e7b",
            "414f450ec",
    ...
    assert row136["operation_id"] == "rhad:route@0x40B98A"
    assert row136["operation_variant"] == "existing_conditional_plus_indirect"
    assert row136["source_native_ea"] == 0x40B972
    assert row136["flag_producer_native_ea"] == 0x40B978
    assert row136["predicate_native_ea"] == 0x40B97E
    assert row136["source_block_anchor_ea"] == 0x40B980
    assert row136["transfer_native_ea"] == 0x40B98A
    assert row136["owned_corridor_instruction_eas"] == [
        0x40B972,
        0x40B978,
        0x40B97E,
        0x40B980,
    ...
    assert row136["semantic_targets"] == [
        {"ea": 0x40B98C, "role": "conditional_taken"},
        {"ea": 0x40C1F2, "role": "conditional_fallthrough"},
    ]
    assert row136["imported_closure_block_anchor_eas"] == [
        0x40B98C,
        0x40B99A,
        0x40B9A0,
        0x40B9A4,
    ...
    assert row136["target_rooted_closures"][0] == {
        "boundary_exit_eas": [0x40A5F0, 0x40B9A6],
        "expected_generated_block_anchor_eas": [
            0x40B98C,
            0x40B99A,
            0x40B9A0,
        ...
        "owned_native_block_entry_eas": [0x40B98C, 0x40B99A, 0x40B9A0],
        "root_ea": 0x40B98C,
        "status": "complete",
        "unavailable_exit_eas": [],
    }
    ...
    assert row136["current_generated_proof"] == {
    ...
    assert row138["current_generated_proof"] == {
        "accepted_commits": ["51acfc5db", "93e5f1bd5"],
        "status": "accepted_generated_c6",
    }
    assert row139["operation_id"] == "rhad:route@0x40BB8D"
    assert row139["operation_variant"] == "existing_conditional_plus_indirect"
    assert row139["source_native_ea"] == 0x40BB75
    assert row139["flag_producer_native_ea"] == 0x40BB7B
    assert row139["predicate_native_ea"] == 0x40BB81
    assert row139["source_block_anchor_ea"] == 0x40BB89
    assert row139["transfer_native_ea"] == 0x40BB8D
    assert row139["owned_corridor_instruction_eas"] == [
        0x40BB75,
        0x40BB7B,
        0x40BB81,
        0x40BB83,
    ...
    assert row139["semantic_targets"] == [
        {"ea": 0x40BB8F, "role": "conditional_taken"},
        {"ea": 0x40BF8C, "role": "conditional_fallthrough"},
    ]
    assert row139["imported_closure_block_anchor_eas"] == [
        0x40BB8F,
        0x40BB9D,
        0x40BBA3,
        0x40BBA7,
    ...
    assert row139["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40BBA9, 0x40C253],
            "expected_generated_block_anchor_eas": [
                0x40BB8F,
                0x40BB9D,
                0x40BBA3,
            ...
            "owned_native_block_entry_eas": [0x40BB8F, 0x40BB9D, 0x40BBA3],
            "root_ea": 0x40BB8F,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            "boundary_exit_eas": [0x40BFA4, 0x40C4DC],
            "expected_generated_block_anchor_eas": [0x40BF8C, 0x40BFA2],
            "owned_native_block_entry_eas": [0x40BF8C],
            "root_ea": 0x40BF8C,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
    ...
    assert row139["current_generated_proof"] == {
        "accepted_commits": ["add74b04b", "9af30f90e", "6a3cc3cff"],
        "status": "accepted_generated_c6",
    }
    assert row140["operation_id"] == "rhad:route@0x40BBA7"
    assert row140["operation_variant"] == "existing_conditional_plus_indirect"
    assert row140["source_native_ea"] == 0x40BB8F
    assert row140["flag_producer_native_ea"] == 0x40BB95
    assert row140["predicate_native_ea"] == 0x40BB9B
    assert row140["source_block_anchor_ea"] == 0x40BBA3
    assert row140["transfer_native_ea"] == 0x40BBA7
    assert row140["owned_corridor_instruction_eas"] == [
        0x40BB8F,
        0x40BB95,
        0x40BB9B,
        0x40BB9D,
    ...
    assert row140["semantic_targets"] == [
        {"ea": 0x40BBA9, "role": "conditional_taken"},
        {"ea": 0x40C253, "role": "conditional_fallthrough"},
    ]
    assert row140["imported_closure_block_anchor_eas"] == [
        0x40BBA9,
        0x40BBB7,
        0x40BBBD,
        0x40BBC1,
    ...
    assert row140["target_rooted_closures"] == [
        {
            "boundary_exit_eas": [0x40A5F0, 0x40BBC3],
            "expected_generated_block_anchor_eas": [
                0x40BBA9,
                0x40BBB7,
                0x40BBBD,
            ...
            "owned_native_block_entry_eas": [0x40BBA9, 0x40BBB7, 0x40BBBD],
            "root_ea": 0x40BBA9,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
        {
            ...
            "owned_native_block_entry_eas": [0x40C253, 0x40C261, 0x40C267],
            "root_ea": 0x40C253,
            "status": "complete",
            "unavailable_exit_eas": [],
        },
    ...
    assert row140["current_generated_proof"] == {
        "accepted_commits": ["53f88bce1", "7ca3edd13", "f20427242"],
        "status": "accepted_generated_c6",
    }
    assert row141["operation_id"] == "rhad:route@0x40BBC1"
    assert row141["operation_variant"] == "existing_conditional_plus_indirect"
    assert row141["source_native_ea"] == 0x40BBA9
    assert row141["flag_producer_native_ea"] == 0x40BBAF
    assert row141["predicate_native_ea"] == 0x40BBB5
    assert row141["source_block_anchor_ea"] == 0x40BBBD
    assert row141["transfer_native_ea"] == 0x40BBC1
    assert row141["owned_corridor_instruction_eas"] == [
        0x40BBA9,
        0x40BBAF,
        0x40BBB5,
        0x40BBB7,
    ...
    assert row141["semantic_targets"] == [
        {"ea": 0x40BBC3, "role": "conditional_taken"},
        {"ea": 0x40A5F0, "role": "conditional_fallthrough"},
    ]
    assert row141["imported_closure_block_anchor_eas"] == [
        0x40A5F0,
        0x40A605,
        0x40BBC3,
        0x40BBD6,
    ...
    assert row141["unavailable_closure_exit_eas"] == []
    assert row141["current_compiler_support"] == (
        "typed_existing_conditional_plus_indirect"
    )
    assert row141["current_generated_proof"] == {
        "accepted_commits": [
            "2a887b0de",
            "59bd6614a",
            "7ce81b4c5",
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert existing == {
        ...
        "compiled_operation_instances": 114,
        "vertically_proved_operations": 113,
        "accepted_receipt_operations": 113,
        "earliest_unproved_reference_order": 209,
        "earliest_unproved_operation_id": "rhad:route@0x40C613",
        "first_missing_typed_obligation": (
            "instantiate the accepted RhadExistingConditionalRoute vocabulary with exact "
            "row208 dependency and target-closure evidence before live mutation"
        ),
    }
    assert setcc == {
