...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 297
...
def test_indirect_jump_coverage_summary_matches_committed_row57_batch() -> None:
    summary = json.loads(
        (
            _REPO
            / "docs"
    ...
    assert summary["accepted_code_sha"] == ("36dea3978df7fe45e92e7c280c6fdec2607df4cc")
    ...
    assert simple == {
        ...
        "earliest_unproved_reference_order": 67,
        "earliest_unproved_operation_id": "rhad:route@0x40AE24",
        "first_missing_typed_obligation": (
    ...
    assert existing == {
        ...
        "earliest_unproved_reference_order": 58,
        "earliest_unproved_operation_id": "rhad:route@0x40AD36",
        "first_missing_typed_obligation": (
