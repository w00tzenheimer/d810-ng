...
def test_indirect_jump_coverage_summary_matches_committed_row23_batch() -> None:
    summary = json.loads(
        (
            _REPO
            / "docs"
    ...
    assert existing == {
        ...
        "earliest_unproved_reference_order": 26,
        "earliest_unproved_operation_id": "rhad:route@0x40A8CD",
