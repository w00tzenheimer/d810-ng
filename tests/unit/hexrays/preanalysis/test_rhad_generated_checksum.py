...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 357
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert summary["accepted_code_sha"] == ("fb6d0f1a0a748a45c066bc589f4a06ffcbd858cc")
    ...
    assert simple == {
        ...
        "earliest_unproved_reference_order": 73,
        "earliest_unproved_operation_id": "rhad:route@0x40AFDD",
        "first_missing_typed_obligation": (
    ...
    assert existing == {
        ...
        "earliest_unproved_reference_order": 72,
        "earliest_unproved_operation_id": "rhad:route@0x40AEFE",
        "first_missing_typed_obligation": (
