...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 443
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert summary["accepted_code_sha"] == ("411ba981e2cb25951484effa5af7b33e8282d1e8")
    ...
    assert len(accepted_operation_ids) == 110
    assert accepted_operation_ids[-1] == "route:rhad-direct@0x40B691"
    assert (
    ...
    assert simple == {
        ...
        "compiled_operation_instances": 35,
        "vertically_proved_operations": 35,
        "accepted_receipt_operations": 35,
        "earliest_unproved_reference_order": 115,
        "earliest_unproved_operation_id": "rhad:route@0x40B6B2",
        "first_missing_typed_obligation": (
    ...
    assert existing == {
        ...
        "compiled_operation_instances": 55,
        "vertically_proved_operations": 55,
        "accepted_receipt_operations": 55,
        "earliest_unproved_reference_order": 116,
        "earliest_unproved_operation_id": "rhad:route@0x40B6D4",
        "first_missing_typed_obligation": (
