...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 347
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert summary["accepted_code_sha"] == ("1e3f87d89896ed33ef5fe2f67fc0905d820ef9a0")
    ...
    assert simple == {
        ...
        "earliest_unproved_reference_order": 71,
        "earliest_unproved_operation_id": "rhad:route@0x40AEE4",
        "first_missing_typed_obligation": (
