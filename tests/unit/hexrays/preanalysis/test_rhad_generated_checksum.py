...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 335
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert summary["accepted_code_sha"] == ("b8ec38c4a45253b973ef26affc265591b42e3c14")
    ...
    assert existing == {
        ...
        "earliest_unproved_reference_order": 70,
        "earliest_unproved_operation_id": "rhad:route@0x40AEA3",
        "first_missing_typed_obligation": (
