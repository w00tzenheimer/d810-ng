...
def test_checksum_producer_compiles_row17_scaled_lookup_reference() -> None:
    ...
    assert len(IMPORTED_BLOCK_IDS) == 290
...
def test_stable_228_row_inventory_references_required_table_artifacts() -> None:
    ...
    assert row34["boundary_exit_eas"] == [0x40AA12, 0x40B0BC, 0x40B32C]
...
def test_indirect_jump_coverage_summary_matches_committed_row55_batch() -> None:
    summary = json.loads(
        (
            _REPO
            / "docs"
    ...
    assert summary["accepted_code_sha"] == ("ca4618829340fefb9121748dd45c3151b51fde6c")
    ...
    assert simple == {
        ...
        "earliest_unproved_reference_order": 57,
        "earliest_unproved_operation_id": "rhad:route@0x40AD1C",
        "first_missing_typed_obligation": (
    ...
    assert existing == {
        ...
        "earliest_unproved_reference_order": 56,
        "earliest_unproved_operation_id": "rhad:route@0x40ACF1",
        "first_missing_typed_obligation": (
