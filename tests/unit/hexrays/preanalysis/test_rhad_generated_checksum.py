...
def test_row152_inventory_owns_producer_and_both_target_fragments() -> None:
    ...
    assert row152["current_compiler_support"] == "unsupported_typed_shape"
...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert existing == {
        ...
        "compiled_operation_instances": 81,
        ...
        "first_missing_typed_obligation": (
            "add typed existing-conditional compiler evidence for row152 before "
            "live mutation"
        ),
    }
    assert setcc == {
