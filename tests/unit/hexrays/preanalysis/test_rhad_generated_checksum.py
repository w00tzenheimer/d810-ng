...
def test_indirect_jump_coverage_summary_matches_committed_acceptance_prefix() -> None:
    ...
    assert summary["accepted_code_sha"] == ("c5a8e93061c307b21821ab6dfdac6f32e1a06410")
    ...
    assert len(accepted_operation_ids) == 111
    assert accepted_operation_ids[-1] == "route:rhad-direct@0x40B6B2"
    assert (
    ...
    assert existing == {
        ...
        "first_missing_typed_obligation": (
            ...
            "CMAT_FINAL publication proof and persist the accepted diagnostic receipt"
        ),
    }
    assert setcc == {
