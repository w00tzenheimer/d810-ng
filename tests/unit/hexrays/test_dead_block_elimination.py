...
class TestDeadBlockEliminationPass:
    ...
    def test_multiple_dead_blocks_returns_all(self):
        ...
        blk10_dead = BlockSnapshot(
            ...
            flags=0,
            start_ea=0xA000,
            insn_snapshots=(insn10a, insn10b, insn10c),
        )
    ...
    def test_diamond_cfg_all_reachable(self):
        ...
        cfg = FlowGraph(
            blocks={0: blk0, 1: blk1, 2: blk2, 3: blk3}, entry_serial=0, func_ea=0x1000
        )
    ...
    def test_dead_block_no_instructions_returns_empty(self):
        ...
        blk2_dead = BlockSnapshot(
            ...
            flags=0,
            start_ea=0x2000,
            insn_snapshots=(insn_placeholder,),
        )
        cfg = FlowGraph(
            blocks={0: blk0, 1: blk1, 2: blk2_dead}, entry_serial=0, func_ea=0x1000
        )
    ...
    def test_dead_block_mixed_ea_filters_zeros(self):
        ...
        blk2_dead = BlockSnapshot(
            ...
            flags=0,
            start_ea=0x2000,
            insn_snapshots=(insn0a, insn2, insn0b),
        )
        # Sentinel block at highest serial
        blk3_sentinel = BlockSnapshot(
            serial=3,
    ...
    def test_last_dummy_block_protected_when_it_is_only_unreachable_block(self):
        ...
        cfg = FlowGraph(
            blocks={0: blk0, 1: blk1, 2: blk2_sentinel}, entry_serial=0, func_ea=0x1000
        )
