...
def test_manager_owns_config_v2_editor_and_exposes_structured_operations():
    ...
    expected = {
        ...
        "add_config_v2_passes": "add_passes",
...
def test_state_exposes_config_v2_transform_and_raw_document_facades():
    ...
    expected = {
        ...
        "add_config_v2_passes": "add_config_v2_passes",
...
def test_live_unflattener_passes_project_policy_to_family_selection():
    path = (
        _ROOT
    ...
    assert any(
        isinstance(argument, ast.Name) and argument.id == "rule_config"
