...
def create_sub_7ffd_scenario(conn: sqlite3.Connection) -> int:
    ...
    dag_edges = [
        ...
        _edge_row(2, 0x258ED455, 0x6465D165, "TRANSITION", 199, None, 23, "[199]"),
        _edge_row(3, 0x6465D165, 0x432DC789, "TRANSITION", 23, None, 62, "[23,24,32]"),
        _edge_row(4, 0x432DC789, 0x298372CC, "TRANSITION", 62, None, 205, "[62]"),
        _edge_row(
    ...
    rendered_lines = [
        ...
        },
        {
            ...
            "line_kind": "comment",
            "target_label": None,
            "text": "    // local-cfg: blk[131] -> blk[174]",
        },
        {
            "snapshot_id": 1,
            "variant_name": "semantic_reference_like",
        ...
        },
        {
            ...
            "indent_level": 2,
            "line_kind": "goto",
            "target_label": "STATE_16F7FF74",
            "text": "        goto STATE_16F7FF74;",
        },
    ]
