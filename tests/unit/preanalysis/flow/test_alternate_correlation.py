...
def _add_collapsed_diagnostic(
    ...
    *,
    ...
    StateCfgEdgeDiagnostic.insert(
        ...
        is_terminal_tail=1,
        original_state_const="0xAA",
        rewritten_state_const="0xBB",
        related_fact_ids="[]",
...
def test_correlates_byte5_alternate_edge() -> None:
    ...
    _add_edge(
        conn,
        edge_id=144,
        src="0x00000000385bbe2d",
        tgt="0x0000000063d54755",
        source_block=100,
        target_entry=21,
        ordered_path="[100]",
    )
    ...
    _add_edge(
        conn,
        edge_id=68,
        src="0x000000003873bc53",
        tgt="0x0000000010743c4c",
        source_block=101,
        target_entry=158,
...
def test_range_backed_sibling_no_outgoing_edge() -> None:
    ...
    assert correlations[0].reason == ("range_backed_sibling_no_outgoing_edge")
