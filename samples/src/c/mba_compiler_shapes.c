...
DEFINE_PAIR(uint8_t, mba_shape_catalogue_01, mba_truth_catalogue_01, (a ^ b) + ((uint64_t)2 * (a & b)), a + b)
DEFINE_PAIR(uint16_t, mba_shape_catalogue_02, mba_truth_catalogue_02, (a & b) + (a | b), a + b)
DEFINE_PAIR(uint32_t, mba_shape_catalogue_03, mba_truth_catalogue_03, (a + b) - ((uint64_t)2 * (a & b)), a ^ b)
DEFINE_PAIR(uint64_t, mba_shape_catalogue_04, mba_truth_catalogue_04, (a ^ b) - ((uint64_t)2 * (a & ~b)), b - a)
DEFINE_PAIR(uint8_t, mba_shape_catalogue_05, mba_truth_catalogue_05, (a & b) + (a ^ b), a | b)
DEFINE_PAIR(uint16_t, mba_shape_catalogue_06, mba_truth_catalogue_06, (a | b) - (a ^ b), a & b)
DEFINE_PAIR(uint32_t, mba_shape_catalogue_07, mba_truth_catalogue_07, (b ^ a) + ((uint64_t)2 * (b & a)), a + b)
DEFINE_PAIR(uint64_t, mba_shape_catalogue_08, mba_truth_catalogue_08, ((a ^ b) + ((uint64_t)2 * (a & b))) ^ c, (a + b) ^ c)
DEFINE_PAIR(uint8_t, mba_shape_catalogue_09, mba_truth_catalogue_09, ((a & b) + (a | b)) + c, a + b + c)
DEFINE_PAIR(uint16_t, mba_shape_catalogue_10, mba_truth_catalogue_10, (a ^ a) + ((b ^ c) + ((uint64_t)2 * (b & c))), b + c)

/* Equal-arity homogeneous reassociation; no operand represents a group. */
DEFINE_PAIR(uint32_t, mba_shape_reassociation_01, mba_truth_reassociation_01, ((a ^ b) + ((uint64_t)2 * (a & b))) + c, a + b + c)
DEFINE_PAIR(uint64_t, mba_shape_reassociation_02, mba_truth_reassociation_02, a + ((b ^ c) + ((uint64_t)2 * (b & c))), a + b + c)
DEFINE_PAIR(uint8_t, mba_shape_reassociation_03, mba_truth_reassociation_03, ((a & b) + (a ^ b)) + (c & d), (a | b) + (c & d))
DEFINE_PAIR(uint16_t, mba_shape_reassociation_04, mba_truth_reassociation_04, (a | b) + ((c + d) - ((uint64_t)2 * (c & d))), (a | b) + (c ^ d))
...
DEFINE_PAIR(uint8_t, mba_shape_reassociation_07, mba_truth_reassociation_07, (a ^ b) + ((uint64_t)2 * (a & b)) + c + d, a + b + c + d)
DEFINE_PAIR(uint16_t, mba_shape_reassociation_08, mba_truth_reassociation_08, a + b + ((c ^ d) + ((uint64_t)2 * (c & d))), a + b + c + d)

/* Short two-rule compositions. */
DEFINE_PAIR(uint32_t, mba_shape_degree2_01, mba_truth_degree2_01, ((a ^ b) + ((uint64_t)2 * (a & b))) + ((c ^ d) + ((uint64_t)2 * (c & d))), a + b + c + d)
DEFINE_PAIR(uint64_t, mba_shape_degree2_02, mba_truth_degree2_02, ((a & b) + (a | b)) ^ ((c & d) + (c | d)), (a + b) ^ (c + d))
DEFINE_PAIR(uint8_t, mba_shape_degree2_03, mba_truth_degree2_03, ((a + b) - ((uint64_t)2 * (a & b))) + ((c + d) - ((uint64_t)2 * (c & d))), (a ^ b) + (c ^ d))
DEFINE_PAIR(uint16_t, mba_shape_degree2_04, mba_truth_degree2_04, ((a ^ b) - ((uint64_t)2 * (a & ~b))) + ((c ^ d) - ((uint64_t)2 * (c & ~d))), (b - a) + (d - c))
...
DEFINE_PAIR(uint8_t, mba_shape_degree2_07, mba_truth_degree2_07, (((a ^ b) + ((uint64_t)2 * (a & b))) ^ c) + ((d ^ e) + ((uint64_t)2 * (d & e))), ((a + b) ^ c) + d + e)
DEFINE_PAIR(uint16_t, mba_shape_degree2_08, mba_truth_degree2_08, ((a & b) + (a | b)) + ((c ^ d) + ((uint64_t)2 * (c & d))), a + b + c + d)
DEFINE_PAIR(uint32_t, mba_shape_degree2_09, mba_truth_degree2_09, ((a + b) - ((uint64_t)2 * (a & b))) ^ ((c + d) - ((uint64_t)2 * (c & d))), (a ^ b) ^ (c ^ d))
DEFINE_PAIR(uint64_t, mba_shape_degree2_10, mba_truth_degree2_10, ((a ^ b) + ((uint64_t)2 * (a & b))) + ((c & d) + (c | d)), a + b + c + d)
