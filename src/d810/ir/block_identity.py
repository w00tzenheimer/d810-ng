...
class BlockHandleProvenance(Enum):
    ...
    # Transitional spelling for callers migrated in Task 8.  It denotes
    # owned creation, never anonymous observation.
    SYNTHETIC = "created_synthetic"
...
class MbaBlockHandle:
    ...
    def created_synthetic(
        ...
        *,
        ...
        """Create a handle backed by D810 plan/receipt ownership."""
        return cls(
            session_id=session_id,
            token=token,
            stable_identity=None,
