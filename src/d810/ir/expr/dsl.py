...
if TYPE_CHECKING:
    from d810.ir.expr.constraints import ConstraintExpr
...
class SymbolicExpression:
    ...
    def __ne__(self, other: SymbolicExpression) -> ConstraintExpr:  # type: ignore
        ...
        """
        from d810.ir.expr.constraints import ComparisonConstraint
...
class ConstraintPredicate:
    ...
    def equal_mops(var1: str, var2: str, ignore_size: bool = True):
        ...
        def check(ctx):
            ...
            if ignore_size:
                ...
                return mop_ops.equal_mops_ignore_size(ctx[var1].mop, ctx[var2].mop)
            else:
                return ctx[var1].mop == ctx[var2].mop
    ...
    def is_bnot(var1: str, var2: str):
        ...
        def check(ctx):
            ...
            if mop_ops is None:
                return False
            return mop_ops.equal_bnot_mop(ctx[var1].mop, ctx[var2].mop)
