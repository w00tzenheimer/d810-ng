...
class PredSetnzRule1(PatternMatchingRule):
    PATTERN = AstNode(
        m_setnz, AstNode(m_or, AstLeaf("x_0"), AstConstant("c_1")), AstConstant("c_2")
    )
...
class PredSetnzRule2(PatternMatchingRule):
    PATTERN = AstNode(
        m_setnz, AstNode(m_and, AstLeaf("x_0"), AstConstant("c_1")), AstConstant("c_2")
    )
    REPLACEMENT_PATTERN = AstNode(m_mov, AstConstant("val_1"))
...
class PredSetnzRule4(PatternMatchingRule):
    PATTERN = AstNode(
        m_setnz,
        AstNode(
            m_xor, AstNode(m_sub, AstConstant("cst_1"), AstLeaf("x_0")), AstLeaf("x_0")
        ),
        AstConstant("0", 0),
    )
    REPLACEMENT_PATTERN = AstNode(m_mov, AstConstant("val_1"))
...
class PredSetzRule1(PatternMatchingRule):
    PATTERN = AstNode(
        m_setz, AstNode(m_or, AstLeaf("x_0"), AstConstant("c_1")), AstConstant("c_2")
    )
...
class PredSetzRule2(PatternMatchingRule):
    PATTERN = AstNode(
        m_setz, AstNode(m_and, AstLeaf("x_0"), AstConstant("c_1")), AstConstant("c_2")
    )
    REPLACEMENT_PATTERN = AstNode(m_mov, AstConstant("val_0"))
...
class PredOdd1(PatternMatchingRule):
    PATTERN = AstNode(
        m_and,
        AstNode(
            m_mul, AstLeaf("x_0"), AstNode(m_sub, AstLeaf("x_0"), AstConstant("1", 1))
        ),
        AstConstant("1", 1),
    )
    REPLACEMENT_PATTERN = AstNode(m_mov, AstConstant("val_0"))
...
class PredOdd2(PatternMatchingRule):
    PATTERN = AstNode(
        m_and,
        AstNode(
            m_mul, AstLeaf("x_0"), AstNode(m_add, AstLeaf("x_0"), AstConstant("1", 1))
        ),
        AstConstant("1", 1),
    )
    REPLACEMENT_PATTERN = AstNode(m_mov, AstConstant("val_0"))
...
class Pred0Rule1(PatternMatchingRule):
    PATTERN = AstNode(m_and, AstLeaf("x_0"), AstNode(m_bnot, AstLeaf("x_0")))
    REPLACEMENT_PATTERN = AstNode(m_mov, AstConstant("val_0"))
...
class PredFFRule1(PatternMatchingRule):
    PATTERN = AstNode(m_or, AstLeaf("x_0"), AstNode(m_bnot, AstLeaf("x_0")))
