...
class Neg_HackersDelightRule_2(PatternMatchingRule):
    PATTERN = AstNode(m_bnot, AstNode(m_sub, AstLeaf("x_0"), AstConstant("1", 1)))
    REPLACEMENT_PATTERN = AstNode(m_neg, AstLeaf("x_0"))
...
class NegAdd_HackersDelightRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(m_neg, AstNode(m_add, AstLeaf("x_0"), AstLeaf("x_1")))
...
class NegOr_HackersDelightRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(m_neg, AstNode(m_or, AstLeaf("x_0"), AstLeaf("x_1")))
...
class NegXor_HackersDelightRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(m_neg, AstNode(m_xor, AstLeaf("x_0"), AstLeaf("x_1")))
