...
class AndBnot_HackersDelightRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(
        m_and, AstLeaf("x_0"), AstNode(m_bnot, AstLeaf("x_1"))
    )
...
class AndBnot_FactorRule_4(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(
        m_and, AstLeaf("x_1"), AstNode(m_bnot, AstLeaf("x_0"))
    )
...
class And1_MbaRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(m_and, AstLeaf("x_0"), AstConstant("val_1"))
