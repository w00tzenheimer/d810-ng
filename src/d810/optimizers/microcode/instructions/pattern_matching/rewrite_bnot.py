...
class Bnot_HackersDelightRule_1(PatternMatchingRule):
    PATTERN = AstNode(m_sub, AstNode(m_neg, AstLeaf("x_0")), AstConstant("1", 1))
...
class Bnot_FactorRule_2(PatternMatchingRule):
    PATTERN = AstNode(m_sub, AstConstant("minus_1"), AstLeaf("x_0"))
    REPLACEMENT_PATTERN = AstNode(m_bnot, AstLeaf("x_0"))
...
class BnotXor_Rule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(
        m_bnot, AstNode(m_xor, AstLeaf("x_0"), AstLeaf("x_1"))
    )
...
class BnotXor_FactorRule_1(PatternMatchingRule):
    PATTERN = AstNode(m_xor, AstLeaf("x_0"), AstNode(m_bnot, AstLeaf("x_1")))
...
class BnotAnd_FactorRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(
        m_bnot, AstNode(m_and, AstLeaf("x_0"), AstLeaf("x_1"))
    )
...
class BnotOr_FactorRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(m_bnot, AstNode(m_or, AstLeaf("x_0"), AstLeaf("x_1")))
...
class BnotAdd_MbaRule_1(PatternMatchingRule):
    ...
    REPLACEMENT_PATTERN = AstNode(
        m_bnot, AstNode(m_add, AstLeaf("x_0"), AstLeaf("x_1"))
    )
