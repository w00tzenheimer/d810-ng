"""Cleanup strategy for predecessor-armed side-effect state loops."""
...
logger = logging.getLogger("D810.strategy.side_effect_select_loop")
...
class SideEffectSelectLoopStrategy:
    """Engine strategy for predecessor-armed side-effect selector loops."""
