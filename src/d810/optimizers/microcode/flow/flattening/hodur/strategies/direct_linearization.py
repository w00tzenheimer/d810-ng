...
from d810.cfg.terminal_corridor_planning import (
    CarrierBucket,
    SuffixGroupDecision,
    classify_carrier_bucket as _classify_carrier_bucket,
    compute_suffix_group_decision as _compute_suffix_group_decision,
)
from d810.recon.flow.terminal_corridor_discovery import (
    ...
    SharedCorridorInfo,
    _mop_matches_stkoff_snapshot,
    _resolve_indirect_state_write_via_mba,
    classify_carrier_source as _classify_carrier_source,
    classify_carrier_source_rich as _classify_carrier_source_rich,
    discover_shared_corridor as _discover_shared_corridor,
