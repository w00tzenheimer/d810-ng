"""Hodur rule-host services used by runtime and post-pipeline hooks."""
...
class HodurRuleServices:
    """Host Hodur-specific services outside the IDA optimizer wrapper."""
    ...
    def _resolve_state_write_insn(
        ...
        if not self._STATE_WRITE_BINARY_OPS:
            HodurRuleServices._STATE_WRITE_BINARY_OPS = self._init_binary_ops()
