"""Reusable live-MBA services for state-machine unflattening rules.

These helpers sit outside ``engine/**`` because they intentionally touch live
Hex-Rays MBA objects.  Engine strategies consume snapshots and PatchPlans; rule
services are adapter/runtime support invoked after a family pass has selected a
profile-owned hook.
"""
...
unflat_logger = logging.getLogger("D810.unflat.state_machine", logging.DEBUG)
...
class StateMachineRuleServices(
    RuleHostProxy,
    TerminalByteMblKeepServices,
    LiveMbaTopologyServices,
    DiagnosticSnapshotServices,
    ...
    """Reusable service surface for live state-machine family hooks."""
