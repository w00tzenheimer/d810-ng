...
from d810.transforms.residual_alias_emission import emit_residual_alias_modifications
from d810.transforms.terminal_family_split import plan_terminal_family_splits
...
def emit_residual_alias_overrides(
    *,
    ...
    :func:`d810.analyses.control_flow.residual_alias_discovery.discover_residual_alias_overrides`
    by the optimizers caller) and modification emission to
    :func:`d810.transforms.residual_alias_emission.emit_residual_alias_modifications`.
