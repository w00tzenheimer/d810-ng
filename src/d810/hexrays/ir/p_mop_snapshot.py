...
This is the Python field-extraction implementation shared by both dispatch modes.
"""
...
class MopSnapshot:
    ...
    def from_mop(cls, mop: ida_hexrays.mop_t) -> MopSnapshot:
        ...
        """
        if isinstance(mop, ida_hexrays.mop_t) and hasattr(mop, "this"):
            if type(mop.this) is not swig_pointer_type():
        ...
        if needs_owned_clone and isinstance(mop, ida_hexrays.mop_t):
            try:
