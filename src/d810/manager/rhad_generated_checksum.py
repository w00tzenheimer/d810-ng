...
def load_row129_table_proof_artifact(
    path: Path = ROW129_TABLE_PROOF_PATH,
) -> RhadSetccIndexedTableProofArtifact:
    """Load the required canonical row-129 proof before any live mutation."""
    try:
        payload = json.loads(path.read_text(encoding="utf-8"))
    except (OSError, json.JSONDecodeError) as error:
        raise RhadCompilerRejection(
...
def load_row167_table_proof_artifact(
    path: Path = ROW167_TABLE_PROOF_PATH,
) -> RhadSetccIndexedTableProofArtifact:
    """Load the required canonical row-167 proof before any live mutation."""
    try:
        payload = json.loads(path.read_text(encoding="utf-8"))
    except (OSError, json.JSONDecodeError) as error:
        raise RhadCompilerRejection(
            f"Rhad row-167 table proof artifact is unavailable: {error}"
        ) from error
    return RhadSetccIndexedTableProofArtifact.from_mapping(payload)
...
ROW129_TARGET_IMPORTED_LAYOUT = (
    (0x40B898, 0x40B8A6, (0x40B898, 0x40B89E, 0x40B8A4)),
    (0x40B8A6, 0x40B8AC, (0x40B8A6,)),
    (0x40B8AC, 0x40B8B2, (0x40B8AC, 0x40B8AE, 0x40B8B0)),
    (0x40B8B0, 0x40B8B2, (0x40B8B0,)),
    (0x40BC61, 0x40BC6F, (0x40BC61, 0x40BC67, 0x40BC6D)),
    (0x40BC6F, 0x40BC75, (0x40BC6F,)),
    (0x40BC75, 0x40BC7B, (0x40BC75, 0x40BC77, 0x40BC79)),
    (0x40BC79, 0x40BC7B, (0x40BC79,)),
)
ROW130_TARGET_IMPORTED_LAYOUT = (
    (0x40B8B2, 0x40B8C0, (0x40B8B2, 0x40B8B8, 0x40B8BE)),
    (0x40B8C0, 0x40B8C6, (0x40B8C0,)),
    (0x40B8C6, 0x40B8CC, (0x40B8C6, 0x40B8C8, 0x40B8CA)),
    (0x40B8CA, 0x40B8CC, (0x40B8CA,)),
    (0x40BE98, 0x40BEA6, (0x40BE98, 0x40BE9E, 0x40BEA4)),
    (0x40BEA6, 0x40BEAC, (0x40BEA6,)),
    (0x40BEAC, 0x40BEB2, (0x40BEAC, 0x40BEAE, 0x40BEB0)),
    (0x40BEB0, 0x40BEB2, (0x40BEB0,)),
)
ROW131_TARGET_IMPORTED_LAYOUT = (
    (0x40B8CC, 0x40B8DA, (0x40B8CC, 0x40B8D2, 0x40B8D8)),
    (0x40B8DA, 0x40B8E0, (0x40B8DA,)),
    (0x40B8E0, 0x40B8E6, (0x40B8E0, 0x40B8E2, 0x40B8E4)),
    (0x40B8E4, 0x40B8E6, (0x40B8E4,)),
    (0x40C186, 0x40C194, (0x40C186, 0x40C18C, 0x40C192)),
    (0x40C194, 0x40C19A, (0x40C194,)),
    (0x40C19A, 0x40C1A0, (0x40C19A, 0x40C19C, 0x40C19E)),
    (0x40C19E, 0x40C1A0, (0x40C19E,)),
)
ROW132_TARGET_IMPORTED_LAYOUT = (
    ...
    (0x40B915, 0x40B927, (0x40B915, 0x40B91B, 0x40B921)),
    (0x40B927, 0x40B933, (0x40B927, 0x40B929, 0x40B92B, 0x40B931)),
    (0x40B931, 0x40B933, (0x40B931,)),
    (0x40C6B5, 0x40C6CC, (0x40C6B5, 0x40C6BA, 0x40C6C0, 0x40C6C6)),
...
ROW135_TARGET_IMPORTED_LAYOUT = (
    (0x40B972, 0x40B980, (0x40B972, 0x40B978, 0x40B97E)),
    (0x40B980, 0x40B986, (0x40B980,)),
    (0x40B986, 0x40B98C, (0x40B986, 0x40B988, 0x40B98A)),
    (0x40B98A, 0x40B98C, (0x40B98A,)),
    (0x40BEE7, 0x40BEF5, (0x40BEE7, 0x40BEED, 0x40BEF3)),
    (0x40BEF5, 0x40BEFB, (0x40BEF5,)),
    (0x40BEFB, 0x40BF01, (0x40BEFB, 0x40BEFD, 0x40BEFF)),
    (0x40BEFF, 0x40BF01, (0x40BEFF,)),
)
ROW136_TARGET_IMPORTED_LAYOUT = (
    (0x40B98C, 0x40B99A, (0x40B98C, 0x40B992, 0x40B998)),
    (0x40B99A, 0x40B9A0, (0x40B99A,)),
    (0x40B9A0, 0x40B9A6, (0x40B9A0, 0x40B9A2, 0x40B9A4)),
    (0x40B9A4, 0x40B9A6, (0x40B9A4,)),
    (0x40C1F2, 0x40C200, (0x40C1F2, 0x40C1F8, 0x40C1FE)),
    (0x40C200, 0x40C206, (0x40C200,)),
    (0x40C206, 0x40C20C, (0x40C206, 0x40C208, 0x40C20A)),
    (0x40C20A, 0x40C20C, (0x40C20A,)),
)
ROW137_TARGET_IMPORTED_LAYOUT = (
    (
        0x40B9A6,
        0x40BA5C,
        (
    ...
    (
        0x40BA5C,
        0x40BA78,
        (0x40BA5C, 0x40BA63, 0x40BA68, 0x40BA6D, 0x40BA6F, 0x40BA70, 0x40BA72),
    ),
    (0x40BA78, 0x40BA92, (0x40BA78, 0x40BA7F, 0x40BA84, 0x40BA89, 0x40BA8B, 0x40BA8C)),
    (
        0x40BA92,
        0x40BB3A,
        (
    ...
    (0x40BB3A, 0x40BB51, (0x40BB3A, 0x40BB3D, 0x40BB44, 0x40BB49, 0x40BB4B)),
    (0x40BB51, 0x40BB69, (0x40BB51, 0x40BB57, 0x40BB5D, 0x40BB63)),
    (0x40BB69, 0x40BB75, (0x40BB69, 0x40BB6B, 0x40BB6D, 0x40BB73)),
    (0x40BB73, 0x40BB75, (0x40BB73,)),
    (0x40C6DA, 0x40C6F7, (0x40C6DA, 0x40C6DF, 0x40C6E5, 0x40C6EB, 0x40C6F1)),
    (0x40C6F7, 0x40C705, (0x40C6F7, 0x40C6F9, 0x40C6FB, 0x40C6FD, 0x40C703)),
    (0x40C703, 0x40C705, (0x40C703,)),
)
ROW139_TARGET_IMPORTED_LAYOUT = (
    (0x40BB8F, 0x40BB9D, (0x40BB8F, 0x40BB95, 0x40BB9B)),
    (0x40BB9D, 0x40BBA3, (0x40BB9D,)),
    (0x40BBA3, 0x40BBA9, (0x40BBA3, 0x40BBA5, 0x40BBA7)),
    (0x40BBA7, 0x40BBA9, (0x40BBA7,)),
    (
        0x40BF8C,
        0x40BFA4,
        (0x40BF8C, 0x40BF8E, 0x40BF94, 0x40BF97, 0x40BF9A, 0x40BFA0, 0x40BFA2),
    ),
    (0x40BFA2, 0x40BFA4, (0x40BFA2,)),
)
ROW140_TARGET_IMPORTED_LAYOUT = (
    (0x40BBA9, 0x40BBB7, (0x40BBA9, 0x40BBAF, 0x40BBB5)),
    (0x40BBB7, 0x40BBBD, (0x40BBB7,)),
    (0x40BBBD, 0x40BBC3, (0x40BBBD, 0x40BBBF, 0x40BBC1)),
    (0x40BBC1, 0x40BBC3, (0x40BBC1,)),
    (0x40C253, 0x40C261, (0x40C253, 0x40C259, 0x40C25F)),
    (0x40C261, 0x40C267, (0x40C261,)),
    (0x40C267, 0x40C26D, (0x40C267, 0x40C269, 0x40C26B)),
    (0x40C26B, 0x40C26D, (0x40C26B,)),
)
...
ROW143_TARGET_IMPORTED_LAYOUT = (
    (0x40BBF9, 0x40BC07, (0x40BBF9, 0x40BBFF, 0x40BC05)),
    (0x40BC07, 0x40BC0D, (0x40BC07,)),
    (0x40BC0D, 0x40BC13, (0x40BC0D, 0x40BC0F, 0x40BC11)),
    (0x40BC11, 0x40BC13, (0x40BC11,)),
    (0x40BFDA, 0x40BFE8, (0x40BFDA, 0x40BFE0, 0x40BFE6)),
    (0x40BFE8, 0x40BFEE, (0x40BFE8,)),
    (0x40BFEE, 0x40BFF4, (0x40BFEE, 0x40BFF0, 0x40BFF2)),
    (0x40BFF2, 0x40BFF4, (0x40BFF2,)),
)
ROW144_TARGET_IMPORTED_LAYOUT = (
    (0x40BC13, 0x40BC21, (0x40BC13, 0x40BC19, 0x40BC1F)),
    (0x40BC21, 0x40BC27, (0x40BC21,)),
    (0x40BC27, 0x40BC2D, (0x40BC27, 0x40BC29, 0x40BC2B)),
    (0x40BC2B, 0x40BC2D, (0x40BC2B,)),
    (0x40C2FB, 0x40C309, (0x40C2FB, 0x40C301, 0x40C307)),
    (0x40C309, 0x40C30F, (0x40C309,)),
    (0x40C30F, 0x40C315, (0x40C30F, 0x40C311, 0x40C313)),
    (0x40C313, 0x40C315, (0x40C313,)),
)
ROW145_TARGET_IMPORTED_LAYOUT = (
...
ROW147_TARGET_IMPORTED_LAYOUT = (
    (0x40BC7B, 0x40BC89, (0x40BC7B, 0x40BC81, 0x40BC87)),
    (0x40BC89, 0x40BC8F, (0x40BC89,)),
    (0x40BC8F, 0x40BC95, (0x40BC8F, 0x40BC91, 0x40BC93)),
    (0x40BC93, 0x40BC95, (0x40BC93,)),
    (0x40C041, 0x40C04F, (0x40C041, 0x40C047, 0x40C04D)),
    (0x40C04F, 0x40C055, (0x40C04F,)),
    (0x40C055, 0x40C05B, (0x40C055, 0x40C057, 0x40C059)),
    (0x40C059, 0x40C05B, (0x40C059,)),
)
ROW148_TARGET_IMPORTED_LAYOUT = (
    (0x40BC95, 0x40BCA3, (0x40BC95, 0x40BC9B, 0x40BCA1)),
    (0x40BCA3, 0x40BCA9, (0x40BCA3,)),
    (0x40BCA9, 0x40BCAF, (0x40BCA9, 0x40BCAB, 0x40BCAD)),
    (0x40BCAD, 0x40BCAF, (0x40BCAD,)),
    (0x40C34D, 0x40C35B, (0x40C34D, 0x40C353, 0x40C359)),
    (0x40C35B, 0x40C361, (0x40C35B,)),
    (0x40C361, 0x40C367, (0x40C361, 0x40C363, 0x40C365)),
    (0x40C365, 0x40C367, (0x40C365,)),
)
ROW149_TARGET_IMPORTED_LAYOUT = (
    (
        0x40BCAF,
        0x40BCC5,
        (
    ...
    (0x40BCC2, 0x40BCC5, (0x40BCC2,)),
    (0x40BCC5, 0x40BCCB, (0x40BCC5, 0x40BCC7, 0x40BCC9)),
    (0x40BCC9, 0x40BCCB, (0x40BCC9,)),
)
ROW151_TARGET_IMPORTED_LAYOUT = (
    (0x40BCE5, 0x40BCF3, (0x40BCE5, 0x40BCEB, 0x40BCF1)),
    (0x40BCF3, 0x40BCF9, (0x40BCF3,)),
    (0x40BCF9, 0x40BCFF, (0x40BCF9, 0x40BCFB, 0x40BCFD)),
    (0x40BCFD, 0x40BCFF, (0x40BCFD,)),
    (0x40C0A0, 0x40C0AE, (0x40C0A0, 0x40C0A6, 0x40C0AC)),
    (0x40C0AE, 0x40C0B4, (0x40C0AE,)),
    (0x40C0B4, 0x40C0BA, (0x40C0B4, 0x40C0B6, 0x40C0B8)),
    (0x40C0B8, 0x40C0BA, (0x40C0B8,)),
)
ROW152_TARGET_IMPORTED_LAYOUT = (
    (0x40BCFF, 0x40BD0D, (0x40BCFF, 0x40BD05, 0x40BD0B)),
    (0x40BD0D, 0x40BD13, (0x40BD0D,)),
    (0x40BD13, 0x40BD19, (0x40BD13, 0x40BD15, 0x40BD17)),
    (0x40BD17, 0x40BD19, (0x40BD17,)),
    (0x40C392, 0x40C3A0, (0x40C392, 0x40C398, 0x40C39E)),
    (0x40C3A0, 0x40C3A6, (0x40C3A0,)),
    (0x40C3A6, 0x40C3AC, (0x40C3A6, 0x40C3A8, 0x40C3AA)),
    (0x40C3AA, 0x40C3AC, (0x40C3AA,)),
)
ROW153_TARGET_IMPORTED_LAYOUT = (
    (0x40BD19, 0x40BD25, (0x40BD19, 0x40BD20)),
    (
        0x40BD25,
        0x40BD4A,
        (
    ...
    (0x40BD47, 0x40BD4A, (0x40BD47,)),
    (0x40BD4A, 0x40BD50, (0x40BD4A, 0x40BD4C, 0x40BD4E)),
    (0x40BD4E, 0x40BD50, (0x40BD4E,)),
)
ROW155_TARGET_IMPORTED_LAYOUT = (
    (0x40BD6A, 0x40BD78, (0x40BD6A, 0x40BD70, 0x40BD76)),
    (0x40BD78, 0x40BD7E, (0x40BD78,)),
    (0x40BD7E, 0x40BD84, (0x40BD7E, 0x40BD80, 0x40BD82)),
    (0x40BD82, 0x40BD84, (0x40BD82,)),
    (0x40C3D9, 0x40C3E7, (0x40C3D9, 0x40C3DF, 0x40C3E5)),
    (0x40C3E7, 0x40C3ED, (0x40C3E7,)),
    (0x40C3ED, 0x40C3F3, (0x40C3ED, 0x40C3EF, 0x40C3F1)),
    (0x40C3F1, 0x40C3F3, (0x40C3F1,)),
)
ROW156_TARGET_IMPORTED_LAYOUT = (
    (
        0x40BD84,
        0x40BDBD,
        (
    ...
    (0x40BDBD, 0x40BDD5, (0x40BDBD, 0x40BDC0, 0x40BDC7, 0x40BDC8, 0x40BDCF, 0x40BDD0)),
    (
        0x40BDD5,
        0x40BE0A,
        (
    ...
    (0x40BE26, 0x40BE29, (0x40BE26,)),
    (0x40BE29, 0x40BE2F, (0x40BE29, 0x40BE2B, 0x40BE2D)),
    (0x40BE2D, 0x40BE2F, (0x40BE2D,)),
)
ROW158_TARGET_IMPORTED_LAYOUT = (
    (0x40BE49, 0x40BE57, (0x40BE49, 0x40BE4F, 0x40BE55)),
    (0x40BE57, 0x40BE5D, (0x40BE57,)),
    (0x40BE5D, 0x40BE63, (0x40BE5D, 0x40BE5F, 0x40BE61)),
    (0x40BE61, 0x40BE63, (0x40BE61,)),
    (0x40C42E, 0x40C43C, (0x40C42E, 0x40C434, 0x40C43A)),
    (0x40C43C, 0x40C442, (0x40C43C,)),
    (0x40C442, 0x40C448, (0x40C442, 0x40C444, 0x40C446)),
    (0x40C446, 0x40C448, (0x40C446,)),
)
ROW159_TARGET_IMPORTED_LAYOUT = (
    (
        0x40BE63,
        0x40BE92,
        (
    ...
    (0x40BE8F, 0x40BE92, (0x40BE8F,)),
    (0x40BE92, 0x40BE98, (0x40BE92, 0x40BE94, 0x40BE96)),
    (0x40BE96, 0x40BE98, (0x40BE96,)),
)
ROW161_TARGET_IMPORTED_LAYOUT = (
    (0x40BEB2, 0x40BEC0, (0x40BEB2, 0x40BEB8, 0x40BEBE)),
    ...
    (0x40C47C, 0x40C47E, (0x40C47C,)),
)
ROW162_TARGET_IMPORTED_LAYOUT = (
    (
        0x40BECC,
        0x40BEE1,
        (0x40BECC, 0x40BED0, 0x40BED6, 0x40BED8, 0x40BEDE),
    ),
    (0x40BEDE, 0x40BEE1, (0x40BEDE,)),
    (0x40BEE1, 0x40BEE7, (0x40BEE1, 0x40BEE3, 0x40BEE5)),
    (0x40BEE5, 0x40BEE7, (0x40BEE5,)),
)
ROW164_TARGET_IMPORTED_LAYOUT = (
    (0x40BF01, 0x40BF0F, (0x40BF01, 0x40BF07, 0x40BF0D)),
    (0x40BF0F, 0x40BF15, (0x40BF0F,)),
    (0x40BF15, 0x40BF1B, (0x40BF15, 0x40BF17, 0x40BF19)),
    (0x40BF19, 0x40BF1B, (0x40BF19,)),
    (0x40C49A, 0x40C4A8, (0x40C49A, 0x40C4A0, 0x40C4A6)),
    (0x40C4A8, 0x40C4AE, (0x40C4A8,)),
    (0x40C4AE, 0x40C4B4, (0x40C4AE, 0x40C4B0, 0x40C4B2)),
    (0x40C4B2, 0x40C4B4, (0x40C4B2,)),
)
ROW165_TARGET_IMPORTED_LAYOUT = (
    (0x40BF1B, 0x40BF2F, (0x40BF1B, 0x40BF1F, 0x40BF23, 0x40BF26, 0x40BF2A)),
    (0x40BF2F, 0x40BF43, (0x40BF2F, 0x40BF31, 0x40BF36, 0x40BF3E)),
    (
        0x40BF43,
        0x40BF68,
        (
    ...
    (0x40BF68, 0x40BF80, (0x40BF68, 0x40BF6E, 0x40BF74, 0x40BF7A)),
    (0x40BF80, 0x40BF8C, (0x40BF80, 0x40BF82, 0x40BF84, 0x40BF8A)),
    (0x40BF8A, 0x40BF8C, (0x40BF8A,)),
    (0x40C705, 0x40C722, (0x40C705, 0x40C70A, 0x40C710, 0x40C716, 0x40C71C)),
    (0x40C722, 0x40C730, (0x40C722, 0x40C724, 0x40C726, 0x40C728, 0x40C72E)),
    (0x40C72E, 0x40C730, (0x40C72E,)),
)
ROW167_TARGET_IMPORTED_LAYOUT = (
    (0x40BFA4, 0x40BFB2, (0x40BFA4, 0x40BFAA, 0x40BFB0)),
    (0x40BFB2, 0x40BFB8, (0x40BFB2,)),
    (0x40BFB8, 0x40BFBE, (0x40BFB8, 0x40BFBA, 0x40BFBC)),
    (0x40BFBC, 0x40BFBE, (0x40BFBC,)),
    (0x40C4DC, 0x40C4EA, (0x40C4DC, 0x40C4E2, 0x40C4E8)),
    (0x40C4EA, 0x40C4F0, (0x40C4EA,)),
    (0x40C4F0, 0x40C4F6, (0x40C4F0, 0x40C4F2, 0x40C4F4)),
    (0x40C4F4, 0x40C4F6, (0x40C4F4,)),
)
ROW168_TARGET_IMPORTED_LAYOUT = (
    (
        0x40BFBE,
        0x40BFD4,
        (
    ...
    (0x40BFD1, 0x40BFD4, (0x40BFD1,)),
    (0x40BFD4, 0x40BFDA, (0x40BFD4, 0x40BFD6, 0x40BFD8)),
    (0x40BFD8, 0x40BFDA, (0x40BFD8,)),
)
ROW170_TARGET_IMPORTED_LAYOUT = (
    (0x40BFF4, 0x40C002, (0x40BFF4, 0x40BFFA, 0x40C000)),
    (0x40C002, 0x40C008, (0x40C002,)),
    (0x40C008, 0x40C00E, (0x40C008, 0x40C00A, 0x40C00C)),
    (0x40C00C, 0x40C00E, (0x40C00C,)),
    (0x40C527, 0x40C535, (0x40C527, 0x40C52D, 0x40C533)),
    (0x40C535, 0x40C53B, (0x40C535,)),
    (0x40C53B, 0x40C541, (0x40C53B, 0x40C53D, 0x40C53F)),
    (0x40C53F, 0x40C541, (0x40C53F,)),
)
ROW171_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C00E,
        0x40C027,
        (0x40C00E, 0x40C010, 0x40C014, 0x40C018, 0x40C01C, 0x40C021),
    ),
    (0x40C027, 0x40C03B, (0x40C027, 0x40C02D, 0x40C033, 0x40C035)),
    (0x40C03B, 0x40C041, (0x40C03B, 0x40C03D, 0x40C03F)),
    (0x40C03F, 0x40C041, (0x40C03F,)),
    (0x40C730, 0x40C749, (0x40C730, 0x40C735, 0x40C73B, 0x40C741, 0x40C743)),
    (0x40C749, 0x40C751, (0x40C749, 0x40C74B, 0x40C74D, 0x40C74F)),
    (0x40C74F, 0x40C751, (0x40C74F,)),
)
ROW173_TARGET_IMPORTED_LAYOUT = (
    (0x40C05B, 0x40C069, (0x40C05B, 0x40C061, 0x40C067)),
    (0x40C069, 0x40C06F, (0x40C069,)),
    (0x40C06F, 0x40C075, (0x40C06F, 0x40C071, 0x40C073)),
    (0x40C073, 0x40C075, (0x40C073,)),
    (0x40C578, 0x40C586, (0x40C578, 0x40C57E, 0x40C584)),
    (0x40C586, 0x40C58C, (0x40C586,)),
    (0x40C58C, 0x40C592, (0x40C58C, 0x40C58E, 0x40C590)),
    (0x40C590, 0x40C592, (0x40C590,)),
)
ROW174_TARGET_IMPORTED_LAYOUT = (
    (0x40C075, 0x40C088, (0x40C075, 0x40C07A, 0x40C07E, 0x40C082)),
    (0x40C088, 0x40C09A, (0x40C088, 0x40C08E, 0x40C094)),
    (0x40C09A, 0x40C0A0, (0x40C09A, 0x40C09C, 0x40C09E)),
    (0x40C09E, 0x40C0A0, (0x40C09E,)),
    (0x40C751, 0x40C768, (0x40C751, 0x40C756, 0x40C75C, 0x40C762)),
    (0x40C768, 0x40C770, (0x40C768, 0x40C76A, 0x40C76C, 0x40C76E)),
    (0x40C76E, 0x40C770, (0x40C76E,)),
)
ROW176_TARGET_IMPORTED_LAYOUT = (
    (0x40C0BA, 0x40C0C8, (0x40C0BA, 0x40C0C0, 0x40C0C6)),
    (0x40C0C8, 0x40C0CE, (0x40C0C8,)),
    (0x40C0CE, 0x40C0D4, (0x40C0CE, 0x40C0D0, 0x40C0D2)),
    (0x40C0D2, 0x40C0D4, (0x40C0D2,)),
    (0x40C5FB, 0x40C609, (0x40C5FB, 0x40C601, 0x40C607)),
    (0x40C609, 0x40C60F, (0x40C609,)),
    (0x40C60F, 0x40C615, (0x40C60F, 0x40C611, 0x40C613)),
    (0x40C613, 0x40C615, (0x40C613,)),
)
ROW177_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C0D4,
        0x40C0EA,
        (
    ...
    (0x40C0E7, 0x40C0EA, (0x40C0E7,)),
    (0x40C0EA, 0x40C0F0, (0x40C0EA, 0x40C0EC, 0x40C0EE)),
    (0x40C0EE, 0x40C0F0, (0x40C0EE,)),
)
ROW179_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C10A,
        0x40C132,
        (
    ...
    (0x40C132, 0x40C144, (0x40C132, 0x40C138, 0x40C13E)),
    (0x40C144, 0x40C150, (0x40C144, 0x40C146, 0x40C148, 0x40C14E)),
    (0x40C14E, 0x40C150, (0x40C14E,)),
    (0x40C770, 0x40C787, (0x40C770, 0x40C775, 0x40C77B, 0x40C781)),
    (
        0x40C787,
        0x40C795,
        (0x40C787, 0x40C789, 0x40C78B, 0x40C78D, 0x40C793),
    ),
    (0x40C793, 0x40C795, (0x40C793,)),
)
ROW181_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C16A,
        0x40C180,
        (
    ...
    (0x40C17D, 0x40C180, (0x40C17D,)),
    (0x40C180, 0x40C186, (0x40C180, 0x40C182, 0x40C184)),
    (0x40C184, 0x40C186, (0x40C184,)),
)
ROW183_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C1A0,
        0x40C1C0,
        (
    ...
    (0x40C1F0, 0x40C1F2, (0x40C1F0,)),
)
ROW185_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C20C,
        0x40C235,
        (
    ...
    (0x40C235, 0x40C247, (0x40C235, 0x40C23B, 0x40C241)),
    (0x40C247, 0x40C253, (0x40C247, 0x40C249, 0x40C24B, 0x40C251)),
    (0x40C251, 0x40C253, (0x40C251,)),
    (0x40C795, 0x40C7AC, (0x40C795, 0x40C79A, 0x40C7A0, 0x40C7A6)),
    (
        0x40C7AC,
        0x40C7BA,
        (0x40C7AC, 0x40C7AE, 0x40C7B0, 0x40C7B2, 0x40C7B8),
    ),
    (0x40C7B8, 0x40C7BA, (0x40C7B8,)),
)
ROW187_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C26D,
        0x40C2AF,
        (
    ...
    (0x40C2AF, 0x40C2C3, (0x40C2AF, 0x40C2B5, 0x40C2BA, 0x40C2BC, 0x40C2BD, 0x40C2BE)),
    (0x40C2C3, 0x40C2D7, (0x40C2C3, 0x40C2C6, 0x40C2CB, 0x40C2CF, 0x40C2D1)),
    (0x40C2D7, 0x40C2EF, (0x40C2D7, 0x40C2DD, 0x40C2E3, 0x40C2E9)),
    (0x40C2EF, 0x40C2FB, (0x40C2EF, 0x40C2F1, 0x40C2F3, 0x40C2F9)),
    (0x40C2F9, 0x40C2FB, (0x40C2F9,)),
    (0x40C7BA, 0x40C7D7, (0x40C7BA, 0x40C7BF, 0x40C7C5, 0x40C7CB, 0x40C7D1)),
    (0x40C7D7, 0x40C7E5, (0x40C7D7, 0x40C7D9, 0x40C7DB, 0x40C7DD, 0x40C7E3)),
    (0x40C7E3, 0x40C7E5, (0x40C7E3,)),
)
ROW189_TARGET_IMPORTED_LAYOUT = (
    (0x40C315, 0x40C335, (0x40C315, 0x40C31F, 0x40C322, 0x40C328, 0x40C32D, 0x40C32F)),
    (0x40C335, 0x40C347, (0x40C335, 0x40C33B, 0x40C341)),
    (0x40C347, 0x40C34D, (0x40C347, 0x40C349, 0x40C34B)),
    (0x40C34B, 0x40C34D, (0x40C34B,)),
    (0x40C7E5, 0x40C7FC, (0x40C7E5, 0x40C7EA, 0x40C7F0, 0x40C7F6)),
    (0x40C7FC, 0x40C804, (0x40C7FC, 0x40C7FE, 0x40C800, 0x40C802)),
    (0x40C802, 0x40C804, (0x40C802,)),
)
ROW191_TARGET_IMPORTED_LAYOUT = (
    (0x40C367, 0x40C37A, (0x40C367, 0x40C36F, 0x40C374)),
    (0x40C37A, 0x40C38C, (0x40C37A, 0x40C380, 0x40C386)),
    (0x40C38C, 0x40C392, (0x40C38C, 0x40C38E, 0x40C390)),
    (0x40C390, 0x40C392, (0x40C390,)),
    (0x40C804, 0x40C81B, (0x40C804, 0x40C809, 0x40C80F, 0x40C815)),
    (0x40C81B, 0x40C823, (0x40C81B, 0x40C81D, 0x40C81F, 0x40C821)),
    (0x40C821, 0x40C823, (0x40C821,)),
)
ROW193_TARGET_IMPORTED_LAYOUT = (
    (0x40C3AC, 0x40C3C1, (0x40C3AC, 0x40C3B0, 0x40C3B5, 0x40C3B9, 0x40C3BB)),
    (0x40C3C1, 0x40C3D3, (0x40C3C1, 0x40C3C7, 0x40C3CD)),
    (0x40C3D3, 0x40C3D9, (0x40C3D3, 0x40C3D5, 0x40C3D7)),
    (0x40C3D7, 0x40C3D9, (0x40C3D7,)),
    (0x40C823, 0x40C83A, (0x40C823, 0x40C828, 0x40C82E, 0x40C834)),
    (0x40C83A, 0x40C842, (0x40C83A, 0x40C83C, 0x40C83E, 0x40C840)),
    (0x40C840, 0x40C842, (0x40C840,)),
)
ROW195_TARGET_IMPORTED_LAYOUT = (
    (0x40C3F3, 0x40C3F9, (0x40C3F3,)),
    (0x40C3F9, 0x40C40A, (0x40C3F9, 0x40C3FE, 0x40C402, 0x40C404)),
    (0x40C40A, 0x40C422, (0x40C40A, 0x40C410, 0x40C416, 0x40C41C)),
    (0x40C422, 0x40C42E, (0x40C422, 0x40C424, 0x40C426, 0x40C42C)),
    (0x40C42C, 0x40C42E, (0x40C42C,)),
    (0x40C842, 0x40C85F, (0x40C842, 0x40C847, 0x40C84D, 0x40C853, 0x40C859)),
...
ROW197_TARGET_IMPORTED_LAYOUT = (
    ...
    (0x40C45E, 0x40C464, (0x40C45E, 0x40C460, 0x40C462)),
    (0x40C462, 0x40C464, (0x40C462,)),
)
ROW198_SOURCE_IMPORTED_LAYOUT = (
    (0x40C45B, 0x40C45E, (0x40C45B,)),
)
ROW198_SOURCE_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW198_SOURCE_IMPORTED_LAYOUT
)
ROW199_TARGET_IMPORTED_LAYOUT = (
    (0x40C47E, 0x40C494, (0x40C47E, 0x40C483, 0x40C489, 0x40C48B, 0x40C491)),
    (0x40C494, 0x40C49A, (0x40C494, 0x40C496, 0x40C498)),
    (0x40C498, 0x40C49A, (0x40C498,)),
)
ROW199_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW199_TARGET_IMPORTED_LAYOUT
)
ROW200_SOURCE_IMPORTED_LAYOUT = (
    (0x40C491, 0x40C494, (0x40C491,)),
)
ROW200_SOURCE_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW200_SOURCE_IMPORTED_LAYOUT
)
ROW201_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C4B4,
        0x40C4C6,
        (0x40C4B4, 0x40C4B9, 0x40C4BE, 0x40C4C3),
    ),
    (0x40C4C3, 0x40C4C6, (0x40C4C3,)),
    (0x40C4C6, 0x40C4D4, (0x40C4C6, 0x40C4CC, 0x40C4D2)),
    (0x40C4D4, 0x40C4D6, (0x40C4D4,)),
    (0x40C4D6, 0x40C4DC, (0x40C4D6, 0x40C4D8, 0x40C4DA)),
    (0x40C4DA, 0x40C4DC, (0x40C4DA,)),
)
ROW201_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW201_TARGET_IMPORTED_LAYOUT
)
ROW203_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C4F6,
        0x40C521,
        (
    ...
    (0x40C525, 0x40C527, (0x40C525,)),
)
ROW203_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW203_TARGET_IMPORTED_LAYOUT
)
ROW204_SOURCE_IMPORTED_LAYOUT = (
    (0x40C51E, 0x40C521, (0x40C51E,)),
)
ROW204_SOURCE_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW204_SOURCE_IMPORTED_LAYOUT
)
ROW205_TARGET_IMPORTED_LAYOUT = (
    (0x40C541, 0x40C54D, (0x40C541, 0x40C548)),
    (
        0x40C54D,
        0x40C572,
        (
    ...
    (0x40C56F, 0x40C572, (0x40C56F,)),
    (0x40C572, 0x40C578, (0x40C572, 0x40C574, 0x40C576)),
    (0x40C576, 0x40C578, (0x40C576,)),
)
ROW205_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW205_TARGET_IMPORTED_LAYOUT
)
ROW206_SOURCE_IMPORTED_BLOCK_IDS = ("native@0x40C56F",)
ROW207_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C592,
        0x40C5BD,
        (
    ...
    (0x40C5BD, 0x40C5D7, (0x40C5BD, 0x40C5C3, 0x40C5C8, 0x40C5CA, 0x40C5CF, 0x40C5D1)),
    (0x40C5D7, 0x40C5EF, (0x40C5D7, 0x40C5DD, 0x40C5E3, 0x40C5E9)),
    (0x40C5EF, 0x40C5FB, (0x40C5EF, 0x40C5F1, 0x40C5F3, 0x40C5F9)),
    (0x40C5F9, 0x40C5FB, (0x40C5F9,)),
    (0x40C86D, 0x40C88A, (0x40C86D, 0x40C872, 0x40C878, 0x40C87E, 0x40C884)),
    (0x40C88A, 0x40C898, (0x40C88A, 0x40C88C, 0x40C88E, 0x40C890, 0x40C896)),
    (0x40C896, 0x40C898, (0x40C896,)),
)
ROW207_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW207_TARGET_IMPORTED_LAYOUT
)
ROW209_TARGET_IMPORTED_LAYOUT = (
    (0x40C615, 0x40C623, (0x40C615, 0x40C61B, 0x40C621)),
    (0x40C623, 0x40C629, (0x40C623,)),
    (0x40C629, 0x40C62F, (0x40C629, 0x40C62B, 0x40C62D)),
    (0x40C62D, 0x40C62F, (0x40C62D,)),
    (0x40C64B, 0x40C659, (0x40C64B, 0x40C651, 0x40C657)),
    (0x40C659, 0x40C65F, (0x40C659,)),
    (0x40C65F, 0x40C665, (0x40C65F, 0x40C661, 0x40C663)),
    (0x40C663, 0x40C665, (0x40C663,)),
)
ROW209_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW209_TARGET_IMPORTED_LAYOUT
)
...
ROW210_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW210_TARGET_IMPORTED_LAYOUT
)
ROW212_TARGET_IMPORTED_LAYOUT = (
    (
        0x40C665,
        0x40C690,
        (
    ...
    (0x40C68D, 0x40C690, (0x40C68D,)),
    (0x40C690, 0x40C696, (0x40C690, 0x40C692, 0x40C694)),
    (0x40C694, 0x40C696, (0x40C694,)),
)
ROW212_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW212_TARGET_IMPORTED_LAYOUT
)
ROW214_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW216_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW217_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW218_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW219_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW220_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW221_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW222_TARGET_IMPORTED_BLOCK_IDS = ROW221_TARGET_IMPORTED_BLOCK_IDS
ROW223_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW224_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW225_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW226_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
ROW227_TARGET_IMPORTED_BLOCK_IDS = (
    "native@0x40A607",
    "native@0x40A615",
    "native@0x40A619",
    "native@0x40A680",
...
IMPORTED_LAYOUT = (
    ...
    + ROW193_TARGET_IMPORTED_LAYOUT
    + ROW195_TARGET_IMPORTED_LAYOUT
    + ROW197_TARGET_IMPORTED_LAYOUT[:1]
    + ROW198_SOURCE_IMPORTED_LAYOUT
    + ROW197_TARGET_IMPORTED_LAYOUT[1:]
    + ROW199_TARGET_IMPORTED_LAYOUT[:1]
    + ROW200_SOURCE_IMPORTED_LAYOUT
    + ROW199_TARGET_IMPORTED_LAYOUT[1:]
    + ROW201_TARGET_IMPORTED_LAYOUT
    + ROW203_TARGET_IMPORTED_LAYOUT[:1]
    + ROW204_SOURCE_IMPORTED_LAYOUT
    + ROW203_TARGET_IMPORTED_LAYOUT[1:]
    + ROW205_TARGET_IMPORTED_LAYOUT
    + ROW207_TARGET_IMPORTED_LAYOUT
...
ROW129_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW129_TARGET_IMPORTED_LAYOUT
)
ROW130_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW130_TARGET_IMPORTED_LAYOUT
)
ROW131_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW131_TARGET_IMPORTED_LAYOUT
)
ROW132_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
...
ROW135_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW135_TARGET_IMPORTED_LAYOUT
)
ROW136_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW136_TARGET_IMPORTED_LAYOUT
)
ROW137_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW137_TARGET_IMPORTED_LAYOUT
)
ROW139_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW139_TARGET_IMPORTED_LAYOUT
)
ROW140_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW140_TARGET_IMPORTED_LAYOUT
)
ROW141_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW141_TARGET_IMPORTED_LAYOUT
)
ROW143_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW143_TARGET_IMPORTED_LAYOUT
)
ROW144_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW144_TARGET_IMPORTED_LAYOUT
)
ROW145_TARGET_IMPORTED_BLOCK_IDS = (
    *(
        f"native@0x{start_ea:X}"
        for start_ea, _end_ea, _exact_eas in ROW145_TARGET_IMPORTED_LAYOUT
    ),
)
ROW147_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW147_TARGET_IMPORTED_LAYOUT
)
ROW148_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW148_TARGET_IMPORTED_LAYOUT
)
ROW149_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW149_TARGET_IMPORTED_LAYOUT
)
ROW151_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW151_TARGET_IMPORTED_LAYOUT
)
ROW152_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW152_TARGET_IMPORTED_LAYOUT
)
ROW153_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW153_TARGET_IMPORTED_LAYOUT
)
ROW155_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW155_TARGET_IMPORTED_LAYOUT
)
ROW156_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW156_TARGET_IMPORTED_LAYOUT
)
ROW158_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW158_TARGET_IMPORTED_LAYOUT
)
ROW159_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW159_TARGET_IMPORTED_LAYOUT
)
ROW161_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW161_TARGET_IMPORTED_LAYOUT
)
ROW162_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW162_TARGET_IMPORTED_LAYOUT
)
ROW164_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW164_TARGET_IMPORTED_LAYOUT
)
ROW165_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW165_TARGET_IMPORTED_LAYOUT
)
ROW167_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW167_TARGET_IMPORTED_LAYOUT
)
ROW168_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW168_TARGET_IMPORTED_LAYOUT
)
ROW170_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW170_TARGET_IMPORTED_LAYOUT
)
ROW171_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW171_TARGET_IMPORTED_LAYOUT
)
ROW173_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW173_TARGET_IMPORTED_LAYOUT
)
ROW174_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW174_TARGET_IMPORTED_LAYOUT
)
ROW176_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW176_TARGET_IMPORTED_LAYOUT
)
ROW177_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW177_TARGET_IMPORTED_LAYOUT
)
ROW179_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW179_TARGET_IMPORTED_LAYOUT
)
ROW181_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW181_TARGET_IMPORTED_LAYOUT
)
ROW183_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW183_TARGET_IMPORTED_LAYOUT
)
ROW185_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW185_TARGET_IMPORTED_LAYOUT
)
ROW187_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW187_TARGET_IMPORTED_LAYOUT
)
ROW189_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW189_TARGET_IMPORTED_LAYOUT
)
ROW191_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW191_TARGET_IMPORTED_LAYOUT
)
ROW193_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
    for start_ea, _end_ea, _exact_eas in ROW193_TARGET_IMPORTED_LAYOUT
)
ROW195_TARGET_IMPORTED_BLOCK_IDS = tuple(
    f"native@0x{start_ea:X}"
...
_ROW128_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40B879",
    reference_order=128,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40B810",
    source_value_block_id="native@0x40B810",
    source_native_ea=0x40B83F,
    source_block_anchor_ea=0x40B810,
    transfer_ea=0x40B879,
    predicate_anchor_ea=0x40B872,
    normalization_start_ea=0x40B872,
    condition_producer_ea=0x40B864,
    conditional_select_ea=0x40B872,
    selected_value_block_id="native@0x40B872",
    join_block_id="native@0x40B875",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40B864",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW127_EXISTING_ROUTE.operation_id,),
)

_ROW129_SETCC_TABLE_PROOF_ARTIFACT = load_row129_table_proof_artifact()

_ROW129_SETCC_ROUTE = RhadSetccIndexedTableRoute(
    operation_id="rhad:route@0x40B896",
    reference_order=129,
    operation_variant=RhadOperationVariant.SETCC_INDEXED_TABLE,
    reference_symbol="JumpInliner._fixup_index_access",
    source_block_id="native@0x40B880",
    source_native_ea=0x40B880,
    source_block_anchor_ea=0x40B880,
    transfer_ea=0x40B896,
    condition_producer_ea=0x40B882,
    predicate_anchor_ea=0x40B888,
    predicate_kind=PredicateKind.SLT,
    fallthrough_delivery=FragmentSetccFallthroughDelivery.PLANNED_HELPER,
    true_target_block_id="native@0x40B898",
    false_target_block_id="native@0x40BC61",
    true_target_ea=0x40B898,
    false_target_ea=0x40BC61,
    table_proof_artifact=_ROW129_SETCC_TABLE_PROOF_ARTIFACT,
    owned_corridor_instruction_eas=(
        0x40B880,
        0x40B882,
        0x40B888,
    ...
    imported_closure_block_ids=ROW129_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40BE98, 0x40C041),
    flag_corridor_id="flags-intact@0x40B882",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW128_CMOV_ROUTE.operation_id,),
)

_ROW130_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40B8B0",
    reference_order=130,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40B898",
    selected_value_block_id="native@0x40B8A6",
    join_block_id="native@0x40B8AC",
    source_native_ea=0x40B898,
    source_block_anchor_ea=0x40B8A6,
    join_ea=0x40B8AC,
    transfer_ea=0x40B8B0,
    condition_producer_ea=0x40B89E,
    predicate_anchor_ea=0x40B8A4,
    normalization_start_ea=0x40B8A4,
    source_branch_ea=0x40B8A4,
    selected_value_ea=0x40B8A6,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B8B2",
    false_target_block_id="native@0x40BE98",
    true_target_ea=0x40B8B2,
    false_target_ea=0x40BE98,
    comparison_constant=0xABB95547,
    owned_corridor_instruction_eas=(
        0x40B898,
        0x40B89E,
        0x40B8A4,
    ...
    imported_closure_block_ids=ROW130_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40B8CC, 0x40BEB2, 0x40C186, 0x40C464),
    flag_corridor_id="flags-intact@0x40B89E",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW129_SETCC_ROUTE.operation_id,),
)

_ROW131_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40B8CA",
    reference_order=131,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40B8B2",
    selected_value_block_id="native@0x40B8C0",
    join_block_id="native@0x40B8C6",
    source_native_ea=0x40B8B2,
    source_block_anchor_ea=0x40B8C0,
    join_ea=0x40B8C6,
    transfer_ea=0x40B8CA,
    condition_producer_ea=0x40B8B8,
    predicate_anchor_ea=0x40B8BE,
    normalization_start_ea=0x40B8BE,
    source_branch_ea=0x40B8BE,
    selected_value_ea=0x40B8C0,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B8CC",
    false_target_block_id="native@0x40C186",
    true_target_ea=0x40B8CC,
    false_target_ea=0x40C186,
    comparison_constant=0xA7933EA0,
    owned_corridor_instruction_eas=(
        0x40B8B2,
        0x40B8B8,
        0x40B8BE,
    ...
    imported_closure_block_ids=ROW131_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40B8E6),
    flag_corridor_id="flags-intact@0x40B8B8",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW130_EXISTING_ROUTE.operation_id,),
)

_ROW132_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40B8E4",
    reference_order=132,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40B8CC",
    selected_value_block_id="native@0x40B8DA",
    join_block_id="native@0x40B8E0",
    source_native_ea=0x40B8CC,
    source_block_anchor_ea=0x40B8DA,
    join_ea=0x40B8E0,
    transfer_ea=0x40B8E4,
    condition_producer_ea=0x40B8D2,
    predicate_anchor_ea=0x40B8D8,
    normalization_start_ea=0x40B8D8,
    source_branch_ea=0x40B8D8,
    selected_value_ea=0x40B8DA,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40B8E6",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40B8E6,
    false_target_ea=0x40A5F0,
    comparison_constant=0xA5A94B86,
    owned_corridor_instruction_eas=(
        0x40B8CC,
    ...
    imported_closure_block_ids=ROW132_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40B8D2",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW131_EXISTING_ROUTE.operation_id,),
)

_ROW133_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40B931",
    reference_operation_id="rhad:route@0x40B931",
    reference_order=133,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40B927",
    source_native_ea=0x40B915,
    transfer_ea=0x40B931,
    owner_anchor_ea=0x40B927,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40B915,
        0x40B927,
...
_ROW135_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40B970",
    reference_order=135,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40B958",
    selected_value_block_id="native@0x40B966",
    join_block_id="native@0x40B96C",
    source_native_ea=0x40B958,
    source_block_anchor_ea=0x40B96C,
    join_ea=0x40B96C,
    transfer_ea=0x40B970,
    condition_producer_ea=0x40B95E,
    predicate_anchor_ea=0x40B964,
    normalization_start_ea=0x40B964,
    source_branch_ea=0x40B964,
    selected_value_ea=0x40B966,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B972",
    false_target_block_id="native@0x40BEE7",
    true_target_ea=0x40B972,
    false_target_ea=0x40BEE7,
    comparison_constant=0xF32B2D3A,
    owned_corridor_instruction_eas=(
        0x40B958,
        0x40B95E,
        0x40B964,
    ...
    imported_closure_block_ids=ROW135_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40C1F2, 0x40C49A),
    flag_corridor_id="flags-intact@0x40B95E",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW134_SETCC_ROUTE.operation_id,),
)

_ROW136_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40B98A",
    reference_order=136,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40B972",
    selected_value_block_id="native@0x40B980",
    join_block_id="native@0x40B986",
    source_native_ea=0x40B972,
    source_block_anchor_ea=0x40B980,
    join_ea=0x40B986,
    transfer_ea=0x40B98A,
    condition_producer_ea=0x40B978,
    predicate_anchor_ea=0x40B97E,
    normalization_start_ea=0x40B97E,
    source_branch_ea=0x40B97E,
    selected_value_ea=0x40B980,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B98C",
    false_target_block_id="native@0x40C1F2",
    true_target_ea=0x40B98C,
    false_target_ea=0x40C1F2,
    comparison_constant=0xF0B56411,
    owned_corridor_instruction_eas=(
        0x40B972,
        0x40B978,
        0x40B97E,
    ...
    imported_closure_block_ids=ROW136_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40B9A6),
    flag_corridor_id="flags-intact@0x40B978",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW135_EXISTING_ROUTE.operation_id,),
)

_ROW137_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40B9A4",
    reference_order=137,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40B98C",
    selected_value_block_id="native@0x40B99A",
    join_block_id="native@0x40B9A0",
    source_native_ea=0x40B98C,
    source_block_anchor_ea=0x40B99A,
    join_ea=0x40B9A0,
    transfer_ea=0x40B9A4,
    condition_producer_ea=0x40B992,
    predicate_anchor_ea=0x40B998,
    normalization_start_ea=0x40B998,
    source_branch_ea=0x40B998,
    selected_value_ea=0x40B99A,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40B9A6",
    false_target_block_id="native@0x40A5F0",
    ...
    imported_closure_block_ids=ROW137_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40B992",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW136_EXISTING_ROUTE.operation_id,),
)

_ROW138_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40BB73",
    reference_operation_id="rhad:route@0x40BB73",
    reference_order=138,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BB69",
    source_native_ea=0x40BB51,
    transfer_ea=0x40BB73,
    owner_anchor_ea=0x40BB69,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40BB51,
        0x40BB69,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW137_EXISTING_ROUTE.operation_id,),
)

_ROW139_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BB8D",
    reference_order=139,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BB75",
    selected_value_block_id="native@0x40BB83",
    join_block_id="native@0x40BB89",
    source_native_ea=0x40BB75,
    source_block_anchor_ea=0x40BB89,
    join_ea=0x40BB89,
    transfer_ea=0x40BB8D,
    condition_producer_ea=0x40BB7B,
    predicate_anchor_ea=0x40BB81,
    normalization_start_ea=0x40BB81,
    source_branch_ea=0x40BB81,
    selected_value_ea=0x40BB83,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40BB8F",
    false_target_block_id="native@0x40BF8C",
    true_target_ea=0x40BB8F,
    false_target_ea=0x40BF8C,
    comparison_constant=0xA0DBF1FA,
    owned_corridor_instruction_eas=(
        0x40BB75,
        0x40BB7B,
        0x40BB81,
    ...
    imported_closure_block_ids=ROW139_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40BBA9, 0x40BFA4, 0x40C253, 0x40C4DC),
    flag_corridor_id="flags-intact@0x40BB7B",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW138_DIRECT_ROUTE.operation_id,),
)

_ROW140_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BBA7",
    reference_order=140,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BB8F",
    selected_value_block_id="native@0x40BB9D",
    join_block_id="native@0x40BBA3",
    source_native_ea=0x40BB8F,
    source_block_anchor_ea=0x40BBA3,
    join_ea=0x40BBA3,
    transfer_ea=0x40BBA7,
    condition_producer_ea=0x40BB95,
    predicate_anchor_ea=0x40BB9B,
    normalization_start_ea=0x40BB9B,
    source_branch_ea=0x40BB9B,
    selected_value_ea=0x40BB9D,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40BBA9",
    false_target_block_id="native@0x40C253",
    true_target_ea=0x40BBA9,
    false_target_ea=0x40C253,
    comparison_constant=0xA0716E5B,
    owned_corridor_instruction_eas=(
        0x40BB8F,
        0x40BB95,
        0x40BB9B,
    ...
    imported_closure_block_ids=ROW140_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40BBC3),
    flag_corridor_id="flags-intact@0x40BB95",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW139_EXISTING_ROUTE.operation_id,),
)

_ROW141_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BBC1",
    reference_order=141,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BBA9",
    selected_value_block_id="native@0x40BBB7",
    join_block_id="native@0x40BBBD",
    source_native_ea=0x40BBA9,
    source_block_anchor_ea=0x40BBBD,
    join_ea=0x40BBBD,
    transfer_ea=0x40BBC1,
    condition_producer_ea=0x40BBAF,
    predicate_anchor_ea=0x40BBB5,
    normalization_start_ea=0x40BBB5,
    source_branch_ea=0x40BBB5,
    selected_value_ea=0x40BBB7,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40BBC3",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40BBC3,
    false_target_ea=0x40A5F0,
    comparison_constant=0x9A607E2A,
    owned_corridor_instruction_eas=(
        0x40BBA9,
    ...
    imported_closure_block_ids=ROW141_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BBAF",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW140_EXISTING_ROUTE.operation_id,),
)

_ROW142_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BBDD",
    reference_order=142,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BBC3",
    source_value_block_id="native@0x40BBC3",
    source_native_ea=0x40BBCE,
    source_block_anchor_ea=0x40BBC3,
    transfer_ea=0x40BBDD,
    predicate_anchor_ea=0x40BBD6,
    normalization_start_ea=0x40BBD6,
    condition_producer_ea=0x40BBC8,
    conditional_select_ea=0x40BBD6,
    selected_value_block_id="native@0x40BBD6",
    join_block_id="native@0x40BBD9",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BBC8",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW141_EXISTING_ROUTE.operation_id,),
)

_ROW143_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BBF7",
    reference_order=143,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BBDF",
    selected_value_block_id="native@0x40BBED",
    join_block_id="native@0x40BBF3",
    source_native_ea=0x40BBDF,
    source_block_anchor_ea=0x40BBF3,
    join_ea=0x40BBF3,
    transfer_ea=0x40BBF7,
    condition_producer_ea=0x40BBE5,
    predicate_anchor_ea=0x40BBEB,
    normalization_start_ea=0x40BBEB,
    source_branch_ea=0x40BBEB,
    selected_value_ea=0x40BBED,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40BBF9",
    false_target_block_id="native@0x40BFDA",
    true_target_ea=0x40BBF9,
    false_target_ea=0x40BFDA,
    comparison_constant=0xE6B7ADA3,
    owned_corridor_instruction_eas=(
        0x40BBDF,
        0x40BBE5,
        0x40BBEB,
    ...
    imported_closure_block_ids=ROW143_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40BC13, 0x40C2FB, 0x40C527),
    flag_corridor_id="flags-intact@0x40BBE5",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW142_CMOV_ROUTE.operation_id,),
)

_ROW144_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BC11",
    reference_order=144,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BBF9",
    selected_value_block_id="native@0x40BC07",
    join_block_id="native@0x40BC0D",
    source_native_ea=0x40BBF9,
    source_block_anchor_ea=0x40BC0D,
    join_ea=0x40BC0D,
    transfer_ea=0x40BC11,
    condition_producer_ea=0x40BBFF,
    predicate_anchor_ea=0x40BC05,
    normalization_start_ea=0x40BC05,
    source_branch_ea=0x40BC05,
    selected_value_ea=0x40BC07,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C2FB",
    false_target_block_id="native@0x40BC13",
    true_target_ea=0x40C2FB,
    false_target_ea=0x40BC13,
    comparison_constant=0xE41F690E,
    owned_corridor_instruction_eas=(
        0x40BBF9,
        0x40BBFF,
        0x40BC05,
    ...
    imported_closure_block_ids=ROW144_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40BC2D, 0x40C315),
    flag_corridor_id="flags-intact@0x40BBFF",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW143_EXISTING_ROUTE.operation_id,),
)

_ROW145_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BC2B",
    reference_order=145,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BC13",
    selected_value_block_id="native@0x40BC21",
    join_block_id="native@0x40BC27",
    source_native_ea=0x40BC13,
    source_block_anchor_ea=0x40BC27,
    join_ea=0x40BC27,
    transfer_ea=0x40BC2B,
    condition_producer_ea=0x40BC19,
    predicate_anchor_ea=0x40BC1F,
    normalization_start_ea=0x40BC1F,
    source_branch_ea=0x40BC1F,
    selected_value_ea=0x40BC21,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40A5F0",
    false_target_block_id="native@0x40BC2D",
    true_target_ea=0x40A5F0,
    false_target_ea=0x40BC2D,
    comparison_constant=0xDEF4B7E6,
    owned_corridor_instruction_eas=(
        0x40BC13,
        0x40BC19,
    ...
    imported_closure_block_ids=ROW145_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BC19",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW144_EXISTING_ROUTE.operation_id,),
)

_ROW146_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BC5F",
    reference_order=146,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BC36",
    source_value_block_id="native@0x40BC36",
    source_native_ea=0x40BC3C,
    source_block_anchor_ea=0x40BC36,
    transfer_ea=0x40BC5F,
    predicate_anchor_ea=0x40BC58,
    normalization_start_ea=0x40BC58,
    condition_producer_ea=0x40BC4A,
    conditional_select_ea=0x40BC58,
    selected_value_block_id="native@0x40BC58",
    join_block_id="native@0x40BC5B",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BC4A",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW145_EXISTING_ROUTE.operation_id,),
)

_ROW147_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BC79",
    reference_order=147,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BC61",
    selected_value_block_id="native@0x40BC6F",
    join_block_id="native@0x40BC75",
    source_native_ea=0x40BC61,
    source_block_anchor_ea=0x40BC75,
    join_ea=0x40BC75,
    transfer_ea=0x40BC79,
    condition_producer_ea=0x40BC67,
    predicate_anchor_ea=0x40BC6D,
    normalization_start_ea=0x40BC6D,
    source_branch_ea=0x40BC6D,
    selected_value_ea=0x40BC6F,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C041",
    false_target_block_id="native@0x40BC7B",
    true_target_ea=0x40C041,
    false_target_ea=0x40BC7B,
    comparison_constant=0xBCDE2EFB,
    owned_corridor_instruction_eas=(
        0x40BC61,
        0x40BC67,
        0x40BC6D,
    ...
    imported_closure_block_ids=ROW147_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40BC95, 0x40C05B, 0x40C34D, 0x40C578),
    flag_corridor_id="flags-intact@0x40BC67",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW146_CMOV_ROUTE.operation_id,),
)

_ROW148_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BC93",
    reference_order=148,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BC7B",
    selected_value_block_id="native@0x40BC89",
    join_block_id="native@0x40BC8F",
    source_native_ea=0x40BC7B,
    source_block_anchor_ea=0x40BC8F,
    join_ea=0x40BC8F,
    transfer_ea=0x40BC93,
    condition_producer_ea=0x40BC81,
    predicate_anchor_ea=0x40BC87,
    normalization_start_ea=0x40BC87,
    source_branch_ea=0x40BC87,
    selected_value_ea=0x40BC89,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C34D",
    false_target_block_id="native@0x40BC95",
    true_target_ea=0x40C34D,
    false_target_ea=0x40BC95,
    comparison_constant=0xB5D98F1E,
    owned_corridor_instruction_eas=(
        0x40BC7B,
        0x40BC81,
        0x40BC87,
    ...
    imported_closure_block_ids=ROW148_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40BCAF, 0x40C367),
    flag_corridor_id="flags-intact@0x40BC81",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW147_EXISTING_ROUTE.operation_id,),
)

_ROW149_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BCAD",
    reference_order=149,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BC95",
    selected_value_block_id="native@0x40BCA3",
    join_block_id="native@0x40BCA9",
    source_native_ea=0x40BC95,
    source_block_anchor_ea=0x40BCA9,
    join_ea=0x40BCA9,
    transfer_ea=0x40BCAD,
    condition_producer_ea=0x40BC9B,
    predicate_anchor_ea=0x40BCA1,
    normalization_start_ea=0x40BCA1,
    source_branch_ea=0x40BCA1,
    selected_value_ea=0x40BCA3,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40A5F0",
    false_target_block_id="native@0x40BCAF",
    true_target_ea=0x40A5F0,
    false_target_ea=0x40BCAF,
    comparison_constant=0xB34CE2DF,
    owned_corridor_instruction_eas=(
        0x40BC95,
        0x40BC9B,
        0x40BCA1,
    ...
    imported_closure_block_ids=ROW149_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BC9B",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW148_EXISTING_ROUTE.operation_id,),
)

_ROW150_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BCC9",
    reference_order=150,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BCAF",
    source_value_block_id="native@0x40BCAF",
    source_native_ea=0x40BCBA,
    source_block_anchor_ea=0x40BCAF,
    transfer_ea=0x40BCC9,
    predicate_anchor_ea=0x40BCC2,
    normalization_start_ea=0x40BCC2,
    condition_producer_ea=0x40BCB4,
    conditional_select_ea=0x40BCC2,
    selected_value_block_id="native@0x40BCC2",
    join_block_id="native@0x40BCC5",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BCB4",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW149_EXISTING_ROUTE.operation_id,),
)

_ROW151_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BCE3",
    reference_order=151,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BCCB",
    selected_value_block_id="native@0x40BCD9",
    join_block_id="native@0x40BCDF",
    source_native_ea=0x40BCCB,
    source_block_anchor_ea=0x40BCDF,
    join_ea=0x40BCDF,
    transfer_ea=0x40BCE3,
    condition_producer_ea=0x40BCD1,
    predicate_anchor_ea=0x40BCD7,
    normalization_start_ea=0x40BCD7,
    source_branch_ea=0x40BCD7,
    selected_value_ea=0x40BCD9,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C0A0",
    false_target_block_id="native@0x40BCE5",
    true_target_ea=0x40C0A0,
    false_target_ea=0x40BCE5,
    comparison_constant=0xFED7FAC0,
    owned_corridor_instruction_eas=(
        0x40BCCB,
        0x40BCD1,
        0x40BCD7,
    ...
    imported_closure_block_ids=ROW151_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40C392, 0x40C5FB),
    flag_corridor_id="flags-intact@0x40BCD1",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW150_CMOV_ROUTE.operation_id,),
)

_ROW152_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BCFD",
    reference_order=152,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BCE5",
    selected_value_block_id="native@0x40BCF3",
    join_block_id="native@0x40BCF9",
    source_native_ea=0x40BCE5,
    source_block_anchor_ea=0x40BCF9,
    join_ea=0x40BCF9,
    transfer_ea=0x40BCFD,
    condition_producer_ea=0x40BCEB,
    predicate_anchor_ea=0x40BCF1,
    normalization_start_ea=0x40BCF1,
    source_branch_ea=0x40BCF1,
    selected_value_ea=0x40BCF3,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C392",
    false_target_block_id="native@0x40BCFF",
    true_target_ea=0x40C392,
    false_target_ea=0x40BCFF,
    comparison_constant=0xFA72F85A,
    owned_corridor_instruction_eas=(
        0x40BCE5,
        0x40BCEB,
        0x40BCF1,
    ...
    imported_closure_block_ids=ROW152_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40BD19),
    flag_corridor_id="flags-intact@0x40BCEB",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW151_EXISTING_ROUTE.operation_id,),
)

_ROW153_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BD17",
    reference_order=153,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BCFF",
    selected_value_block_id="native@0x40BD0D",
    join_block_id="native@0x40BD13",
    source_native_ea=0x40BCFF,
    source_block_anchor_ea=0x40BD13,
    join_ea=0x40BD13,
    transfer_ea=0x40BD17,
    condition_producer_ea=0x40BD05,
    predicate_anchor_ea=0x40BD0B,
    normalization_start_ea=0x40BD0B,
    source_branch_ea=0x40BD0B,
    selected_value_ea=0x40BD0D,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40A5F0",
    false_target_block_id="native@0x40BD19",
    true_target_ea=0x40A5F0,
    false_target_ea=0x40BD19,
    comparison_constant=0xF7088159,
    owned_corridor_instruction_eas=(
        0x40BCFF,
        0x40BD05,
        0x40BD0B,
    ...
    imported_closure_block_ids=ROW153_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BD05",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW152_EXISTING_ROUTE.operation_id,),
)

_ROW154_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BD4E",
    reference_order=154,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BD25",
    source_value_block_id="native@0x40BD25",
    source_native_ea=0x40BD2B,
    source_block_anchor_ea=0x40BD25,
    transfer_ea=0x40BD4E,
    predicate_anchor_ea=0x40BD47,
    normalization_start_ea=0x40BD47,
    condition_producer_ea=0x40BD39,
    conditional_select_ea=0x40BD47,
    selected_value_block_id="native@0x40BD47",
    join_block_id="native@0x40BD4A",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BD39",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW153_EXISTING_ROUTE.operation_id,),
)

_ROW155_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BD68",
    reference_order=155,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BD50",
    selected_value_block_id="native@0x40BD5E",
    join_block_id="native@0x40BD64",
    source_native_ea=0x40BD50,
    source_block_anchor_ea=0x40BD64,
    join_ea=0x40BD64,
    transfer_ea=0x40BD68,
    condition_producer_ea=0x40BD56,
    predicate_anchor_ea=0x40BD5C,
    normalization_start_ea=0x40BD5C,
    source_branch_ea=0x40BD5C,
    selected_value_ea=0x40BD5E,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C3D9",
    false_target_block_id="native@0x40BD6A",
    true_target_ea=0x40C3D9,
    false_target_ea=0x40BD6A,
    comparison_constant=0x96B0D1E5,
    owned_corridor_instruction_eas=(
        0x40BD50,
        0x40BD56,
        0x40BD5C,
    ...
    imported_closure_block_ids=ROW155_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40BD84, 0x40C3F3),
    flag_corridor_id="flags-intact@0x40BD56",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW154_CMOV_ROUTE.operation_id,),
)

_ROW156_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BD82",
    reference_order=156,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BD6A",
    selected_value_block_id="native@0x40BD78",
    join_block_id="native@0x40BD7E",
    source_native_ea=0x40BD6A,
    source_block_anchor_ea=0x40BD7E,
    join_ea=0x40BD7E,
    transfer_ea=0x40BD82,
    condition_producer_ea=0x40BD70,
    predicate_anchor_ea=0x40BD76,
    normalization_start_ea=0x40BD76,
    source_branch_ea=0x40BD76,
    selected_value_ea=0x40BD78,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40A5F0",
    false_target_block_id="native@0x40BD84",
    true_target_ea=0x40A5F0,
    false_target_ea=0x40BD84,
    comparison_constant=0x921C6083,
    owned_corridor_instruction_eas=(
        0x40BD6A,
        0x40BD70,
    ...
    imported_closure_block_ids=ROW156_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BD70",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW155_EXISTING_ROUTE.operation_id,),
)

_ROW157_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BE2D",
    reference_order=157,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BE0A",
    source_value_block_id="native@0x40BDD5",
    source_native_ea=0x40BDFC,
    source_block_anchor_ea=0x40BE0A,
    transfer_ea=0x40BE2D,
    predicate_anchor_ea=0x40BE26,
    normalization_start_ea=0x40BE26,
    condition_producer_ea=0x40BE1E,
    conditional_select_ea=0x40BE26,
    selected_value_block_id="native@0x40BE26",
    join_block_id="native@0x40BE29",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BE1E",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW156_EXISTING_ROUTE.operation_id,),
)

_ROW158_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BE47",
    reference_order=158,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BE2F",
    selected_value_block_id="native@0x40BE3D",
    join_block_id="native@0x40BE43",
    source_native_ea=0x40BE2F,
    source_block_anchor_ea=0x40BE43,
    join_ea=0x40BE43,
    transfer_ea=0x40BE47,
    condition_producer_ea=0x40BE35,
    predicate_anchor_ea=0x40BE3B,
    normalization_start_ea=0x40BE3B,
    source_branch_ea=0x40BE3B,
    selected_value_ea=0x40BE3D,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C42E",
    false_target_block_id="native@0x40BE49",
    true_target_ea=0x40C42E,
    false_target_ea=0x40BE49,
    ...
    imported_closure_block_ids=ROW158_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40BE63),
    flag_corridor_id="flags-intact@0x40BE35",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW157_CMOV_ROUTE.operation_id,),
)

_ROW159_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BE61",
    reference_order=159,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BE49",
    selected_value_block_id="native@0x40BE57",
    join_block_id="native@0x40BE5D",
    source_native_ea=0x40BE49,
    source_block_anchor_ea=0x40BE5D,
    join_ea=0x40BE5D,
    transfer_ea=0x40BE61,
    condition_producer_ea=0x40BE4F,
    predicate_anchor_ea=0x40BE55,
    normalization_start_ea=0x40BE55,
    source_branch_ea=0x40BE55,
    selected_value_ea=0x40BE57,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40A5F0",
    false_target_block_id="native@0x40BE63",
    true_target_ea=0x40A5F0,
    false_target_ea=0x40BE63,
    comparison_constant=0xCEA36423,
    owned_corridor_instruction_eas=(
        0x40BE49,
        0x40BE4F,
    ...
    imported_closure_block_ids=ROW159_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BE4F",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW158_EXISTING_ROUTE.operation_id,),
)

_ROW160_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BE96",
    reference_order=160,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BE63",
    source_value_block_id="native@0x40BE63",
    source_native_ea=0x40BE68,
    source_block_anchor_ea=0x40BE63,
    transfer_ea=0x40BE96,
    predicate_anchor_ea=0x40BE8F,
    normalization_start_ea=0x40BE8F,
    condition_producer_ea=0x40BE81,
    conditional_select_ea=0x40BE8F,
    selected_value_block_id="native@0x40BE8F",
    join_block_id="native@0x40BE92",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BE81",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW159_EXISTING_ROUTE.operation_id,),
)

_ROW161_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BEB0",
    reference_order=161,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BE98",
    selected_value_block_id="native@0x40BEA6",
    join_block_id="native@0x40BEAC",
    source_native_ea=0x40BE98,
    source_block_anchor_ea=0x40BEAC,
    join_ea=0x40BEAC,
    transfer_ea=0x40BEB0,
    condition_producer_ea=0x40BE9E,
    predicate_anchor_ea=0x40BEA4,
    normalization_start_ea=0x40BEA4,
    source_branch_ea=0x40BEA4,
    selected_value_ea=0x40BEA6,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40BEB2",
    false_target_block_id="native@0x40C464",
    true_target_ea=0x40BEB2,
    false_target_ea=0x40C464,
    comparison_constant=0xAE5A330B,
    owned_corridor_instruction_eas=(
        0x40BE98,
        0x40BE9E,
        0x40BEA4,
...
_ROW162_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BECA",
    reference_order=162,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BEB2",
    selected_value_block_id="native@0x40BEC0",
    join_block_id="native@0x40BEC6",
    source_native_ea=0x40BEB2,
    source_block_anchor_ea=0x40BEC6,
    join_ea=0x40BEC6,
    transfer_ea=0x40BECA,
    condition_producer_ea=0x40BEB8,
    predicate_anchor_ea=0x40BEBE,
    normalization_start_ea=0x40BEBE,
    source_branch_ea=0x40BEBE,
    selected_value_ea=0x40BEC0,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40A5F0",
    false_target_block_id="native@0x40BECC",
    true_target_ea=0x40A5F0,
    false_target_ea=0x40BECC,
    comparison_constant=0xABB95547,
    owned_corridor_instruction_eas=(
        0x40BEB2,
        0x40BEB8,
    ...
    imported_closure_block_ids=ROW162_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BEB8",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW161_EXISTING_ROUTE.operation_id,),
)

_ROW163_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BEE5",
    reference_order=163,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BECC",
    source_value_block_id="native@0x40BECC",
    source_native_ea=0x40BED6,
    source_block_anchor_ea=0x40BECC,
    transfer_ea=0x40BEE5,
    predicate_anchor_ea=0x40BEDE,
    normalization_start_ea=0x40BEDE,
    condition_producer_ea=0x40BED0,
    conditional_select_ea=0x40BEDE,
    selected_value_block_id="native@0x40BEDE",
    join_block_id="native@0x40BEE1",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BED0",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW162_EXISTING_ROUTE.operation_id,),
)

_ROW164_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BEFF",
    reference_order=164,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BEE7",
    selected_value_block_id="native@0x40BEF5",
    join_block_id="native@0x40BEFB",
    source_native_ea=0x40BEE7,
    source_block_anchor_ea=0x40BEFB,
    join_ea=0x40BEFB,
    transfer_ea=0x40BEFF,
    condition_producer_ea=0x40BEED,
    predicate_anchor_ea=0x40BEF3,
    normalization_start_ea=0x40BEF3,
    source_branch_ea=0x40BEF3,
    selected_value_ea=0x40BEF5,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40BF01",
    false_target_block_id="native@0x40C49A",
    true_target_ea=0x40BF01,
    false_target_ea=0x40C49A,
    comparison_constant=0xF6A636EF,
    owned_corridor_instruction_eas=(
        0x40BEE7,
        0x40BEED,
        0x40BEF3,
    ...
    imported_closure_block_ids=ROW164_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40BF1B, 0x40C4B4),
    flag_corridor_id="flags-intact@0x40BEED",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW163_CMOV_ROUTE.operation_id,),
)

_ROW165_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BF19",
    reference_order=165,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BF01",
    selected_value_block_id="native@0x40BF0F",
    join_block_id="native@0x40BF15",
    source_native_ea=0x40BF01,
    source_block_anchor_ea=0x40BF15,
    join_ea=0x40BF15,
    transfer_ea=0x40BF19,
    condition_producer_ea=0x40BF07,
    predicate_anchor_ea=0x40BF0D,
    normalization_start_ea=0x40BF0D,
    source_branch_ea=0x40BF0D,
    selected_value_ea=0x40BF0F,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40BF1B",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40BF1B,
    false_target_ea=0x40A5F0,
    comparison_constant=0xF32B2D3A,
    owned_corridor_instruction_eas=(
        0x40BF01,
    ...
    imported_closure_block_ids=ROW165_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BF07",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW164_EXISTING_ROUTE.operation_id,),
)

_ROW166_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40BF8A",
    reference_operation_id="rhad:route@0x40BF8A",
    reference_order=166,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BF80",
    source_native_ea=0x40BF68,
    transfer_ea=0x40BF8A,
    owner_anchor_ea=0x40BF80,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40BF68,
        0x40BF80,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW165_EXISTING_ROUTE.operation_id,),
)

_ROW167_SETCC_TABLE_PROOF_ARTIFACT = load_row167_table_proof_artifact()

_ROW167_SETCC_ROUTE = RhadSetccIndexedTableRoute(
    operation_id="rhad:route@0x40BFA2",
    reference_order=167,
    operation_variant=RhadOperationVariant.SETCC_INDEXED_TABLE,
    reference_symbol="JumpInliner._fixup_index_access",
    source_block_id="native@0x40BF8C",
    source_native_ea=0x40BF8C,
    source_block_anchor_ea=0x40BF8C,
    transfer_ea=0x40BFA2,
    condition_producer_ea=0x40BF8E,
    predicate_anchor_ea=0x40BF94,
    predicate_kind=PredicateKind.SGE,
    fallthrough_delivery=FragmentSetccFallthroughDelivery.PLANNED_HELPER,
    true_target_block_id="native@0x40C4DC",
    false_target_block_id="native@0x40BFA4",
    true_target_ea=0x40C4DC,
    false_target_ea=0x40BFA4,
    table_proof_artifact=_ROW167_SETCC_TABLE_PROOF_ARTIFACT,
    owned_corridor_instruction_eas=(
        0x40BF8C,
        0x40BF8E,
        0x40BF94,
    ...
    imported_closure_block_ids=ROW167_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0,),
    flag_corridor_id="flags-intact@0x40BF8E",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW166_DIRECT_ROUTE.operation_id,),
)

_ROW168_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BFBC",
    reference_order=168,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BFA4",
    selected_value_block_id="native@0x40BFB2",
    join_block_id="native@0x40BFB8",
    source_native_ea=0x40BFA4,
    source_block_anchor_ea=0x40BFB8,
    join_ea=0x40BFB8,
    transfer_ea=0x40BFBC,
    condition_producer_ea=0x40BFAA,
    predicate_anchor_ea=0x40BFB0,
    normalization_start_ea=0x40BFB0,
    source_branch_ea=0x40BFB0,
    selected_value_ea=0x40BFB2,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40BFBE",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40BFBE,
    false_target_ea=0x40A5F0,
    comparison_constant=0xA0DBF1FA,
    owned_corridor_instruction_eas=(
        0x40BFA4,
    ...
    imported_closure_block_ids=ROW168_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BFAA",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW167_SETCC_ROUTE.operation_id,),
)

_ROW169_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40BFD8",
    reference_order=169,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40BFBE",
    source_value_block_id="native@0x40BFBE",
    source_native_ea=0x40BFC9,
    source_block_anchor_ea=0x40BFBE,
    transfer_ea=0x40BFD8,
    predicate_anchor_ea=0x40BFD1,
    normalization_start_ea=0x40BFD1,
    condition_producer_ea=0x40BFC3,
    conditional_select_ea=0x40BFD1,
    selected_value_block_id="native@0x40BFD1",
    join_block_id="native@0x40BFD4",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40BFC3",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW168_EXISTING_ROUTE.operation_id,),
)

_ROW170_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40BFF2",
    reference_order=170,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BFDA",
    selected_value_block_id="native@0x40BFE8",
    join_block_id="native@0x40BFEE",
    source_native_ea=0x40BFDA,
    source_block_anchor_ea=0x40BFEE,
    join_ea=0x40BFEE,
    transfer_ea=0x40BFF2,
    condition_producer_ea=0x40BFE0,
    predicate_anchor_ea=0x40BFE6,
    normalization_start_ea=0x40BFE6,
    source_branch_ea=0x40BFE6,
    selected_value_ea=0x40BFE8,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40BFF4",
    false_target_block_id="native@0x40C527",
    true_target_ea=0x40BFF4,
    false_target_ea=0x40C527,
    comparison_constant=0xEC054ACC,
    owned_corridor_instruction_eas=(
        0x40BFDA,
        0x40BFE0,
        0x40BFE6,
    ...
    imported_closure_block_ids=ROW170_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40C00E, 0x40C541),
    flag_corridor_id="flags-intact@0x40BFE0",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW169_CMOV_ROUTE.operation_id,),
)

_ROW171_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C00C",
    reference_order=171,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40BFF4",
    selected_value_block_id="native@0x40C002",
    join_block_id="native@0x40C008",
    source_native_ea=0x40BFF4,
    source_block_anchor_ea=0x40C008,
    join_ea=0x40C008,
    transfer_ea=0x40C00C,
    condition_producer_ea=0x40BFFA,
    predicate_anchor_ea=0x40C000,
    normalization_start_ea=0x40C000,
    source_branch_ea=0x40C000,
    selected_value_ea=0x40C002,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C00E",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C00E,
    false_target_ea=0x40A5F0,
    comparison_constant=0xE6B7ADA3,
    owned_corridor_instruction_eas=(
        0x40BFF4,
    ...
    imported_closure_block_ids=ROW171_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40BFFA",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW170_EXISTING_ROUTE.operation_id,),
)

_ROW172_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C03F",
    reference_operation_id="rhad:route@0x40C03F",
    reference_order=172,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C03B",
    source_native_ea=0x40C027,
    transfer_ea=0x40C03F,
    owner_anchor_ea=0x40C03B,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C027,
        0x40C03B,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW171_EXISTING_ROUTE.operation_id,),
)

_ROW173_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C059",
    reference_order=173,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C041",
    selected_value_block_id="native@0x40C04F",
    join_block_id="native@0x40C055",
    source_native_ea=0x40C041,
    source_block_anchor_ea=0x40C055,
    join_ea=0x40C055,
    transfer_ea=0x40C059,
    condition_producer_ea=0x40C047,
    predicate_anchor_ea=0x40C04D,
    normalization_start_ea=0x40C04D,
    source_branch_ea=0x40C04D,
    selected_value_ea=0x40C04F,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C05B",
    false_target_block_id="native@0x40C578",
    true_target_ea=0x40C05B,
    false_target_ea=0x40C578,
    comparison_constant=0xBD9A2C2A,
    owned_corridor_instruction_eas=(
        0x40C041,
        0x40C047,
        0x40C04D,
    ...
    imported_closure_block_ids=ROW173_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40C075, 0x40C592),
    flag_corridor_id="flags-intact@0x40C047",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW172_DIRECT_ROUTE.operation_id,),
)

_ROW174_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C073",
    reference_order=174,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C05B",
    selected_value_block_id="native@0x40C069",
    join_block_id="native@0x40C06F",
    source_native_ea=0x40C05B,
    source_block_anchor_ea=0x40C06F,
    join_ea=0x40C06F,
    transfer_ea=0x40C073,
    condition_producer_ea=0x40C061,
    predicate_anchor_ea=0x40C067,
    normalization_start_ea=0x40C067,
    source_branch_ea=0x40C067,
    selected_value_ea=0x40C069,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C075",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C075,
    false_target_ea=0x40A5F0,
    comparison_constant=0xBCDE2EFB,
    owned_corridor_instruction_eas=(
        0x40C05B,
    ...
    imported_closure_block_ids=ROW174_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C061",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW173_EXISTING_ROUTE.operation_id,),
)

_ROW175_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C09E",
    reference_operation_id="rhad:route@0x40C09E",
    reference_order=175,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C09A",
    source_native_ea=0x40C088,
    transfer_ea=0x40C09E,
    owner_anchor_ea=0x40C09A,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C088,
        0x40C09A,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW174_EXISTING_ROUTE.operation_id,),
)

_ROW176_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C0B8",
    reference_order=176,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C0A0",
    selected_value_block_id="native@0x40C0AE",
    join_block_id="native@0x40C0B4",
    source_native_ea=0x40C0A0,
    source_block_anchor_ea=0x40C0B4,
    join_ea=0x40C0B4,
    transfer_ea=0x40C0B8,
    condition_producer_ea=0x40C0A6,
    predicate_anchor_ea=0x40C0AC,
    normalization_start_ea=0x40C0AC,
    source_branch_ea=0x40C0AC,
    selected_value_ea=0x40C0AE,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C0BA",
    false_target_block_id="native@0x40C5FB",
    true_target_ea=0x40C0BA,
    false_target_ea=0x40C5FB,
    comparison_constant=0x0872BFF1,
    owned_corridor_instruction_eas=(
        0x40C0A0,
        0x40C0A6,
        0x40C0AC,
    ...
    imported_closure_block_ids=ROW176_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40C64B),
    flag_corridor_id="flags-intact@0x40C0A6",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW175_DIRECT_ROUTE.operation_id,),
)

_ROW177_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C0D2",
    reference_order=177,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C0BA",
    selected_value_block_id="native@0x40C0C8",
    join_block_id="native@0x40C0CE",
    source_native_ea=0x40C0BA,
    source_block_anchor_ea=0x40C0CE,
    join_ea=0x40C0CE,
    transfer_ea=0x40C0D2,
    condition_producer_ea=0x40C0C0,
    predicate_anchor_ea=0x40C0C6,
    normalization_start_ea=0x40C0C6,
    source_branch_ea=0x40C0C6,
    selected_value_ea=0x40C0C8,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C0D4",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C0D4,
    false_target_ea=0x40A5F0,
    comparison_constant=0xFED7FAC0,
    owned_corridor_instruction_eas=(
        0x40C0BA,
    ...
    imported_closure_block_ids=ROW177_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C0C0",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW176_EXISTING_ROUTE.operation_id,),
)

_ROW178_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C0EE",
    reference_order=178,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C0D4",
    source_value_block_id="native@0x40C0D4",
    source_native_ea=0x40C0DF,
    source_block_anchor_ea=0x40C0D4,
    transfer_ea=0x40C0EE,
    predicate_anchor_ea=0x40C0E7,
    normalization_start_ea=0x40C0E7,
    condition_producer_ea=0x40C0D9,
    conditional_select_ea=0x40C0E7,
    selected_value_block_id="native@0x40C0E7",
    join_block_id="native@0x40C0EA",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C0D9",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW177_EXISTING_ROUTE.operation_id,),
)

_ROW179_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C108",
    reference_order=179,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C0F0",
    selected_value_block_id="native@0x40C0FE",
    join_block_id="native@0x40C104",
    source_native_ea=0x40C0F0,
    source_block_anchor_ea=0x40C104,
    join_ea=0x40C104,
    transfer_ea=0x40C108,
    condition_producer_ea=0x40C0F6,
    predicate_anchor_ea=0x40C0FC,
    normalization_start_ea=0x40C0FC,
    source_branch_ea=0x40C0FC,
    selected_value_ea=0x40C0FE,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C10A",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C10A,
    false_target_ea=0x40A5F0,
    comparison_constant=0x886CCA9F,
    owned_corridor_instruction_eas=(
        0x40C0F0,
    ...
    imported_closure_block_ids=ROW179_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C0F6",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW178_CMOV_ROUTE.operation_id,),
)

_ROW180_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C14E",
    reference_operation_id="rhad:route@0x40C14E",
    reference_order=180,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C144",
    source_native_ea=0x40C132,
    transfer_ea=0x40C14E,
    owner_anchor_ea=0x40C144,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C132,
        0x40C144,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW179_EXISTING_ROUTE.operation_id,),
)

_ROW181_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C168",
    reference_order=181,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C150",
    selected_value_block_id="native@0x40C15E",
    join_block_id="native@0x40C164",
    source_native_ea=0x40C150,
    source_block_anchor_ea=0x40C164,
    join_ea=0x40C164,
    transfer_ea=0x40C168,
    condition_producer_ea=0x40C156,
    predicate_anchor_ea=0x40C15C,
    normalization_start_ea=0x40C15C,
    source_branch_ea=0x40C15C,
    selected_value_ea=0x40C15E,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C16A",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C16A,
    false_target_ea=0x40A5F0,
    comparison_constant=0xCCEC5DE0,
    owned_corridor_instruction_eas=(
        0x40C150,
        0x40C156,
        0x40C15C,
    ...
    imported_closure_block_ids=ROW181_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C156",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW180_DIRECT_ROUTE.operation_id,),
)

_ROW182_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C184",
    reference_order=182,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C16A",
    source_value_block_id="native@0x40C16A",
    source_native_ea=0x40C175,
    source_block_anchor_ea=0x40C16A,
    transfer_ea=0x40C184,
    predicate_anchor_ea=0x40C17D,
    normalization_start_ea=0x40C17D,
    condition_producer_ea=0x40C16F,
    conditional_select_ea=0x40C17D,
    selected_value_block_id="native@0x40C17D",
    join_block_id="native@0x40C180",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C16F",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW181_EXISTING_ROUTE.operation_id,),
)

_ROW183_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C19E",
    reference_order=183,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C186",
    selected_value_block_id="native@0x40C194",
    join_block_id="native@0x40C19A",
    source_native_ea=0x40C186,
    source_block_anchor_ea=0x40C19A,
    join_ea=0x40C19A,
    transfer_ea=0x40C19E,
    condition_producer_ea=0x40C18C,
    predicate_anchor_ea=0x40C192,
    normalization_start_ea=0x40C192,
    source_branch_ea=0x40C192,
    selected_value_ea=0x40C194,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C1A0",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C1A0,
    false_target_ea=0x40A5F0,
    comparison_constant=0xA7933EA0,
    owned_corridor_instruction_eas=(
        0x40C186,
    ...
    imported_closure_block_ids=ROW183_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C18C",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW182_CMOV_ROUTE.operation_id,),
)

_ROW184_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C1F0",
    reference_order=184,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C1C0",
    source_value_block_id="native@0x40C1C0",
    source_native_ea=0x40C1C6,
    source_block_anchor_ea=0x40C1C0,
    transfer_ea=0x40C1F0,
    predicate_anchor_ea=0x40C1E9,
    normalization_start_ea=0x40C1E9,
    condition_producer_ea=0x40C1DB,
    conditional_select_ea=0x40C1E9,
    selected_value_block_id="native@0x40C1E9",
    join_block_id="native@0x40C1EC",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C1DB",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW183_EXISTING_ROUTE.operation_id,),
)

_ROW185_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C20A",
    reference_order=185,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C1F2",
    selected_value_block_id="native@0x40C200",
    join_block_id="native@0x40C206",
    source_native_ea=0x40C1F2,
    source_block_anchor_ea=0x40C206,
    join_ea=0x40C206,
    transfer_ea=0x40C20A,
    condition_producer_ea=0x40C1F8,
    predicate_anchor_ea=0x40C1FE,
    normalization_start_ea=0x40C1FE,
    source_branch_ea=0x40C1FE,
    selected_value_ea=0x40C200,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C20C",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C20C,
    false_target_ea=0x40A5F0,
    comparison_constant=0xF0B56411,
    owned_corridor_instruction_eas=(
        0x40C1F2,
    ...
    imported_closure_block_ids=ROW185_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C1F8",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW184_CMOV_ROUTE.operation_id,),
)

_ROW186_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C251",
    reference_operation_id="rhad:route@0x40C251",
    reference_order=186,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C247",
    source_native_ea=0x40C235,
    transfer_ea=0x40C251,
    owner_anchor_ea=0x40C247,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C235,
        0x40C247,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW185_EXISTING_ROUTE.operation_id,),
)

_ROW187_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C26B",
    reference_order=187,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C253",
    selected_value_block_id="native@0x40C261",
    join_block_id="native@0x40C267",
    source_native_ea=0x40C253,
    source_block_anchor_ea=0x40C267,
    join_ea=0x40C267,
    transfer_ea=0x40C26B,
    condition_producer_ea=0x40C259,
    predicate_anchor_ea=0x40C25F,
    normalization_start_ea=0x40C25F,
    source_branch_ea=0x40C25F,
    selected_value_ea=0x40C261,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C26D",
    false_target_block_id="native@0x40A5F0",
    ...
    imported_closure_block_ids=ROW187_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C259",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW186_DIRECT_ROUTE.operation_id,),
)

_ROW188_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C2F9",
    reference_operation_id="rhad:route@0x40C2F9",
    reference_order=188,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C2EF",
    source_native_ea=0x40C2D7,
    transfer_ea=0x40C2F9,
    owner_anchor_ea=0x40C2EF,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C2D7,
        0x40C2EF,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW187_EXISTING_ROUTE.operation_id,),
)

_ROW189_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C313",
    reference_order=189,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C2FB",
    selected_value_block_id="native@0x40C309",
    join_block_id="native@0x40C30F",
    source_native_ea=0x40C2FB,
    source_block_anchor_ea=0x40C30F,
    join_ea=0x40C30F,
    transfer_ea=0x40C313,
    condition_producer_ea=0x40C301,
    predicate_anchor_ea=0x40C307,
    normalization_start_ea=0x40C307,
    source_branch_ea=0x40C307,
    selected_value_ea=0x40C309,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C315",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C315,
    false_target_ea=0x40A5F0,
    comparison_constant=0xE41F690E,
    owned_corridor_instruction_eas=(
        0x40C2FB,
    ...
    imported_closure_block_ids=ROW189_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C301",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW188_DIRECT_ROUTE.operation_id,),
)

_ROW190_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C34B",
    reference_operation_id="rhad:route@0x40C34B",
    reference_order=190,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C347",
    source_native_ea=0x40C335,
    transfer_ea=0x40C34B,
    owner_anchor_ea=0x40C347,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C335,
        0x40C347,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW189_EXISTING_ROUTE.operation_id,),
)

_ROW191_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C365",
    reference_order=191,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C34D",
    selected_value_block_id="native@0x40C35B",
    join_block_id="native@0x40C361",
    source_native_ea=0x40C34D,
    source_block_anchor_ea=0x40C361,
    join_ea=0x40C361,
    transfer_ea=0x40C365,
    condition_producer_ea=0x40C353,
    predicate_anchor_ea=0x40C359,
    normalization_start_ea=0x40C359,
    source_branch_ea=0x40C359,
    selected_value_ea=0x40C35B,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C367",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C367,
    false_target_ea=0x40A5F0,
    comparison_constant=0xB5D98F1E,
    owned_corridor_instruction_eas=(
        0x40C34D,
    ...
    imported_closure_block_ids=ROW191_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C353",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW190_DIRECT_ROUTE.operation_id,),
)

_ROW192_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C390",
    reference_operation_id="rhad:route@0x40C390",
    reference_order=192,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C38C",
    source_native_ea=0x40C37A,
    transfer_ea=0x40C390,
    owner_anchor_ea=0x40C38C,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C37A,
        0x40C38C,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW191_EXISTING_ROUTE.operation_id,),
)

_ROW193_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C3AA",
    reference_order=193,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C392",
    selected_value_block_id="native@0x40C3A0",
    join_block_id="native@0x40C3A6",
    source_native_ea=0x40C392,
    source_block_anchor_ea=0x40C3A6,
    join_ea=0x40C3A6,
    transfer_ea=0x40C3AA,
    condition_producer_ea=0x40C398,
    predicate_anchor_ea=0x40C39E,
    normalization_start_ea=0x40C39E,
    source_branch_ea=0x40C39E,
    selected_value_ea=0x40C3A0,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C3AC",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C3AC,
    false_target_ea=0x40A5F0,
    comparison_constant=0xFA72F85A,
    owned_corridor_instruction_eas=(
        0x40C392,
    ...
    imported_closure_block_ids=ROW193_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C398",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW192_DIRECT_ROUTE.operation_id,),
)

_ROW194_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C3D7",
    reference_operation_id="rhad:route@0x40C3D7",
    reference_order=194,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C3D3",
    source_native_ea=0x40C3C1,
    transfer_ea=0x40C3D7,
    owner_anchor_ea=0x40C3D3,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C3C1,
        0x40C3D3,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW193_EXISTING_ROUTE.operation_id,),
)

_ROW195_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C3F1",
    reference_order=195,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C3D9",
    selected_value_block_id="native@0x40C3E7",
    join_block_id="native@0x40C3ED",
    source_native_ea=0x40C3D9,
    source_block_anchor_ea=0x40C3ED,
    join_ea=0x40C3ED,
    transfer_ea=0x40C3F1,
    condition_producer_ea=0x40C3DF,
    predicate_anchor_ea=0x40C3E5,
    normalization_start_ea=0x40C3E5,
    source_branch_ea=0x40C3E5,
    selected_value_ea=0x40C3E7,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C3F3",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C3F3,
    false_target_ea=0x40A5F0,
    comparison_constant=0x96B0D1E5,
    owned_corridor_instruction_eas=(
        0x40C3D9,
    ...
    imported_closure_block_ids=ROW195_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C3DF",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW194_DIRECT_ROUTE.operation_id,),
)

_ROW196_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C42C",
    reference_operation_id="rhad:route@0x40C42C",
    reference_order=196,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C422",
    source_native_ea=0x40C40A,
    transfer_ea=0x40C42C,
    owner_anchor_ea=0x40C422,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C40A,
        0x40C422,
...
_ROW198_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C462",
    reference_order=198,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C448",
    source_value_block_id="native@0x40C448",
    source_native_ea=0x40C453,
    source_block_anchor_ea=0x40C448,
    transfer_ea=0x40C462,
    predicate_anchor_ea=0x40C45B,
    normalization_start_ea=0x40C45B,
    condition_producer_ea=0x40C44D,
    conditional_select_ea=0x40C45B,
    selected_value_block_id="native@0x40C45B",
    join_block_id="native@0x40C45E",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=(
        ...
        *ROW198_SOURCE_IMPORTED_BLOCK_IDS,
    ),
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C44D",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW197_EXISTING_ROUTE.operation_id,),
)

_ROW199_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C47C",
    reference_order=199,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C464",
    selected_value_block_id="native@0x40C472",
    join_block_id="native@0x40C478",
    source_native_ea=0x40C464,
    source_block_anchor_ea=0x40C478,
    join_ea=0x40C478,
    transfer_ea=0x40C47C,
    condition_producer_ea=0x40C46A,
    predicate_anchor_ea=0x40C470,
    normalization_start_ea=0x40C470,
    source_branch_ea=0x40C470,
    selected_value_ea=0x40C472,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C47E",
    false_target_block_id="native@0x40A5F0",
    ...
    imported_closure_block_ids=ROW199_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C46A",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW198_CMOV_ROUTE.operation_id,),
)

_ROW200_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C498",
    reference_order=200,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C47E",
    source_value_block_id="native@0x40C47E",
    source_native_ea=0x40C489,
    source_block_anchor_ea=0x40C47E,
    transfer_ea=0x40C498,
    predicate_anchor_ea=0x40C491,
    normalization_start_ea=0x40C491,
    condition_producer_ea=0x40C483,
    conditional_select_ea=0x40C491,
    selected_value_block_id="native@0x40C491",
    join_block_id="native@0x40C494",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=(
        *ACCEPTED_IMPORTED_BLOCK_IDS,
        *ROW200_SOURCE_IMPORTED_BLOCK_IDS,
    ),
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C483",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW199_EXISTING_ROUTE.operation_id,),
)

_ROW201_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C4B2",
    reference_order=201,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C49A",
    selected_value_block_id="native@0x40C4A8",
    join_block_id="native@0x40C4AE",
    source_native_ea=0x40C49A,
    source_block_anchor_ea=0x40C4AE,
    join_ea=0x40C4AE,
    transfer_ea=0x40C4B2,
    condition_producer_ea=0x40C4A0,
    predicate_anchor_ea=0x40C4A6,
    normalization_start_ea=0x40C4A6,
    source_branch_ea=0x40C4A6,
    selected_value_ea=0x40C4A8,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C4B4",
    false_target_block_id="native@0x40A5F0",
    ...
    imported_closure_block_ids=ROW201_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C4A0",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
...
_ROW203_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C4F4",
    reference_order=203,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C4DC",
    selected_value_block_id="native@0x40C4EA",
    join_block_id="native@0x40C4F0",
    source_native_ea=0x40C4DC,
    source_block_anchor_ea=0x40C4F0,
    join_ea=0x40C4F0,
    transfer_ea=0x40C4F4,
    condition_producer_ea=0x40C4E2,
    predicate_anchor_ea=0x40C4E8,
    normalization_start_ea=0x40C4E8,
    source_branch_ea=0x40C4E8,
    selected_value_ea=0x40C4EA,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C4F6",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C4F6,
    false_target_ea=0x40A5F0,
    comparison_constant=0xA5540595,
    owned_corridor_instruction_eas=(
        0x40C4DC,
        0x40C4E2,
        0x40C4E8,
    ...
    imported_closure_block_ids=ROW203_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C4E2",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW202_EXISTING_ROUTE.operation_id,),
)

_ROW204_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C525",
    reference_order=204,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C4F6",
    source_value_block_id="native@0x40C4F6",
    source_native_ea=0x40C516,
    source_block_anchor_ea=0x40C4F6,
    transfer_ea=0x40C525,
    predicate_anchor_ea=0x40C51E,
    normalization_start_ea=0x40C51E,
    condition_producer_ea=0x40C510,
    conditional_select_ea=0x40C51E,
    selected_value_block_id="native@0x40C51E",
    join_block_id="native@0x40C521",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=(
        *ACCEPTED_IMPORTED_BLOCK_IDS,
        *ROW204_SOURCE_IMPORTED_BLOCK_IDS,
    ),
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C510",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW203_EXISTING_ROUTE.operation_id,),
)

_ROW205_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C53F",
    reference_order=205,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C527",
    selected_value_block_id="native@0x40C535",
    join_block_id="native@0x40C53B",
    source_native_ea=0x40C527,
    source_block_anchor_ea=0x40C53B,
    join_ea=0x40C53B,
    transfer_ea=0x40C53F,
    condition_producer_ea=0x40C52D,
    predicate_anchor_ea=0x40C533,
    normalization_start_ea=0x40C533,
    source_branch_ea=0x40C533,
    selected_value_ea=0x40C535,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C541",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C541,
    false_target_ea=0x40A5F0,
    comparison_constant=0xEC054ACC,
    owned_corridor_instruction_eas=(
        0x40C527,
    ...
    imported_closure_block_ids=ROW205_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C52D",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW204_CMOV_ROUTE.operation_id,),
)

_ROW206_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C576",
    reference_order=206,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C54D",
    source_value_block_id="native@0x40C54D",
    source_native_ea=0x40C553,
    source_block_anchor_ea=0x40C54D,
    transfer_ea=0x40C576,
    predicate_anchor_ea=0x40C56F,
    normalization_start_ea=0x40C56F,
    condition_producer_ea=0x40C561,
    conditional_select_ea=0x40C56F,
    selected_value_block_id="native@0x40C56F",
    join_block_id="native@0x40C572",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=(
        *ACCEPTED_IMPORTED_BLOCK_IDS,
        *ROW206_SOURCE_IMPORTED_BLOCK_IDS,
    ),
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C561",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW205_EXISTING_ROUTE.operation_id,),
)

_ROW207_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C590",
    reference_order=207,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C578",
    selected_value_block_id="native@0x40C586",
    join_block_id="native@0x40C58C",
    source_native_ea=0x40C578,
    source_block_anchor_ea=0x40C58C,
    join_ea=0x40C58C,
    transfer_ea=0x40C590,
    condition_producer_ea=0x40C57E,
    predicate_anchor_ea=0x40C584,
    normalization_start_ea=0x40C584,
    source_branch_ea=0x40C584,
    selected_value_ea=0x40C586,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C592",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C592,
    false_target_ea=0x40A5F0,
    comparison_constant=0xBD9A2C2A,
    owned_corridor_instruction_eas=(
        0x40C578,
    ...
    imported_closure_block_ids=ROW207_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C57E",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW206_CMOV_ROUTE.operation_id,),
)

_ROW208_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C5F9",
    reference_operation_id="rhad:route@0x40C5F9",
    reference_order=208,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C5EF",
    source_native_ea=0x40C5D7,
    transfer_ea=0x40C5F9,
    owner_anchor_ea=0x40C5EF,
    direct_target_block_id="native@0x40B6C0",
    owned_corridor_instruction_eas=(
        0x40C5D7,
        0x40C5EF,
    ...
    boundary_exit_eas=(0x40B790,),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW207_EXISTING_ROUTE.operation_id,),
)

_ROW209_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C613",
    reference_order=209,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C5FB",
    selected_value_block_id="native@0x40C609",
    join_block_id="native@0x40C60F",
    source_native_ea=0x40C5FB,
    source_block_anchor_ea=0x40C60F,
    join_ea=0x40C60F,
    transfer_ea=0x40C613,
    condition_producer_ea=0x40C601,
    predicate_anchor_ea=0x40C607,
    normalization_start_ea=0x40C607,
    source_branch_ea=0x40C607,
    selected_value_ea=0x40C609,
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40C64B",
    false_target_block_id="native@0x40C615",
    true_target_ea=0x40C64B,
    false_target_ea=0x40C615,
    comparison_constant=0x09FE690C,
    owned_corridor_instruction_eas=(
        0x40C5FB,
        0x40C601,
        0x40C607,
    ...
    imported_closure_block_ids=ROW209_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A5F0, 0x40C62F, 0x40C665),
    flag_corridor_id="flags-intact@0x40C601",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW208_DIRECT_ROUTE.operation_id,),
)

_ROW210_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C62D",
    reference_order=210,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C615",
    selected_value_block_id="native@0x40C623",
    join_block_id="native@0x40C629",
    source_native_ea=0x40C615,
    source_block_anchor_ea=0x40C629,
    join_ea=0x40C629,
    transfer_ea=0x40C62D,
    condition_producer_ea=0x40C61B,
    predicate_anchor_ea=0x40C621,
    normalization_start_ea=0x40C621,
    source_branch_ea=0x40C621,
    selected_value_ea=0x40C623,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C62F",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C62F,
    false_target_ea=0x40A5F0,
    comparison_constant=0x0872BFF1,
    owned_corridor_instruction_eas=(
        0x40C615,
    ...
    imported_closure_block_ids=ROW210_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C61B",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW209_EXISTING_ROUTE.operation_id,),
)

_ROW211_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C649",
    reference_order=211,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C62F",
    source_value_block_id="native@0x40C62F",
    source_native_ea=0x40C63A,
    source_block_anchor_ea=0x40C62F,
    transfer_ea=0x40C649,
    predicate_anchor_ea=0x40C642,
    normalization_start_ea=0x40C642,
    condition_producer_ea=0x40C634,
    conditional_select_ea=0x40C642,
    selected_value_block_id="native@0x40C642",
    join_block_id="native@0x40C645",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C634",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW210_EXISTING_ROUTE.operation_id,),
)

_ROW212_EXISTING_ROUTE = RhadExistingConditionalRoute(
    operation_id="rhad:route@0x40C663",
    reference_order=212,
    operation_variant=RhadOperationVariant.EXISTING_CONDITIONAL_PLUS_INDIRECT,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C64B",
    selected_value_block_id="native@0x40C659",
    join_block_id="native@0x40C65F",
    source_native_ea=0x40C64B,
    source_block_anchor_ea=0x40C65F,
    join_ea=0x40C65F,
    transfer_ea=0x40C663,
    condition_producer_ea=0x40C651,
    predicate_anchor_ea=0x40C657,
    normalization_start_ea=0x40C657,
    source_branch_ea=0x40C657,
    selected_value_ea=0x40C659,
    observed_predicate_kind=PredicateKind.EQ,
    predicate_kind=PredicateKind.NE,
    true_target_block_id="native@0x40C665",
    false_target_block_id="native@0x40A5F0",
    true_target_ea=0x40C665,
    false_target_ea=0x40A5F0,
    comparison_constant=0x09FE690C,
    owned_corridor_instruction_eas=(
        0x40C64B,
    ...
    imported_closure_block_ids=ROW212_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A607, 0x40B6C0),
    flag_corridor_id="flags-intact@0x40C651",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW211_CMOV_ROUTE.operation_id,),
)

_ROW213_CMOV_ROUTE = RhadConditionalRoute(
    operation_id="rhad:route@0x40C694",
    reference_order=213,
    operation_variant=RhadOperationVariant.CMOV_SELECTED_INDIRECT,
    reference_symbol="JumpInliner._fixup_cmov",
    source_block_id="native@0x40C665",
    source_value_block_id="native@0x40C665",
    source_native_ea=0x40C685,
    source_block_anchor_ea=0x40C665,
    transfer_ea=0x40C694,
    predicate_anchor_ea=0x40C68D,
    normalization_start_ea=0x40C68D,
    condition_producer_ea=0x40C67F,
    conditional_select_ea=0x40C68D,
    selected_value_block_id="native@0x40C68D",
    join_block_id="native@0x40C690",
    observed_predicate_kind=PredicateKind.SLT,
    predicate_kind=PredicateKind.SGE,
    true_target_block_id="native@0x40B6C0",
    false_target_block_id="native@0x40A607",
    ...
    imported_closure_block_ids=ACCEPTED_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C, 0x40B790),
    flag_corridor_id="flags-intact@0x40C67F",
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW212_EXISTING_ROUTE.operation_id,),
)

_ROW214_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C6B3",
    reference_operation_id="rhad:route@0x40C6B3",
    reference_order=214,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C6AD",
    source_native_ea=0x40B765,
    transfer_ea=0x40C6B3,
    owner_anchor_ea=0x40C6AD,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40B765,
        0x40B777,
    ...
    imported_closure_block_ids=ROW214_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
...
_ROW216_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C703",
    reference_operation_id="rhad:route@0x40C703",
    reference_order=216,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C6F7",
    source_native_ea=0x40BB4B,
    transfer_ea=0x40C703,
    owner_anchor_ea=0x40C6F7,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40BB4B,
        0x40BB5D,
    ...
    imported_closure_block_ids=ROW216_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW215_DIRECT_ROUTE.operation_id,),
)

_ROW217_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C72E",
    reference_operation_id="rhad:route@0x40C72E",
    reference_order=217,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C722",
    source_native_ea=0x40BF62,
    transfer_ea=0x40C72E,
    owner_anchor_ea=0x40C722,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40BF62,
        0x40BF74,
    ...
    imported_closure_block_ids=ROW217_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW216_DIRECT_ROUTE.operation_id,),
)

_ROW218_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C74F",
    reference_operation_id="rhad:route@0x40C74F",
    reference_order=218,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C749",
    source_native_ea=0x40C00E,
    transfer_ea=0x40C74F,
    owner_anchor_ea=0x40C749,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C00E,
        0x40C021,
    ...
    imported_closure_block_ids=ROW218_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW217_DIRECT_ROUTE.operation_id,),
)

_ROW219_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C76E",
    reference_operation_id="rhad:route@0x40C76E",
    reference_order=219,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C768",
    source_native_ea=0x40C082,
    transfer_ea=0x40C76E,
    owner_anchor_ea=0x40C768,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C082,
        0x40C094,
    ...
    imported_closure_block_ids=ROW219_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW218_DIRECT_ROUTE.operation_id,),
)

_ROW220_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C793",
    reference_operation_id="rhad:route@0x40C793",
    reference_order=220,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C787",
    source_native_ea=0x40C12C,
    transfer_ea=0x40C793,
    owner_anchor_ea=0x40C787,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C12C,
        0x40C13E,
    ...
    imported_closure_block_ids=ROW220_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW219_DIRECT_ROUTE.operation_id,),
)

_ROW221_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C7B8",
    reference_operation_id="rhad:route@0x40C7B8",
    reference_order=221,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C7AC",
    source_native_ea=0x40C22F,
    transfer_ea=0x40C7B8,
    owner_anchor_ea=0x40C7AC,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C22F,
        0x40C241,
    ...
    imported_closure_block_ids=ROW221_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW220_DIRECT_ROUTE.operation_id,),
)

_ROW222_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C7E3",
    reference_operation_id="rhad:route@0x40C7E3",
    reference_order=222,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C7D7",
    source_native_ea=0x40C2D1,
    transfer_ea=0x40C7E3,
    owner_anchor_ea=0x40C7D7,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C2D1,
        0x40C2E3,
    ...
    imported_closure_block_ids=ROW222_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW221_DIRECT_ROUTE.operation_id,),
)

_ROW223_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C802",
    reference_operation_id="rhad:route@0x40C802",
    reference_order=223,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C7FC",
    source_native_ea=0x40C32F,
    transfer_ea=0x40C802,
    owner_anchor_ea=0x40C7FC,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C32F,
        0x40C341,
    ...
    imported_closure_block_ids=ROW223_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW222_DIRECT_ROUTE.operation_id,),
)

_ROW224_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C821",
    reference_operation_id="rhad:route@0x40C821",
    reference_order=224,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C81B",
    source_native_ea=0x40C374,
    transfer_ea=0x40C821,
    owner_anchor_ea=0x40C81B,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C374,
        0x40C386,
    ...
    imported_closure_block_ids=ROW224_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW223_DIRECT_ROUTE.operation_id,),
)

_ROW225_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C840",
    reference_operation_id="rhad:route@0x40C840",
    reference_order=225,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C83A",
    source_native_ea=0x40C3BB,
    transfer_ea=0x40C840,
    owner_anchor_ea=0x40C83A,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C3BB,
        0x40C3CD,
    ...
    imported_closure_block_ids=ROW225_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW224_DIRECT_ROUTE.operation_id,),
)

_ROW226_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C86B",
    reference_operation_id="rhad:route@0x40C86B",
    reference_order=226,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C85F",
    source_native_ea=0x40C404,
    transfer_ea=0x40C86B,
    owner_anchor_ea=0x40C85F,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C404,
        0x40C416,
    ...
    imported_closure_block_ids=ROW226_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
    depends_on=(_ROW225_DIRECT_ROUTE.operation_id,),
)

_ROW227_DIRECT_ROUTE = RhadDirectRoute(
    operation_id="route:rhad-direct@0x40C896",
    reference_operation_id="rhad:route@0x40C896",
    reference_order=227,
    operation_variant=RhadOperationVariant.SIMPLE_INDIRECT_JUMP,
    reference_symbol="JumpInliner._fixup_jmp_and_possible_jcc",
    source_block_id="native@0x40C88A",
    source_native_ea=0x40C5D1,
    transfer_ea=0x40C896,
    owner_anchor_ea=0x40C88A,
    direct_target_block_id="native@0x40A607",
    owned_corridor_instruction_eas=(
        0x40C5D1,
        0x40C5E3,
    ...
    imported_closure_block_ids=ROW227_TARGET_IMPORTED_BLOCK_IDS,
    boundary_exit_eas=(0x40A61B, 0x40A68C),
    phase=RhadReferencePhase.INDIRECT_JUMP_RECONSTRUCTION,
...
_CONSTANT_ROW3_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40A903",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW2_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW4_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40A922",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW3_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW5_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40A9AE",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW4_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW6_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AAC2",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW5_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW7_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40ABFF",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW6_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW8_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AC81",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW7_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW9_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AE3E",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW8_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW10_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AE4A",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW9_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW11_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AEAC",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW10_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW12_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AF00",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW11_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW13_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AF32",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW12_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW14_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AF45",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW13_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW15_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AF71",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW14_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW16_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AF84",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW15_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW17_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40AFA0",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW16_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW18_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B03E",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW17_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW19_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B19B",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW18_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW20_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B287",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW19_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW21_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B2F7",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW20_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW22_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B3B0",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW21_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW23_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B3FF",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW22_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW24_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B410",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW23_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW25_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B421",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW24_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW26_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B432",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW25_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW27_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B443",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW26_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW28_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B450",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW27_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW29_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B45D",
...
_CONSTANT_ROW31_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B825",
...
_CONSTANT_ROW33_MOVZX_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-movzx-absolute@0x40B8E6",
...
_CONSTANT_ROW34_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B8ED",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW33_MOVZX_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW35_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B8FC",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW34_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW36_MOVZX_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-movzx-absolute@0x40B9C1",
    ...
    encoding_variant=RhadAbsoluteConstantEncoding.MOVZX_R32_BYTE_ABSOLUTE,
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_BYTE_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW35_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW37_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40B9FF",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW36_MOVZX_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW38_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BA1A",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW37_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW39_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BA2D",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW38_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW40_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BA47",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW39_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW41_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BA63",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW40_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW42_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BA7F",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW41_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW43_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BACF",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW42_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW44_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BB0A",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW43_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW45_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BB28",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW44_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW46_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BD84",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW45_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW47_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BD9B",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW46_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW48_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BDD8",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW47_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW49_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BDEB",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW48_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW50_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BE63",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW49_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW51_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BF31",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW50_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW52_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40BF4E",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW51_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW53_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C118",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW52_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW54_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C1A0",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW53_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW55_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C1AC",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW54_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW56_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C21B",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW55_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW57_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C26D",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW56_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW58_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C279",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW57_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW59_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C286",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW58_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW60_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C293",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW59_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW61_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C2AF",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW60_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW62_XOR_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-xor-absolute@0x40C322",
    reference_operation_id="rhad:constant@0x40C322",
    reference_order=62,
    operation_variant=RhadOperationVariant.XOR_ABSOLUTE,
    reference_symbol="deob_consts.ConstantInliner.transform_arith_mem_to_imm",
    ...
    encoding_variant=RhadAbsoluteConstantEncoding.XOR_R8_ABSOLUTE,
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_BYTE_XOR,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW61_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW63_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C4F8",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW62_XOR_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW64_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C592",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW63_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW65_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C59E",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW64_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW66_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C5BD",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW65_MOV_ABSOLUTE.operation_id,),
)

_CONSTANT_ROW67_MOV_ABSOLUTE = RhadAbsoluteConstantMaterialization(
    operation_id="constant:rhad-mov-absolute@0x40C667",
    ...
    publication_envelope=RhadConstantPublicationEnvelope.IMPORTED_GLOBAL_MOVE,
    phase=RhadReferencePhase.CONSTANT_MATERIALIZATION,
    depends_on=(_CONSTANT_ROW66_MOV_ABSOLUTE.operation_id,),
)
...
_A560_GENERATED_REFERENCE_BATCH = RhadGeneratedReferenceBatch(
    ...
    native_body_proof_ids=(
        ...
        _ROW128_CMOV_ROUTE.operation_id,
        _ROW129_SETCC_ROUTE.operation_id,
        _ROW130_EXISTING_ROUTE.operation_id,
        ...
        _ROW135_EXISTING_ROUTE.operation_id,
        _ROW136_EXISTING_ROUTE.operation_id,
        _ROW137_EXISTING_ROUTE.operation_id,
        _ROW138_DIRECT_ROUTE.operation_id,
        _ROW139_EXISTING_ROUTE.operation_id,
        _ROW140_EXISTING_ROUTE.operation_id,
        _ROW141_EXISTING_ROUTE.operation_id,
        _ROW142_CMOV_ROUTE.operation_id,
        _ROW143_EXISTING_ROUTE.operation_id,
        _ROW144_EXISTING_ROUTE.operation_id,
        _ROW145_EXISTING_ROUTE.operation_id,
        _ROW146_CMOV_ROUTE.operation_id,
        _ROW147_EXISTING_ROUTE.operation_id,
        _ROW148_EXISTING_ROUTE.operation_id,
        _ROW149_EXISTING_ROUTE.operation_id,
        _ROW150_CMOV_ROUTE.operation_id,
        _ROW151_EXISTING_ROUTE.operation_id,
        _ROW152_EXISTING_ROUTE.operation_id,
        _ROW153_EXISTING_ROUTE.operation_id,
        _ROW154_CMOV_ROUTE.operation_id,
        _ROW155_EXISTING_ROUTE.operation_id,
        _ROW156_EXISTING_ROUTE.operation_id,
        _ROW157_CMOV_ROUTE.operation_id,
        _ROW158_EXISTING_ROUTE.operation_id,
        _ROW159_EXISTING_ROUTE.operation_id,
        _ROW160_CMOV_ROUTE.operation_id,
        _ROW161_EXISTING_ROUTE.operation_id,
        _ROW162_EXISTING_ROUTE.operation_id,
        _ROW163_CMOV_ROUTE.operation_id,
        _ROW164_EXISTING_ROUTE.operation_id,
        _ROW165_EXISTING_ROUTE.operation_id,
        _ROW166_DIRECT_ROUTE.operation_id,
        _ROW167_SETCC_ROUTE.operation_id,
        _ROW168_EXISTING_ROUTE.operation_id,
        _ROW169_CMOV_ROUTE.operation_id,
        _ROW170_EXISTING_ROUTE.operation_id,
        _ROW171_EXISTING_ROUTE.operation_id,
        _ROW172_DIRECT_ROUTE.operation_id,
        _ROW173_EXISTING_ROUTE.operation_id,
        _ROW174_EXISTING_ROUTE.operation_id,
        _ROW175_DIRECT_ROUTE.operation_id,
        _ROW176_EXISTING_ROUTE.operation_id,
        _ROW177_EXISTING_ROUTE.operation_id,
        _ROW178_CMOV_ROUTE.operation_id,
        _ROW179_EXISTING_ROUTE.operation_id,
        _ROW180_DIRECT_ROUTE.operation_id,
        _ROW181_EXISTING_ROUTE.operation_id,
        _ROW182_CMOV_ROUTE.operation_id,
        _ROW183_EXISTING_ROUTE.operation_id,
        _ROW184_CMOV_ROUTE.operation_id,
        _ROW185_EXISTING_ROUTE.operation_id,
        _ROW186_DIRECT_ROUTE.operation_id,
        _ROW187_EXISTING_ROUTE.operation_id,
        _ROW188_DIRECT_ROUTE.operation_id,
        _ROW189_EXISTING_ROUTE.operation_id,
        _ROW190_DIRECT_ROUTE.operation_id,
        _ROW191_EXISTING_ROUTE.operation_id,
        _ROW192_DIRECT_ROUTE.operation_id,
        _ROW193_EXISTING_ROUTE.operation_id,
        ...
        _ROW198_CMOV_ROUTE.operation_id,
        ...
        _ROW203_EXISTING_ROUTE.operation_id,
        _ROW204_CMOV_ROUTE.operation_id,
        _ROW205_EXISTING_ROUTE.operation_id,
        _ROW206_CMOV_ROUTE.operation_id,
        _ROW207_EXISTING_ROUTE.operation_id,
        _ROW208_DIRECT_ROUTE.operation_id,
        _ROW209_EXISTING_ROUTE.operation_id,
        _ROW210_EXISTING_ROUTE.operation_id,
        _ROW211_CMOV_ROUTE.operation_id,
        ...
        _ROW216_DIRECT_ROUTE.operation_id,
        _ROW217_DIRECT_ROUTE.operation_id,
        _ROW218_DIRECT_ROUTE.operation_id,
        _ROW219_DIRECT_ROUTE.operation_id,
        _ROW220_DIRECT_ROUTE.operation_id,
        _ROW221_DIRECT_ROUTE.operation_id,
        _ROW222_DIRECT_ROUTE.operation_id,
        _ROW223_DIRECT_ROUTE.operation_id,
        _ROW224_DIRECT_ROUTE.operation_id,
        _ROW225_DIRECT_ROUTE.operation_id,
        _ROW226_DIRECT_ROUTE.operation_id,
        _ROW227_DIRECT_ROUTE.operation_id,
    ),
    template_fragments=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            boundary_ranges=(),
            boundary_exit_eas=(0x40BE49, 0x40C42E),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40BE47,
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C16A,
            owned_ranges=((0x40C16A, 0x40C186),),
            owned_block_entry_eas=(0x40C16A, 0x40C17D, 0x40C180),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40B898, 0x40B8A6, 0x40B8AC),
            boundary_ranges=(),
            boundary_exit_eas=(0x40B8B2, 0x40BE98),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40B8B0,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BC61, 0x40BC6F, 0x40BC75),
            boundary_ranges=(),
            boundary_exit_eas=(0x40BC7B, 0x40C041),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40BC79,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40B8B2, 0x40B8C0, 0x40B8C6),
            boundary_ranges=(),
            boundary_exit_eas=(0x40B8CC, 0x40C186),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40B8CA,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BE98, 0x40BEA6, 0x40BEAC),
            boundary_ranges=(),
            boundary_exit_eas=(0x40BEB2, 0x40C464),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40BEB0,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40B8CC, 0x40B8DA, 0x40B8E0),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40B8E6),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C186, 0x40C194, 0x40C19A),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40C1A0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40C19E,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C1A0, 0x40C1C0, 0x40C1EC),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            boundary_ranges=(),
            boundary_exit_eas=(0x40BCE5, 0x40C0A0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40BCE3,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40B972, 0x40B980, 0x40B986),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BEE7, 0x40BEF5, 0x40BEFB),
            boundary_ranges=(),
            boundary_exit_eas=(0x40C49A,),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40BEFF,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40B98C, 0x40B99A, 0x40B9A0),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40B9A6),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C1F2, 0x40C200, 0x40C206),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40C20C),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40C20A,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BB8F, 0x40BB9D, 0x40BBA3),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40BF8C,
            owned_ranges=((0x40BF8C, 0x40BFA4),),
            owned_block_entry_eas=(0x40BF8C,),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BBA9, 0x40BBB7, 0x40BBBD),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40BBC3),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C253, 0x40C261, 0x40C267),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40C26D),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40C26B,
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40BBC3,
            owned_ranges=((0x40BBC3, 0x40BBDF),),
            owned_block_entry_eas=(0x40BBC3,),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BBF9, 0x40BC07, 0x40BC0D),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BFDA, 0x40BFE8, 0x40BFEE),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BC13, 0x40BC21, 0x40BC27),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C2FB, 0x40C309, 0x40C30F),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BC2D, 0x40BC36),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BC7B, 0x40BC89, 0x40BC8F),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C041, 0x40C04F, 0x40C055),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BC95, 0x40BCA3, 0x40BCA9),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C34D, 0x40C35B, 0x40C361),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40BCAF,
            owned_ranges=((0x40BCAF, 0x40BCCB),),
            owned_block_entry_eas=(0x40BCAF, 0x40BCC5),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BCE5, 0x40BCF3, 0x40BCF9),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C0A0, 0x40C0AE, 0x40C0B4),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BCFF, 0x40BD0D, 0x40BD13),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40BD19),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C392, 0x40C3A0, 0x40C3A6),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BD19, 0x40BD25, 0x40BD4A),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BD6A, 0x40BD78, 0x40BD7E),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C3D9, 0x40C3E7, 0x40C3ED),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BE49, 0x40BE57, 0x40BE5D),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40BE63),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C448,
            owned_ranges=((0x40C448, 0x40C45E), (0x40C45E, 0x40C464)),
            owned_block_entry_eas=(0x40C448, 0x40C45E),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40BE63,
            owned_ranges=((0x40BE63, 0x40BE92), (0x40BE92, 0x40BE98)),
            owned_block_entry_eas=(0x40BE63, 0x40BE92),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BEB2, 0x40BEC0, 0x40BEC6),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40BECC),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C464, 0x40C472, 0x40C478),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0, 0x40C47E),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
                RhadGeneratedPreservedTransfer(
                    transfer_ea=0x40C47C,
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C47E,
            owned_ranges=((0x40C47E, 0x40C494), (0x40C494, 0x40C49A)),
            owned_block_entry_eas=(0x40C47E, 0x40C494),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BF01, 0x40BF0F, 0x40BF15),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C49A, 0x40C4A8, 0x40C4AE),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C4B4, 0x40C4C6, 0x40C4D4, 0x40C4D6),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40BF1B,
            owned_ranges=((0x40BF1B, 0x40BF8C), (0x40C705, 0x40C730)),
            owned_block_entry_eas=(
                0x40BF1B,
                0x40BF2F,
                0x40BF43,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40BFA4, 0x40BFB2, 0x40BFB8),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0,),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C4DC, 0x40C4EA, 0x40C4F0),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A5F0,),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C4F6,
            owned_ranges=((0x40C4F6, 0x40C521), (0x40C521, 0x40C527)),
            owned_block_entry_eas=(0x40C4F6, 0x40C521),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40BFBE,
            owned_ranges=((0x40BFBE, 0x40BFD4), (0x40BFD4, 0x40BFDA)),
            owned_block_entry_eas=(0x40BFBE, 0x40BFD4),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40BFF4,
            owned_ranges=((0x40BFF4, 0x40C008), (0x40C008, 0x40C00E)),
            owned_block_entry_eas=(0x40BFF4, 0x40C008),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C527,
            owned_ranges=((0x40C527, 0x40C53B), (0x40C53B, 0x40C541)),
            owned_block_entry_eas=(0x40C527, 0x40C53B),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C541, 0x40C54D, 0x40C572),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C00E,
            owned_ranges=((0x40C00E, 0x40C041), (0x40C730, 0x40C751)),
            owned_block_entry_eas=(
                0x40C00E,
                0x40C027,
                0x40C03B,
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C05B,
            owned_ranges=((0x40C05B, 0x40C075),),
            owned_block_entry_eas=(0x40C05B, 0x40C069, 0x40C06F),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C075,
            owned_ranges=((0x40C075, 0x40C0A0), (0x40C751, 0x40C770)),
            owned_block_entry_eas=(
                0x40C075,
                0x40C088,
                0x40C09A,
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C578,
            owned_ranges=((0x40C578, 0x40C592),),
            owned_block_entry_eas=(0x40C578, 0x40C586, 0x40C58C),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C592,
            owned_ranges=((0x40C592, 0x40C5FB), (0x40C86D, 0x40C898)),
            owned_block_entry_eas=(
                0x40C592,
                0x40C5BD,
                0x40C5D7,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C0BA, 0x40C0C8, 0x40C0CE),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C0D4,
            owned_ranges=((0x40C0D4, 0x40C0F0),),
            owned_block_entry_eas=(0x40C0D4, 0x40C0E7, 0x40C0EA),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C10A,
            owned_ranges=((0x40C10A, 0x40C150), (0x40C770, 0x40C795)),
            owned_block_entry_eas=(
                0x40C10A,
                0x40C132,
                0x40C144,
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C5FB, 0x40C609, 0x40C60F),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C615, 0x40C623, 0x40C629),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            ...
            owned_block_entry_eas=(0x40C64B, 0x40C659, 0x40C65F),
            boundary_ranges=(),
        ...
        RhadGeneratedTemplateFragment(
            root_ea=0x40C665,
            owned_ranges=((0x40C665, 0x40C690), (0x40C690, 0x40C696)),
            owned_block_entry_eas=(0x40C665, 0x40C690),
            boundary_ranges=(),
            boundary_exit_eas=(0x40A607, 0x40B6C0),
            direct_boundary_routes=(),
            preserved_unresolved_transfers=(
    ...
    operations=(
        ...
        _ROW128_CMOV_ROUTE,
        _ROW129_SETCC_ROUTE,
        _ROW130_EXISTING_ROUTE,
        _ROW131_EXISTING_ROUTE,
        _ROW132_EXISTING_ROUTE,
        _ROW133_DIRECT_ROUTE,
        _ROW134_SETCC_ROUTE,
        _ROW135_EXISTING_ROUTE,
        _ROW136_EXISTING_ROUTE,
        _ROW137_EXISTING_ROUTE,
        _ROW138_DIRECT_ROUTE,
        _ROW139_EXISTING_ROUTE,
        _ROW140_EXISTING_ROUTE,
        _ROW141_EXISTING_ROUTE,
        _ROW142_CMOV_ROUTE,
        _ROW143_EXISTING_ROUTE,
        _ROW144_EXISTING_ROUTE,
        _ROW145_EXISTING_ROUTE,
        _ROW146_CMOV_ROUTE,
        _ROW147_EXISTING_ROUTE,
        _ROW148_EXISTING_ROUTE,
        _ROW149_EXISTING_ROUTE,
        _ROW150_CMOV_ROUTE,
        _ROW151_EXISTING_ROUTE,
        _ROW152_EXISTING_ROUTE,
        _ROW153_EXISTING_ROUTE,
        _ROW154_CMOV_ROUTE,
        _ROW155_EXISTING_ROUTE,
        _ROW156_EXISTING_ROUTE,
        _ROW157_CMOV_ROUTE,
        _ROW158_EXISTING_ROUTE,
        _ROW159_EXISTING_ROUTE,
        _ROW160_CMOV_ROUTE,
        _ROW161_EXISTING_ROUTE,
        _ROW162_EXISTING_ROUTE,
        _ROW163_CMOV_ROUTE,
        _ROW164_EXISTING_ROUTE,
        _ROW165_EXISTING_ROUTE,
        _ROW166_DIRECT_ROUTE,
        _ROW167_SETCC_ROUTE,
        _ROW168_EXISTING_ROUTE,
        _ROW169_CMOV_ROUTE,
        _ROW170_EXISTING_ROUTE,
        _ROW171_EXISTING_ROUTE,
        _ROW172_DIRECT_ROUTE,
        _ROW173_EXISTING_ROUTE,
        _ROW174_EXISTING_ROUTE,
        _ROW175_DIRECT_ROUTE,
        _ROW176_EXISTING_ROUTE,
        _ROW177_EXISTING_ROUTE,
        _ROW178_CMOV_ROUTE,
        _ROW179_EXISTING_ROUTE,
        _ROW180_DIRECT_ROUTE,
        _ROW181_EXISTING_ROUTE,
        _ROW182_CMOV_ROUTE,
        _ROW183_EXISTING_ROUTE,
        _ROW184_CMOV_ROUTE,
        _ROW185_EXISTING_ROUTE,
        _ROW186_DIRECT_ROUTE,
        _ROW187_EXISTING_ROUTE,
        _ROW188_DIRECT_ROUTE,
        _ROW189_EXISTING_ROUTE,
        _ROW190_DIRECT_ROUTE,
        _ROW191_EXISTING_ROUTE,
        _ROW192_DIRECT_ROUTE,
        _ROW193_EXISTING_ROUTE,
        ...
        _ROW203_EXISTING_ROUTE,
        _ROW204_CMOV_ROUTE,
        _ROW205_EXISTING_ROUTE,
        _ROW206_CMOV_ROUTE,
        _ROW207_EXISTING_ROUTE,
        _ROW208_DIRECT_ROUTE,
        _ROW209_EXISTING_ROUTE,
        _ROW210_EXISTING_ROUTE,
        _ROW211_CMOV_ROUTE,
        _ROW212_EXISTING_ROUTE,
        _ROW213_CMOV_ROUTE,
        _ROW214_DIRECT_ROUTE,
        _ROW215_DIRECT_ROUTE,
        _ROW216_DIRECT_ROUTE,
        _ROW217_DIRECT_ROUTE,
        _ROW218_DIRECT_ROUTE,
        _ROW219_DIRECT_ROUTE,
        _ROW220_DIRECT_ROUTE,
        _ROW221_DIRECT_ROUTE,
        _ROW222_DIRECT_ROUTE,
        _ROW223_DIRECT_ROUTE,
        _ROW224_DIRECT_ROUTE,
        ...
        _CONSTANT_ROW3_MOV_ABSOLUTE,
        _CONSTANT_ROW4_MOV_ABSOLUTE,
        _CONSTANT_ROW5_MOV_ABSOLUTE,
        _CONSTANT_ROW6_MOV_ABSOLUTE,
        _CONSTANT_ROW7_MOV_ABSOLUTE,
        _CONSTANT_ROW8_MOV_ABSOLUTE,
        _CONSTANT_ROW9_MOV_ABSOLUTE,
        _CONSTANT_ROW10_MOV_ABSOLUTE,
        _CONSTANT_ROW11_MOV_ABSOLUTE,
        _CONSTANT_ROW12_MOV_ABSOLUTE,
        _CONSTANT_ROW13_MOV_ABSOLUTE,
        _CONSTANT_ROW14_MOV_ABSOLUTE,
        _CONSTANT_ROW15_MOV_ABSOLUTE,
        _CONSTANT_ROW16_MOV_ABSOLUTE,
        _CONSTANT_ROW17_MOV_ABSOLUTE,
        _CONSTANT_ROW18_MOV_ABSOLUTE,
        _CONSTANT_ROW19_MOV_ABSOLUTE,
        _CONSTANT_ROW20_MOV_ABSOLUTE,
        _CONSTANT_ROW21_MOV_ABSOLUTE,
        _CONSTANT_ROW22_MOV_ABSOLUTE,
        _CONSTANT_ROW23_MOV_ABSOLUTE,
        _CONSTANT_ROW24_MOV_ABSOLUTE,
        _CONSTANT_ROW25_MOV_ABSOLUTE,
        _CONSTANT_ROW26_MOV_ABSOLUTE,
        ...
        _CONSTANT_ROW33_MOVZX_ABSOLUTE,
        _CONSTANT_ROW34_MOV_ABSOLUTE,
        _CONSTANT_ROW35_MOV_ABSOLUTE,
        _CONSTANT_ROW36_MOVZX_ABSOLUTE,
        _CONSTANT_ROW37_MOV_ABSOLUTE,
        _CONSTANT_ROW38_MOV_ABSOLUTE,
        _CONSTANT_ROW39_MOV_ABSOLUTE,
        _CONSTANT_ROW40_MOV_ABSOLUTE,
        _CONSTANT_ROW41_MOV_ABSOLUTE,
        _CONSTANT_ROW42_MOV_ABSOLUTE,
        _CONSTANT_ROW43_MOV_ABSOLUTE,
        _CONSTANT_ROW44_MOV_ABSOLUTE,
        _CONSTANT_ROW45_MOV_ABSOLUTE,
        _CONSTANT_ROW46_MOV_ABSOLUTE,
        _CONSTANT_ROW47_MOV_ABSOLUTE,
        _CONSTANT_ROW48_MOV_ABSOLUTE,
        _CONSTANT_ROW49_MOV_ABSOLUTE,
        _CONSTANT_ROW50_MOV_ABSOLUTE,
        _CONSTANT_ROW51_MOV_ABSOLUTE,
        _CONSTANT_ROW52_MOV_ABSOLUTE,
        _CONSTANT_ROW53_MOV_ABSOLUTE,
        _CONSTANT_ROW54_MOV_ABSOLUTE,
        _CONSTANT_ROW55_MOV_ABSOLUTE,
        _CONSTANT_ROW56_MOV_ABSOLUTE,
        _CONSTANT_ROW57_MOV_ABSOLUTE,
        _CONSTANT_ROW58_MOV_ABSOLUTE,
        _CONSTANT_ROW59_MOV_ABSOLUTE,
        _CONSTANT_ROW60_MOV_ABSOLUTE,
        _CONSTANT_ROW61_MOV_ABSOLUTE,
        _CONSTANT_ROW62_XOR_ABSOLUTE,
        _CONSTANT_ROW63_MOV_ABSOLUTE,
        _CONSTANT_ROW64_MOV_ABSOLUTE,
        _CONSTANT_ROW65_MOV_ABSOLUTE,
        _CONSTANT_ROW66_MOV_ABSOLUTE,
        _CONSTANT_ROW67_MOV_ABSOLUTE,
    ),
...
__all__ = [
    ...
    "ROW134_TABLE_PROOF_PATH",
    "ROW167_TABLE_PROOF_PATH",
    "ROW209_TARGET_IMPORTED_BLOCK_IDS",
    "ROW210_TARGET_IMPORTED_BLOCK_IDS",
    "ROW212_TARGET_IMPORTED_BLOCK_IDS",
    "SOURCE_EA",
    "TEMPLATE_ROOT_EAS",
    "TRANSFER_EA",
    ...
    "load_row167_table_proof_artifact",
