...
from d810._vendor.peewee import CommaNodeList
from d810._vendor.peewee import EnclosedNodeList
from d810._vendor.peewee import Entity
from d810._vendor.peewee import Expression
from d810._vendor.peewee import Node
from d810._vendor.peewee import NodeList
from d810._vendor.peewee import OP
from d810._vendor.peewee import callable_
from d810._vendor.peewee import sort_models
from d810._vendor.peewee import sqlite3
from d810._vendor.peewee import _truncate_constraint_name

try:
    from d810._vendor.playhouse.cockroachdb import CockroachDatabase
except ImportError:
...
class PostgresqlMigrator(SchemaMigrator):
    ...
    def set_search_path(self, schema_name):
        return (
            self.make_context().literal("SET search_path TO ").sql(Entity(schema_name))
        )
...
class SqliteMigrator(SchemaMigrator):
    ...
    def _update_column(self, table, column_to_update, fn):
        ...
        create = rgx.sub(r"\1%s\2" % temp_table, raw_create)
    ...
    def _fix_index(self, sql, column_to_update, new_column):
        ...
        for column in columns:
            if re.match(r'%s(?:[\'"`\]]?\s|$)' % re.escape(column_to_update), column):
