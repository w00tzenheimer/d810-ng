...
class AstLeaf(AstBase):
    ...
    @property
    def leafs_by_name(self) -> dict[str, "AstLeaf"]:
        """Return self as a single-entry leafs_by_name dict for interface compatibility."""
        return {self.name: self} if self.name else {}
