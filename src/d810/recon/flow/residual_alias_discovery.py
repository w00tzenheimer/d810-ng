...
class ResidualAliasOverride:
    ...
    ``d810.cfg.residual_alias_emission.emit_residual_alias_modifications`` to
...
def discover_residual_alias_overrides(
    *,
    ...
    ``d810.cfg.residual_alias_emission.emit_residual_alias_modifications``.
