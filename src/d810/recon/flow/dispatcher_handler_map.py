"""Migration shim: ``d810.recon.flow.dispatcher_handler_map`` relocated to ``d810.analyses.control_flow.dispatcher_handler_map`` (LS11, ticket d81-mt50).
...
from d810.analyses.control_flow import dispatcher_handler_map as _canonical
