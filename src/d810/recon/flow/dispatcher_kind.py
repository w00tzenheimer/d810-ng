"""Migration shim: ``d810.recon.flow.dispatcher_kind`` relocated to ``d810.analyses.control_flow.dispatcher_kind`` (LS11, ticket d81-mt50).
...
from d810.analyses.control_flow import dispatcher_kind as _canonical
