"""Migration shim: ``d810.recon.flow.dispatcher_map`` relocated to ``d810.analyses.control_flow.dispatcher_resolution`` (LS11, ticket d81-mt50).
...
from d810.analyses.control_flow import dispatcher_resolution as _canonical
