"""Migration shim: ``d810.recon.flow.indirect_jump_table_analysis`` relocated to ``d810.analyses.control_flow.indirect_jump_table_analysis`` (LS11, ticket d81-mt50).
...
from d810.analyses.control_flow import indirect_jump_table_analysis as _canonical
