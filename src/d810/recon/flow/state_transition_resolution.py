"""Migration shim: ``d810.recon.flow.state_transition_resolution`` relocated to ``d810.analyses.control_flow.semantic_transition`` (LS11, ticket d81-mt50).
...
from d810.analyses.control_flow import semantic_transition as _canonical
