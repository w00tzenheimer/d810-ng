"""Migration shim: ``d810.recon.flow.branch_ownership`` relocated to ``d810.analyses.control_flow.branch_ownership`` (LS11, ticket d81-mt50).
...
from d810.analyses.control_flow import branch_ownership as _canonical
