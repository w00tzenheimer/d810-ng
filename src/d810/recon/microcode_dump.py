...
the historical ``d810.recon.microcode_dump`` tool.  These functions
...
* The seven moved symbols (plus the constant tables) are re-exported
  ...
  ``d810.recon.microcode_dump`` keep working.
...
# ``d810.recon.microcode_dump`` import sites without touching them.
