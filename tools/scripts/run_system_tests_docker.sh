...
[ -n "${D810_TAIL_DUPLICATE_CONVERGENCE_BYTE:-}" ] && ENV_TEST="$ENV_TEST D810_TAIL_DUPLICATE_CONVERGENCE_BYTE=$D810_TAIL_DUPLICATE_CONVERGENCE_BYTE"
[ -n "${D810_TERMINAL_TAIL_STATE_CASCADE_PAIR:-}" ] && ENV_TEST="$ENV_TEST D810_TERMINAL_TAIL_STATE_CASCADE_PAIR=$D810_TERMINAL_TAIL_STATE_CASCADE_PAIR"
[ -n "${D810_TAIL_ANCHOR_BYTE6_SPLIT_XOR:-}" ] && ENV_TEST="$ENV_TEST D810_TAIL_ANCHOR_BYTE6_SPLIT_XOR=$D810_TAIL_ANCHOR_BYTE6_SPLIT_XOR"
if [ -n "$ENABLE_DEBUG_LOGGING" ]; then
