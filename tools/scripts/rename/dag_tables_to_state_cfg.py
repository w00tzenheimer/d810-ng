...
ALLOWLIST = [
    ...
    "tests/unit/preanalysis/flow/test_edge_diagnostics.py",
    "tests/unit/preanalysis/flow/test_alternate_selection.py",
    "tests/unit/preanalysis/flow/test_alternate_correlation.py",
    "tests/unit/preanalysis/flow/test_selected_alternate_edge_override.py",
