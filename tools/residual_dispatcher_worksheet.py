...
Output is a compact four-column worksheet for residual dispatcher-feeder
blocks that can be regenerated from the latest saved artifacts.
"""
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Generate a residual dispatcher worksheet from diag/recon artifacts."
    )
    parser.add_argument("--diag-db", type=Path, default=None, help="Diagnostic SQLite DB")
    parser.add_argument("--recon-db", type=Path, default=None, help="Recon SQLite DB")
    parser.add_argument("--log", type=Path, default=None, help="Optional text log/dump to parse")
    parser.add_argument("--log-dir", type=Path, default=None, help="Search root for auto-detected DBs/logs")
    parser.add_argument("--func-ea", type=parse_int, default=None, help="Function EA (decimal or hex)")
    parser.add_argument("--func-token", default=None, help="Function token for log auto-detection, e.g. sub_7FFD")
    parser.add_argument("--snapshot-id", type=int, default=None, help="Primary worksheet snapshot ID")
    parser.add_argument("--dag-snapshot-id", type=int, default=None, help="Auxiliary DAG snapshot ID")
    parser.add_argument(
    ...
    parser.add_argument("--maturity", default=DEFAULT_MATURITY, help="Preferred maturity, default GLBOPT1")
    parser.add_argument("--phase", default=DEFAULT_PHASE, help="Preferred phase, default post_d810")
    parser.add_argument("--variant", default=DEFAULT_VARIANT, help="Rendered-program variant name")
    parser.add_argument(
        "--format",
    ...
    parser.add_argument("--list-snapshots", action="store_true", help="List snapshots and exit")
    return parser
